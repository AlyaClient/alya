 ...
 */
package dev.thoq.viamcp.impl;

import dev.thoq.viamcp.impl.gui.AsyncVersionSlider;
...
public class ViaMCP {
    ...
    public ViaMCP() {
        ViaLoadingBase.ViaLoadingBaseBuilder.create().runDirectory(new File("ViaMCP")).nativeVersion(NATIVE_VERSION).forceNativeVersionCondition(() -> {
