...
public final class ClickGUIScreen extends GuiScreen {
    ...
    private void renderCategoryPanel(final Category category, final int mouseX, final int mouseY) {
        ...
        final net.minecraft.util.ResourceLocation categoryIcon = new net.minecraft.util.ResourceLocation("Alya/Icons/Categories/" + categoryName + "_good.png");
        net.minecraft.client.renderer.GlStateManager.color(catR, catG, catB, 1.0F);
        RenderUtility.drawImage(categoryIcon, panelX + PANEL_WIDTH - 8, panelY + 5, 6, 6);
        
        final String eyeIconName = expandedCategories.get(category) ? "eye_open.png" : "eye_close.png";
        final net.minecraft.util.ResourceLocation eyeIcon = new net.minecraft.util.ResourceLocation("Alya/Icons/" + eyeIconName);
        net.minecraft.client.renderer.GlStateManager.color(catR, catG, catB, 1.0F);
        RenderUtility.drawImage(eyeIcon, panelX + PANEL_WIDTH - 16, panelY + 5, 6, 6);
