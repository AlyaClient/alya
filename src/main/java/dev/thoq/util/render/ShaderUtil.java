    ...
    public boolean init() {
        ...
        try {
            ...
            if(GL20.glGetShaderi(vertexShader, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
                System.err.println("[Alya] Vertex shader compilation failed: " + GL20.glGetShaderInfoLog(vertexShader, 1024));
                return false;
            }
            ...
            if(GL20.glGetShaderi(fragmentShader, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
                System.err.println("[Alya] Fragment shader compilation failed: " + GL20.glGetShaderInfoLog(fragmentShader, 1024));
                return false;
            }
            ...
            if(GL20.glGetProgrami(programId, GL20.GL_LINK_STATUS) == GL11.GL_FALSE) {
                System.err.println("[Alya] Shader program linking failed: " + GL20.glGetProgramInfoLog(programId, 1024));
                return false;
            }
