...
public final class LuaModule extends Module {
    ...
    private LuaTable buildTable() {
        ...
        table.set("getDescription", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(getDescription());
            }
        });
        table.set("getCategory", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(getCategory().name());
            }
        });
        table.set("isEnabled", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(isEnabled());
            }
        });
        table.set("toggle", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                toggle();
                return LuaValue.NIL;
        ...
        table.set("getKeyCode", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(getKeyCode());
            }
        });
        table.set("setKeyCode", new OneArgFunction() {
            @Override
        ...
        table.set("onEnable", new OneArgFunction() {
            @Override
        ...
        table.set("onDisable", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue callbackFunction) {
                if (callbackFunction instanceof LuaFunction)
        ...
        table.set("addBooleanSetting", new ThreeArgFunction() {
            @Override
            public LuaValue call(LuaValue nameValue, LuaValue descriptionValue, LuaValue defaultValue) {
                BooleanSetting booleanSetting = new BooleanSetting(nameValue.tojstring(), descriptionValue.tojstring(),
                        defaultValue.toboolean());
                initializeSettings(booleanSetting);
                return buildBooleanSettingTable(booleanSetting);
            }
        });
        table.set("addNumberSetting", new VarArgFunction() {
            @Override
            public Varargs invoke(Varargs arguments) {
                ...
                NumberSetting numberSetting = new NumberSetting(settingName, settingDescription, defaultValue, minValue,
                        maxValue, incrementValue);
                initializeSettings(numberSetting);
                return buildNumberSettingTable(numberSetting);
            }
        });
        table.set("addModeSetting", new VarArgFunction() {
            @Override
            public Varargs invoke(Varargs arguments) {
                String settingName = arguments.arg(1).tojstring();
                String settingDescription = arguments.arg(2).tojstring();
                ...
                ModeSetting modeSetting = new ModeSetting(settingName, settingDescription, defaultValue, modeOptions);
                initializeSettings(modeSetting);
                return buildModeSettingTable(modeSetting);
            }
        });
        table.set("getSetting", new OneArgFunction() {
            @Override
    ...
    static LuaTable buildBooleanSettingTable(final BooleanSetting booleanSetting) {
        ...
        settingTable.set("getValue", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(booleanSetting.getValue());
            }
        });
        settingTable.set("isEnabled", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(booleanSetting.isEnabled());
            }
        });
        settingTable.set("setValue", new OneArgFunction() {
            @Override
        ...
        settingTable.set("toggle", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        settingTable.set("isVisible", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
    ...
    static LuaTable buildNumberSettingTable(final NumberSetting numberSetting) {
        ...
        settingTable.set("getValueAsInt", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(numberSetting.getValueAsInt());
            }
        });
        settingTable.set("getValueAsFloat", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        settingTable.set("getMin", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(numberSetting.getMin());
            }
        });
        settingTable.set("getMax", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(numberSetting.getMax());
            }
        });
        settingTable.set("getIncrement", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
    ...
    static LuaTable buildModeSettingTable(final ModeSetting modeSetting) {
        ...
        settingTable.set("is", new OneArgFunction() {
            @Override
        ...
        settingTable.set("cycle", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                modeSetting.cycle();
                return LuaValue.NIL;
        ...
        settingTable.set("getModes", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                LuaTable modesTable = new LuaTable();
                for (int modeIndex = 0; modeIndex < modeSetting.getModes().size(); modeIndex++) {
                    modesTable.set(modeIndex + 1, LuaValue.valueOf(modeSetting.getModes().get(modeIndex)));
                }
                return modesTable;
            }
        });
        settingTable.set("setOnChange", new OneArgFunction() {
            @Override
    ...
    public void onEnable() {
        if (onEnableFunction != null) {
            try {
                ...
                Alya.getInstance().getLogger().error("Lua onEnable error in {}: {}", getName(), luaError.getMessage());
            }
        }
    }
    @Override
    public void onDisable() {
        if (onDisableFunction != null) {
            try {
                ...
                Alya.getInstance().getLogger().error("Lua onDisable error in {}: {}", getName(), luaError.getMessage());
            }
        }
    }
