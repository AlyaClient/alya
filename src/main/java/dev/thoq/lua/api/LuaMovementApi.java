...
public final class LuaMovementApi extends LuaTable {
    ...
    public LuaMovementApi() {
        ...
        set("getMoveYaw", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf((double) MovementUtil.getMoveYaw());
            }
        });
        set("getMoveSpeed", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(MovementUtil.getMoveSpeed());
            }
        });
        set("getDirection", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        set("getAllowedHDistNCP", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        set("setSpeedStrafe", new TwoArgFunction() {
            @Override
