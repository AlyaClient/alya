...
public final class LuaCombatApi extends LuaTable implements IUtil {
    ...
    public LuaCombatApi() {
        ...
        set("rightClickMouse", new ZeroArgFunction() {
            ...
            public LuaValue call() {
                if (mc.thePlayer == null) return LuaValue.NIL;
                try {
                    java.lang.reflect.Method m = net.minecraft.client.Minecraft.class.getDeclaredMethod("rightClickMouse");
        ...
        set("getHotbarItemName", new OneArgFunction() {
            ...
            public LuaValue call(LuaValue slotValue) {
                ...
                net.minecraft.item.ItemStack stack = mc.thePlayer.inventory.getStackInSlot(slotValue.toint());
    ...
    private LuaTable livingToTable(EntityLivingBase e) {
        ...
        String name = e instanceof EntityPlayer ? ((EntityPlayer) e).getName()
                : e.hasCustomName() ? e.getCustomNameTag()
