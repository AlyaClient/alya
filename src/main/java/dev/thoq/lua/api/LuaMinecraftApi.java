...
public final class LuaMinecraftApi extends LuaTable {
    ...
    public static void registerEvents(dev.thoq.event.EventBus eventBus) {
        if (!eventsRegistered) {
            ...
            eventBus.subscribe(
                ReachEvent.class,
                event -> { if (reachOverride > 0) event.setReachDistance(reachOverride); }
            );
            eventBus.subscribe(
                HitboxEvent.class,
                event -> { if (hitboxExpansion >= 0) event.setExpansion(hitboxExpansion); }
            );
            eventBus.subscribe(
    ...
    public LuaMinecraftApi() {
        ...
        set("setStepHeight", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue v) {
                if (minecraft.thePlayer != null)
        ...
        set("resetStepHeight", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                if (minecraft.thePlayer != null)
        ...
        set("holdPackets", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue v) {
        ...
        set("flushPackets", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                if (minecraft.thePlayer != null) {
        ...
        set("clearPackets", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                packetQueue.clear();
                return LuaValue.NIL;
        ...
        set("isOnLiquid", new ZeroArgFunction() {
            ...
            public LuaValue call() {
                ...
                return LuaValue.valueOf(minecraft.theWorld.getBlockState(pos).getBlock() instanceof BlockLiquid);
            }
        });
        set("isGuiOpen", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                return LuaValue.valueOf(minecraft.currentScreen != null);
            }
        });
        set("getGuiClass", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        set("getKeyCode", new OneArgFunction() {
            ...
            public LuaValue call(LuaValue name) {
                switch (name.tojstring()) {
                    case "forward": return LuaValue.valueOf(minecraft.gameSettings.keyBindForward.getKeyCode());
                    case "back":    return LuaValue.valueOf(minecraft.gameSettings.keyBindBack.getKeyCode());
                    case "left":    return LuaValue.valueOf(minecraft.gameSettings.keyBindLeft.getKeyCode());
                    case "right":   return LuaValue.valueOf(minecraft.gameSettings.keyBindRight.getKeyCode());
                    case "sprint":  return LuaValue.valueOf(minecraft.gameSettings.keyBindSprint.getKeyCode());
                    case "sneak":   return LuaValue.valueOf(minecraft.gameSettings.keyBindSneak.getKeyCode());
                    case "jump":    return LuaValue.valueOf(minecraft.gameSettings.keyBindJump.getKeyCode());
                    default:        return LuaValue.valueOf(-1);
                }
            }
        });
        set("setReach", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue v) {
        ...
        set("resetReach", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                reachOverride = -1.0f;
                return LuaValue.NIL;
        ...
        set("setHitboxExpansion", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue v) {
        ...
        set("resetHitboxExpansion", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        set("getHotbarBlockSlot", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
        ...
        set("getHotbarSlot", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                if (minecraft.thePlayer == null) return LuaValue.valueOf(-1);
        ...
        set("sendHeldItemChange", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue slotValue) {
                if (minecraft.thePlayer != null) {
                    minecraft.getNetHandler().addToSendQueueNoEvent(new net.minecraft.network.play.client.C09PacketHeldItemChange(slotValue.toint()));
                }
                return LuaValue.NIL;
            }
        });
        set("sendAnimation", new ZeroArgFunction() {
            @Override
            public LuaValue call() {
                if (minecraft.thePlayer != null) {
                    minecraft.getNetHandler().addToSendQueue(new net.minecraft.network.play.client.C0APacketAnimation());
                }
                return LuaValue.NIL;
            }
        });
        set("isBlockAir", new org.luaj.vm2.lib.ThreeArgFunction() {
            @Override
            public LuaValue call(LuaValue xValue, LuaValue yValue, LuaValue zValue) {
                if (minecraft.theWorld != null) {
                    ...
                    return LuaValue.valueOf(minecraft.theWorld.getBlockState(blockPos).getBlock() instanceof net.minecraft.block.BlockAir);
                }
                return LuaValue.FALSE;
            }
        });
        set("isBlockSolid", new org.luaj.vm2.lib.ThreeArgFunction() {
            @Override
            public LuaValue call(LuaValue xValue, LuaValue yValue, LuaValue zValue) {
                if (minecraft.theWorld != null) {
                    BlockPos blockPos = new BlockPos(xValue.toint(), yValue.toint(), zValue.toint());
                    net.minecraft.block.material.Material material = minecraft.theWorld.getBlockState(blockPos).getBlock().getMaterial();
                    return LuaValue.valueOf(material.isSolid() && !material.isLiquid());
                }
                return LuaValue.FALSE;
            }
        });
        set("isBlockLiquid", new org.luaj.vm2.lib.ThreeArgFunction() {
            @Override
            public LuaValue call(LuaValue xValue, LuaValue yValue, LuaValue zValue) {
                if (minecraft.theWorld != null) {
                    BlockPos blockPos = new BlockPos(xValue.toint(), yValue.toint(), zValue.toint());
                    return LuaValue.valueOf(minecraft.theWorld.getBlockState(blockPos).getBlock().getMaterial().isLiquid());
                }
                return LuaValue.FALSE;
            }
        });
        set("rightClickBlock", new org.luaj.vm2.lib.VarArgFunction() {
            ...
            public org.luaj.vm2.Varargs invoke(org.luaj.vm2.Varargs arguments) {
                if (minecraft.thePlayer != null && minecraft.theWorld != null) {
                    ...
                    net.minecraft.util.EnumFacing enumFacing = net.minecraft.util.EnumFacing.getFacingFromVector((float)facingX, (float)facingY, (float)facingZ);
                    if (enumFacing == null) {
                        enumFacing = net.minecraft.util.EnumFacing.UP;
                    }
                    net.minecraft.util.Vec3 hitVec = new net.minecraft.util.Vec3(hitX, hitY, hitZ);
                    boolean success = minecraft.playerController.onPlayerRightClick(minecraft.thePlayer, minecraft.theWorld, itemStack, blockPos, enumFacing, hitVec);
                    return LuaValue.valueOf(success);
                }
                return LuaValue.FALSE;
            }
        });
        set("raycastBlock", new org.luaj.vm2.lib.ThreeArgFunction() {
            @Override
            public LuaValue call(LuaValue yawValue, LuaValue pitchValue, LuaValue rangeValue) {
                if (minecraft.theWorld != null && minecraft.thePlayer != null) {
                    ...
                    float f1 = net.minecraft.util.MathHelper.cos(-yawFloat * 0.017453292F - (float)Math.PI);
                    float f2 = net.minecraft.util.MathHelper.sin(-yawFloat * 0.017453292F - (float)Math.PI);
                    ...
                    net.minecraft.util.Vec3 lookPosition = new net.minecraft.util.Vec3(f2 * f3, f4, f1 * f3);
                    net.minecraft.util.Vec3 endPosition = eyePosition.addVector(lookPosition.xCoord * rangeDouble, lookPosition.yCoord * rangeDouble, lookPosition.zCoord * rangeDouble);
                    net.minecraft.util.MovingObjectPosition movingObjectPosition = minecraft.theWorld.rayTraceBlocks(eyePosition, endPosition, false, false, true);
