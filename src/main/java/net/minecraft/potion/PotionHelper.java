...
public class PotionHelper {
  ...
  private static int func_77904_a(
      boolean p_77904_0_,
      boolean p_77904_1_,
      boolean p_77904_2_,
      int p_77904_3_,
  ...
  private static int parsePotionEffects(
      String p_77912_0_, int p_77912_1_, int p_77912_2_, int p_77912_3_) {
  ...
  /**
   * Manipulates the specified bit of the potion damage value according to the rules passed from
   * applyIngredient.
   */
  private static int brewBitOperations(
      int p_77906_0_, int p_77906_1_, boolean p_77906_2_, boolean p_77906_3_, boolean p_77906_4_) {
    if (p_77906_4_) {
  ...
  /**
   * Returns the new potion damage value after the specified ingredient info is applied to the
   * specified potion.
   */
  ...
  public static int func_77908_a(
      int p_77908_0_,
      int p_77908_1_,
      int p_77908_2_,
      int p_77908_3_,
