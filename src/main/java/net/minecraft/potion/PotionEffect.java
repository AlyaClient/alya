...
public class PotionEffect {
  ...
  public PotionEffect(
      int id, int effectDuration, int effectAmplifier, boolean ambient, boolean showParticles) {
    this.potionID = id;
  ...
  /**
   * merges the input PotionEffect into this one if this.amplifier <= tomerge.amplifier. The
   * duration in the supplied potion effect is assumed to be greater.
   */
