...
public class VillageCollection extends WorldSavedData {
  ...
  /**
   * returns the VillageDoorInfo if it exists in any village or in the newDoor list, otherwise
   * returns null
   */
  ...
  private void addToNewDoorsList(BlockPos doorBlock) {
    ...
    if (i != j) {
      this.newDoors.add(
          new VillageDoorInfo(doorBlock, i < j ? enumfacing : enumfacing1, this.tickCounter));
    }
  }
