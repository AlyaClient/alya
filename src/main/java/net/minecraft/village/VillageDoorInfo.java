...
public class VillageDoorInfo {
  ...
  public int getDistanceSquared(int p_75474_1_, int p_75474_2_, int p_75474_3_) {
    return (int)
        this.doorBlockPos.distanceSq((double) p_75474_1_, (double) p_75474_2_, (double) p_75474_3_);
  }
  ...
  public boolean func_179850_c(BlockPos p_179850_1_) {
    ...
    return i * this.insideDirection.getFrontOffsetX() + j * this.insideDirection.getFrontOffsetZ()
        >= 0;
  }
