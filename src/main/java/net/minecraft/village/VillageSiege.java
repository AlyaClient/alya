...
public class VillageSiege {
  ...
  private boolean func_75529_b() {
    ...
    while (true) {
      ...
      if (!entityplayer.isSpectator()) {
        this.theVillage =
            this.worldObj.getVillageCollection().getNearestVillage(new BlockPos(entityplayer), 1);
        ...
        if (this.theVillage != null
          ...
          for (int i = 0; i < 10; ++i) {
            ...
            for (Village village : this.worldObj.getVillageCollection().getVillageList()) {
              if (village != this.theVillage
                  && village.func_179866_a(
  ...
  private boolean spawnZombie() {
    ...
    if (vec3 == null) {
      ...
      entityzombie.setLocationAndAngles(
          vec3.xCoord, vec3.yCoord, vec3.zCoord, this.worldObj.rand.nextFloat() * 360.0F, 0.0F);
