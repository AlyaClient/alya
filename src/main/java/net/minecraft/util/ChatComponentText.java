...
public class ChatComponentText extends ChatComponentStyle {
  ...
  /**
   * Gets the text value of this ChatComponentText. TODO: what are getUnformattedText and
   * getUnformattedTextForChat missing that made someone decide to create a third equivalent method
   * that only ChatComponentText can implement?
   */
  ...
  public boolean equals(Object p_equals_1_) {
    if (this == p_equals_1_) {
      ...
      return this.text.equals(chatcomponenttext.getChatComponentText_TextValue())
