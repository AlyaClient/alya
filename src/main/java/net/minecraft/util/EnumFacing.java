...
public enum EnumFacing implements IStringSerializable {
  ...
  NORTH(
      2, 3, 2, "north", EnumFacing.AxisDirection.NEGATIVE, EnumFacing.Axis.Z, new Vec3i(0, 0, -1)),
  ...
  /**
   * Rotate this Facing around the Y axis counter-clockwise (NORTH => WEST => SOUTH => EAST =>
   * NORTH)
   */
  ...
  public static EnumFacing getFacingFromVector(
      float p_176737_0_, float p_176737_1_, float p_176737_2_) {
    EnumFacing enumfacing = NORTH;
    float f = Float.MIN_VALUE;

    for (EnumFacing enumfacing1 : values()) {
      float f1 =
          p_176737_0_ * (float) enumfacing1.directionVec.getX()
  ...
  public static EnumFacing func_181076_a(
      EnumFacing.AxisDirection p_181076_0_, EnumFacing.Axis p_181076_1_) {
  ...
  public static enum Axis implements Predicate<EnumFacing>, IStringSerializable {
    ...
    private static final Map<String, EnumFacing.Axis> NAME_LOOKUP =
        Maps.<String, EnumFacing.Axis>newHashMap();
    private final String name;
