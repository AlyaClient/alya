...
public class CryptManager {
   ...
   *
   * @param opMode The operation mode of the cipher. (this is one of the following:
   *     Cipher.ENCRYPT_MODE, Cipher.DECRYPT_MODE, Cipher.WRAP_MODE or Cipher.UNWRAP_MODE)
   * @param key The encryption key
   * @param data The data
   */
  ...
  /**
   * Creates an Cipher instance using the AES/CFB8/NoPadding algorithm. Used for protocol
   * encryption.
   *
   * @param opMode The operation mode of the cipher. (this is one of the following:
   *     Cipher.ENCRYPT_MODE, Cipher.DECRYPT_MODE, Cipher.WRAP_MODE or Cipher.UNWRAP_MODE)
  ...
  public static Cipher createNetCipherInstance(int opMode, Key key) {
    try {
      ...
      cipher.init(
          opMode, (Key) key, (AlgorithmParameterSpec) (new IvParameterSpec(key.getEncoded())));
      return cipher;
