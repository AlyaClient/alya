...
public class MathHelper {
  ...
  /**
   * Though it looks like an array, this is really more like a mapping. Key (index of this array) is
   * the upper 5 bits of the result of multiplying a 32-bit unsigned integer by the B(2, 5) De
   * Bruijn sequence 0x077CB531. Value (value stored in the array) is the unique index (from the
   * right) of the leftmost one-bit in a 32-bit unsigned integer that can cause the upper 5 bits to
   * get that value. Used for highly optimized "find the log-base-2 of this number" calculations.
   */
  ...
  public static float sin(float p_76126_0_) {
    return fastMath
        ? SIN_TABLE_FAST[(int) (p_76126_0_ * radToIndex) & 4095]
  ...
  public static float cos(float value) {
    return fastMath
        ? SIN_TABLE_FAST[(int) (value * radToIndex + 1024.0F) & 4095]
  ...
  public static double denormalizeClamp(
      double p_151238_0_, double p_151238_2_, double p_151238_4_) {
    return p_151238_4_ < 0.0D
        ? p_151238_0_
        : (p_151238_4_ > 1.0D
            ? p_151238_2_
            : p_151238_0_ + (p_151238_2_ - p_151238_0_) * p_151238_4_);
  }
  ...
  public static int getRandomIntegerInRange(Random p_76136_0_, int p_76136_1_, int p_76136_2_) {
    return p_76136_1_ >= p_76136_2_
        ? p_76136_1_
        : p_76136_0_.nextInt(p_76136_2_ - p_76136_1_ + 1) + p_76136_1_;
  }

  public static float randomFloatClamp(Random p_151240_0_, float p_151240_1_, float p_151240_2_) {
    return p_151240_1_ >= p_151240_2_
        ? p_151240_1_
        : p_151240_0_.nextFloat() * (p_151240_2_ - p_151240_1_) + p_151240_1_;
  }

  public static double getRandomDoubleInRange(
      Random p_82716_0_, double p_82716_1_, double p_82716_3_) {
    return p_82716_1_ >= p_82716_3_
        ? p_82716_1_
        : p_82716_0_.nextDouble() * (p_82716_3_ - p_82716_1_) + p_82716_1_;
  }
  ...
  public static double parseDoubleWithDefaultAndMax(
      String p_82713_0_, double p_82713_1_, double p_82713_3_) {
   ...
   * of the given value. Optimized for cases where the input value is a power-of-two. If the input
   * value is not a power-of-two, then subtract 1 from the return value.
   */
  ...
  /**
   * Efficiently calculates the floor of the base-2 log of an integer value. This is effectively the
   * index of the highest bit that is set. For example, if the number in binary is 0...100101, this
   * will return 5.
   */
