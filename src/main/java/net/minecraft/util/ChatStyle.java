...
public class ChatStyle {
  ...
  public boolean getStrikethrough() {
    return this.strikethrough == null
        ? this.getParent().getStrikethrough()
  ...
  /**
   * Sets the color for this ChatStyle to the given value. Only use color values for this; set other
   * values using the specific methods.
   */
  public ChatStyle setColor(EnumChatFormatting color) {
    this.color = color;
    return this;
  ...
  /**
   * Sets whether or not text of this ChatStyle should be in bold. Set to false if, e.g., the parent
   * style is bold and you want text of this style to be unbolded.
   */
  public ChatStyle setBold(Boolean boldIn) {
    this.bold = boldIn;
    return this;
  ...
  /**
   * Sets whether or not text of this ChatStyle should be italicized. Set to false if, e.g., the
   * parent style is italicized and you want to override that for this style.
   */
  public ChatStyle setItalic(Boolean italic) {
    this.italic = italic;
    return this;
   ...
   * e.g., the parent style uses strikethrough and you want to override that for this style.
   */
  public ChatStyle setStrikethrough(Boolean strikethrough) {
  ...
  /**
   * Sets whether or not text of this ChatStyle should be underlined. Set to false if, e.g., the
   * parent style is underlined and you want to override that for this style.
   */
  public ChatStyle setUnderlined(Boolean underlined) {
  ...
  /**
   * Sets whether or not text of this ChatStyle should be obfuscated. Set to false if, e.g., the
   * parent style is obfuscated and you want to override that for this style.
   */
  public ChatStyle setObfuscated(Boolean obfuscated) {
  ...
  /**
   * Sets the fallback ChatStyle to use if this ChatStyle does not override some value. Without a
   * parent, obvious defaults are used (bold: false, underlined: false, etc).
   */
  public ChatStyle setParentStyle(ChatStyle parent) {
  ...
  /**
   * Gets the equivalent text formatting code for this style, without the initial section sign
   * (U+00A7) character.
   */
  public String getFormattingCode() {
    if (this.isEmpty()) {
  ...
  /**
   * Creates a shallow copy of this style. Changes to this instance's values will not be reflected
   * in the copy, but changes to the parent style's values WILL be reflected in both this instance
   * and the copy, wherever either does not override a value.
   */
  public ChatStyle createShallowCopy() {
  ...
  /**
   * Creates a deep copy of this style. No changes to this instance or its parent style will be
  ...
  public static class Serializer implements JsonDeserializer<ChatStyle>, JsonSerializer<ChatStyle> {
      ...
      if (p_deserialize_1_.isJsonObject()) {
        ...
        if (jsonobject == null) {
          ...
          if (jsonobject.has("strikethrough")) {
            chatstyle.strikethrough =
                Boolean.valueOf(jsonobject.get("strikethrough").getAsBoolean());
          }
          ...
          if (jsonobject.has("color")) {
            chatstyle.color =
                (EnumChatFormatting)
                    p_deserialize_3_.deserialize(jsonobject.get("color"), EnumChatFormatting.class);
          }
          ...
          if (jsonobject.has("hoverEvent")) {
            ...
            if (jsonobject2 != null) {
              ...
              IChatComponent ichatcomponent =
                  (IChatComponent)
                      p_deserialize_3_.deserialize(jsonobject2.get("value"), IChatComponent.class);

              if (hoverevent$action != null
                  && ichatcomponent != null
    ...
    public JsonElement serialize(
        ChatStyle p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
      if (p_serialize_1_.isEmpty()) {
        ...
        if (p_serialize_1_.chatClickEvent != null) {
          ...
          jsonobject1.addProperty(
              "action", p_serialize_1_.chatClickEvent.getAction().getCanonicalName());
        ...
        if (p_serialize_1_.chatHoverEvent != null) {
          ...
          jsonobject2.addProperty(
              "action", p_serialize_1_.chatHoverEvent.getAction().getCanonicalName());
          jsonobject2.add(
              "value", p_serialize_3_.serialize(p_serialize_1_.chatHoverEvent.getValue()));
