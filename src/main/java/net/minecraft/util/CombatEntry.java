...
public class CombatEntry {
  ...
  /**
   * Returns true if {@link net.minecraft.util.DamageSource#getEntity() damage source} is a living
   * entity
   */
  ...
  public IChatComponent getDamageSrcDisplayName() {
    return this.getDamageSrc().getEntity() == null
        ? null
        : this.getDamageSrc().getEntity().getDisplayName();
  }
