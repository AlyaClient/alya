...
public class StatCollector {
  ...
  /**
   * A StringTranslate instance using the hardcoded default locale (en_US). Used as a fallback in
   * case the shared StringTranslate singleton instance fails to translate a key.
   */
  ...
  /**
   * Translates a Stat name using the fallback (hardcoded en_US) locale. Looks like it's only
   * intended to be used if translateToLocal fails.
   */
