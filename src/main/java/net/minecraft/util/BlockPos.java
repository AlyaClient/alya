...
public class BlockPos extends Vec3i {
  ...
  public BlockPos add(double x, double y, double z) {
    return x == 0.0D && y == 0.0D && z == 0.0D
        ? this
        : new BlockPos(
            (double) this.getX() + x, (double) this.getY() + y, (double) this.getZ() + z);
  }
  ...
  public BlockPos add(Vec3i vec) {
    return vec.getX() == 0 && vec.getY() == 0 && vec.getZ() == 0
        ? this
        : new BlockPos(
            this.getX() + vec.getX(), this.getY() + vec.getY(), this.getZ() + vec.getZ());
  }
        ...
        return new AbstractIterator<BlockPos.MutableBlockPos>() {
          ...
          protected BlockPos.MutableBlockPos computeNext() {
            if (this.theBlockPos == null) {
              this.theBlockPos =
                  new BlockPos.MutableBlockPos(blockpos.getX(), blockpos.getY(), blockpos.getZ());
  ...
  public static final class MutableBlockPos extends BlockPos {
    ...
    public BlockPos.MutableBlockPos func_181079_c(
