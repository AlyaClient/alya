...
public abstract class EntityAgeable extends EntityCreature {
  ...
  /**
   * The age value may be negative or positive or zero. If it's negative, it get's incremented on
   * each tick, if it's positive, it get's decremented each tick. Don't confuse this with
  ...
  /**
   * "Adds the value of the parameter times 20 to the age of this entity. If the entity is an adult
   * (if the entity's age is greater than 0), it will have no effect."
   */
  ...
  /**
   * The age value may be negative or positive or zero. If it's negative, it get's incremented on
   * each tick, if it's positive, it get's decremented each tick. With a negative value the Entity
