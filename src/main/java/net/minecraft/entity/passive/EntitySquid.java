...
public class EntitySquid extends EntityWaterMob {
  ...
  public void onLivingUpdate() {
    ...
    if (this.inWater) {
      ...
      this.renderYawOffset +=
          (-((float) MathHelper.func_181159_b(this.motionX, this.motionZ))
                      * 180.0F
                      / (float) Math.PI
                  - this.renderYawOffset)
              * 0.1F;
      ...
      this.squidYaw =
          (float) ((double) this.squidYaw + Math.PI * (double) this.field_70871_bB * 1.5D);
      this.squidPitch +=
          (-((float) MathHelper.func_181159_b((double) f1, this.motionY)) * 180.0F / (float) Math.PI
                  - this.squidPitch)
              * 0.1F;
    } else {
      this.tentacleAngle =
          MathHelper.abs(MathHelper.sin(this.squidRotation)) * (float) Math.PI * 0.25F;
      ...
      this.squidPitch =
          (float) ((double) this.squidPitch + (double) (-90.0F - this.squidPitch) * 0.02D);
    }
  }
  ...
  public boolean getCanSpawnHere() {
    return this.posY > 45.0D
        && this.posY < (double) this.worldObj.func_181545_F()
  ...
  public void func_175568_b(
      float randomMotionVecXIn, float randomMotionVecYIn, float randomMotionVecZIn) {
  ...
  public boolean func_175567_n() {
    return this.randomMotionVecX != 0.0F
  ...
  static class AIMoveRandom extends EntityAIBase {
    ...
    public void updateTask() {
      ...
      } else if (this.squid.getRNG().nextInt(50) == 0
          || !this.squid.inWater
          || !this.squid.func_175567_n()) {
