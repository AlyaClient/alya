...
public class EntityLightningBolt extends EntityWeatherEffect {
  ...
  /**
   * Determines the time before the EntityLightningBolt is destroyed. It is a random integer
  ...
  public EntityLightningBolt(World worldIn, double posX, double posY, double posZ) {
    ...
    if (!worldIn.isRemote
        ...
        && (worldIn.getDifficulty() == EnumDifficulty.NORMAL
            || worldIn.getDifficulty() == EnumDifficulty.HARD)
      ...
      for (int i = 0; i < 4; ++i) {
        BlockPos blockpos1 =
            blockpos.add(
                this.rand.nextInt(3) - 1, this.rand.nextInt(3) - 1, this.rand.nextInt(3) - 1);
