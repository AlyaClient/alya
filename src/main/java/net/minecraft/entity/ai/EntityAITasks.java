...
public class EntityAITasks {
  ...
  private List<EntityAITasks.EntityAITaskEntry> taskEntries =
      Lists.<EntityAITasks.EntityAITaskEntry>newArrayList();
  ...
  public void onUpdateTasks() {
    ...
    if (this.tickCount++ % this.tickRate == 0) {
      ...
      while (iterator1.hasNext()) {
        EntityAITasks.EntityAITaskEntry entityaitasks$entityaitaskentry1 =
            (EntityAITasks.EntityAITaskEntry) iterator1.next();
    ...
    for (EntityAITasks.EntityAITaskEntry entityaitasks$entityaitaskentry2 :
        this.executingTaskEntries) {
  ...
  /**
   * Determine if a specific AI Task can be executed, which means that all running higher (= lower
   * int value) priority tasks are compatible with it or all lower priority tasks can be
   * interrupted.
   */
  ...
  private boolean areTasksCompatible(
      EntityAITasks.EntityAITaskEntry taskEntry1, EntityAITasks.EntityAITaskEntry taskEntry2) {
