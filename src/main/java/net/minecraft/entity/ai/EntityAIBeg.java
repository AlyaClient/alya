...
public class EntityAIBeg extends EntityAIBase {
  ...
  public boolean shouldExecute() {
    this.thePlayer =
        this.worldObject.getClosestPlayerToEntity(this.theWolf, (double) this.minPlayerDistance);
  ...
  public boolean continueExecuting() {
    return !this.thePlayer.isEntityAlive()
        ...
        : (this.theWolf.getDistanceSqToEntity(this.thePlayer)
                > (double) (this.minPlayerDistance * this.minPlayerDistance)
            ? false
  ...
  private boolean hasPlayerGotBoneInHand(EntityPlayer player) {
    ...
    return itemstack == null
        ? false
        : (!this.theWolf.isTamed() && itemstack.getItem() == Items.bone
            ? true
