...
public class EntityAIMate extends EntityAIBase {
  ...
  public void updateTask() {
    this.theAnimal
        ...
        .setLookPositionWithEntity(
            this.targetMate, 10.0F, (float) this.theAnimal.getVerticalFaceSpeed());
   ...
   * Returns the first valid mate found.
   */
  private EntityAnimal getNearbyMate() {
    float f = 8.0F;
    List<EntityAnimal> list =
        this.theWorld.<EntityAnimal>getEntitiesWithinAABB(
  ...
  private void spawnBaby() {
    ...
    if (entityageable != null) {
      ...
      for (int i = 0; i < 7; ++i) {
        ...
        double d3 =
            random.nextDouble() * (double) this.theAnimal.width * 2.0D
        ...
        this.theWorld.spawnParticle(
            ...
            this.theAnimal.posX + d3,
            this.theAnimal.posY + d4,
            this.theAnimal.posZ + d5,
            d0,
            d1,
            d2,
            new int[0]);
