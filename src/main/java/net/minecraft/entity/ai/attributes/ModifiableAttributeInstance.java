...
public class ModifiableAttributeInstance implements IAttributeInstance {
  ...
  private final Map<Integer, Set<AttributeModifier>> mapByOperation =
      Maps.<Integer, Set<AttributeModifier>>newHashMap();
  private final Map<String, Set<AttributeModifier>> mapByName =
      Maps.<String, Set<AttributeModifier>>newHashMap();
  ...
  public ModifiableAttributeInstance(
      BaseAttributeMap attributeMapIn, IAttribute genericAttributeIn) {
  ...
  private Collection<AttributeModifier> func_180375_b(int p_180375_1_) {
    ...
    for (IAttribute iattribute = this.genericAttribute.func_180372_d();
        iattribute != null;
