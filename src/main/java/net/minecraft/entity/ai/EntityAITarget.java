...
public abstract class EntityAITarget extends EntityAIBase {
   ...
   * the entity does't see the target
   */
   ...
   * @param includeInvincibles should ignore {@link
   *     net.minecraft.entity.player.EntityPlayer#capabilities EntityPlayer.capabilities}.{@link
   *     net.minecraft.entity.player.PlayerCapabilities#disableDamage disableDamage}
