...
public class EntityAITempt extends EntityAIBase {
  ...
  /**
   * A counter that is decremented each time the shouldExecute method is called. The shouldExecute
   * method will always return false if delayTemptCounter is greater than 0.
   */
  ...
  public EntityAITempt(
      EntityCreature temptedEntityIn,
      double speedIn,
      Item temptItemIn,
  ...
  public boolean shouldExecute() {
    if (this.delayTemptCounter > 0) {
      ...
      this.temptingPlayer =
          this.temptedEntity.worldObj.getClosestPlayerToEntity(this.temptedEntity, 10.0D);
  ...
  public void updateTask() {
    this.temptedEntity
        ...
        .setLookPositionWithEntity(
            this.temptingPlayer, 30.0F, (float) this.temptedEntity.getVerticalFaceSpeed());
