...
public class EntityAIFindEntityNearest extends EntityAIBase {
  private static final Logger field_179444_a =
      LogManager.getLogger(EntityAIFindEntityNearest.class);
  ...
  public EntityAIFindEntityNearest(
      EntityLiving p_i45884_1_, Class<? extends EntityLivingBase> p_i45884_2_) {
        ...
        new Predicate<EntityLivingBase>() {
          public boolean apply(EntityLivingBase p_apply_1_) {
            ...
            return p_apply_1_.isInvisible()
                ? false
                : ((double)
                            p_apply_1_.getDistanceToEntity(
                                EntityAIFindEntityNearest.this.field_179442_b)
                        > d0
                    ? false
  ...
  public boolean shouldExecute() {
    ...
    List<EntityLivingBase> list =
        this.field_179442_b.worldObj.<EntityLivingBase>getEntitiesWithinAABB(
            this.field_179439_f,
            this.field_179442_b.getEntityBoundingBox().expand(d0, 4.0D, d0),
            this.field_179443_c);
  ...
  protected double func_179438_f() {
    IAttributeInstance iattributeinstance =
        this.field_179442_b.getEntityAttribute(SharedMonsterAttributes.followRange);
