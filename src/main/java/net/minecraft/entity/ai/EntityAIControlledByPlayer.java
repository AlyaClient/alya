...
public class EntityAIControlledByPlayer extends EntityAIBase {
  ...
  public void updateTask() {
    ...
    float f =
        MathHelper.wrapAngleTo180_float(entityplayer.rotationYaw - this.thisEntity.rotationYaw)
            * 0.5F;
          ...
          this.thisEntity
                  ...
                  .getBlockState(
                      new BlockPos(
                          ...
                          MathHelper.floor_float((float) k)))
                  .getBlock()
                  .slipperiness
              * 0.91F;
    }
    ...
    if (i != l || k != i1) {
      ...
      boolean flag =
          !this.isStairOrSlab(block)
              && (block.getMaterial() != Material.air
                  || !this.isStairOrSlab(
                      this.thisEntity
                          .worldObj
                          .getBlockState(new BlockPos(i, j - 1, k))
                          .getBlock()));

      if (flag
          && 0
              == WalkNodeProcessor.func_176170_a(
                  this.thisEntity.worldObj,
                  this.thisEntity,
                  l,
                  j,
                  i1,
