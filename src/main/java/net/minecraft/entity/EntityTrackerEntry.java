...
public class EntityTrackerEntry {
  ...
  /**
   * every 400 ticks a full teleport packet is sent, rather than just a "move me +x" command, so
   * that position remains fully synced.
   */
  ...
  public EntityTrackerEntry(
    ...
    this.encodedRotationPitch =
        MathHelper.floor_float(trackedEntityIn.rotationPitch * 256.0F / 360.0F);
    this.lastHeadMotion =
        MathHelper.floor_float(trackedEntityIn.getRotationYawHead() * 256.0F / 360.0F);
    this.onGround = trackedEntityIn.onGround;
  }

  public boolean equals(Object p_equals_1_) {
    return p_equals_1_ instanceof EntityTrackerEntry
        ? ((EntityTrackerEntry) p_equals_1_).trackedEntity.getEntityId()
  ...
  public void updatePlayerList(List<EntityPlayer> p_73122_1_) {
    ...
    if (!this.firstUpdateDone
        || this.trackedEntity.getDistanceSq(
                this.lastTrackedEntityPosX, this.lastTrackedEntityPosY, this.lastTrackedEntityPosZ)
            > 16.0D) {
    ...
    if (this.trackedEntity instanceof EntityItemFrame && this.updateCounter % 10 == 0) {
      ...
      if (itemstack != null && itemstack.getItem() instanceof ItemMap) {
        ...
        for (EntityPlayer entityplayer : p_73122_1_) {
          ...
          Packet packet =
              Items.filled_map.createMapDataPacket(
                  itemstack, this.trackedEntity.worldObj, entityplayermp);
    ...
    if (this.updateCounter % this.updateFrequency == 0
      ...
      if (this.trackedEntity.ridingEntity == null) {
        ...
        boolean flag1 =
            Math.abs(l1 - this.encodedRotationYaw) >= 4
        ...
        if (this.updateCounter > 0 || this.trackedEntity instanceof EntityArrow) {
          if (j2 >= -128
            ...
            if ((!flag || !flag1) && !(this.trackedEntity instanceof EntityArrow)) {
              if (flag) {
                packet1 =
                    new S14PacketEntity.S15PacketEntityRelMove(
                        this.trackedEntity.getEntityId(),
                        (byte) j2,
                        (byte) k2,
                        (byte) i,
        ...
        boolean flag2 =
            Math.abs(j - this.encodedRotationYaw) >= 4
   ...
   * including the entity itself if a player.
   */
  private void sendMetadataToAllAssociatedPlayers() {
    ...
    if (this.trackedEntity instanceof EntityLivingBase) {
      ServersideAttributeMap serversideattributemap =
          (ServersideAttributeMap) ((EntityLivingBase) this.trackedEntity).getAttributeMap();
        ...
        if (!this.trackingPlayers.contains(playerMP)
          ...
          if (this.trackedEntity instanceof EntityLivingBase) {
            ...
            Collection<IAttributeInstance> collection =
                serversideattributemap.getWatchedAttributes();
          ...
          if (this.trackedEntity instanceof EntityPlayer) {
            ...
            if (entityplayer.isPlayerSleeping()) {
              playerMP.playerNetServerHandler.sendPacket(
                  new S0APacketUseBed(entityplayer, new BlockPos(this.trackedEntity)));
            }
          }
  ...
  private boolean isPlayerWatchingThisChunk(EntityPlayerMP playerMP) {
    return playerMP
        ...
        .isPlayerWatchingChunk(
            playerMP, this.trackedEntity.chunkCoordX, this.trackedEntity.chunkCoordZ);
  }
  ...
  private Packet func_151260_c() {
    ...
    if (this.trackedEntity instanceof EntityItem) {
      ...
      return new S0EPacketSpawnObject(
          this.trackedEntity, 10, entityminecart.getMinecartType().getNetworkID());
      ...
      this.lastHeadMotion =
          MathHelper.floor_float(this.trackedEntity.getRotationYawHead() * 256.0F / 360.0F);
      ...
      if (entityfireball.shootingEntity != null) {
        s0epacketspawnobject2 =
            new S0EPacketSpawnObject(
                this.trackedEntity,
                i,
      ...
      return new S0EPacketSpawnObject(
          this.trackedEntity, 70, Block.getStateId(entityfallingblock.getBlock()));
      ...
      EntityItemFrame entityitemframe = (EntityItemFrame) this.trackedEntity;
      S0EPacketSpawnObject s0epacketspawnobject1 =
          new S0EPacketSpawnObject(
              this.trackedEntity, 71, entityitemframe.facingDirection.getHorizontalIndex());
      ...
      throw new IllegalArgumentException(
          "Don\'t know how to add " + this.trackedEntity.getClass() + "!");
    }
  }

  /**
   * Remove a tracked player from our list and tell the tracked player to destroy us from their
   * world.
   */
