...
public class EntityCreeper extends EntityMob {
  ...
  public void readEntityFromNBT(NBTTagCompound tagCompund) {
    ...
    this.dataWatcher.updateObject(
        17, Byte.valueOf((byte) (tagCompund.getBoolean("powered") ? 1 : 0)));
  ...
  public float getCreeperFlashIntensity(float p_70831_1_) {
    return ((float) this.lastActiveTime
            + (float) (this.timeSinceIgnited - this.lastActiveTime) * p_70831_1_)
  ...
  private void explode() {
    if (!this.worldObj.isRemote) {
      ...
      this.worldObj.createExplosion(
          this, this.posX, this.posY, this.posZ, (float) this.explosionRadius * f, flag);
      this.setDead();
    }
  }
