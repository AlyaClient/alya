...
public class EntityEnderman extends EntityMob {
  ...
  private static final AttributeModifier attackingSpeedBoostModifier =
      (new AttributeModifier(
              attackingSpeedBoostModifierUUID, "Attacking speed boost", 0.15000000596046448D, 0))
          .setSaved(false);
  ...
  public void writeEntityToNBT(NBTTagCompound tagCompound) {
    ...
    tagCompound.setShort(
        "carriedData", (short) iblockstate.getBlock().getMetaFromState(iblockstate));
  }
  ...
  public void readEntityFromNBT(NBTTagCompound tagCompund) {
    ...
    if (tagCompund.hasKey("carried", 8)) {
      iblockstate =
          Block.getBlockFromName(tagCompund.getString("carried"))
              .getStateFromMeta(tagCompund.getShort("carriedData") & 65535);
    } else {
      iblockstate =
          Block.getBlockById(tagCompund.getShort("carried"))
              .getStateFromMeta(tagCompund.getShort("carriedData") & 65535);
    }
  ...
  protected void updateAITasks() {
    ...
    if (this.worldObj.isDaytime()) {
      ...
      if (f > 0.5F
          && this.worldObj.canSeeSky(new BlockPos(this))
      ...
      for (int j = 0; j < i; ++j) {
        ...
        double d5 =
            d2
                ...
                + (this.rand.nextDouble() - 0.5D) * (double) this.width * 2.0D;
        this.worldObj.spawnParticle(
            EnumParticleTypes.PORTAL, d3, d4, d5, (double) f, (double) f1, (double) f2, new int[0]);
      }
  ...
  static class AIFindPlayer extends EntityAINearestAttackableTarget {
    ...
    public boolean shouldExecute() {
      ...
      List<EntityPlayer> list =
          this.taskOwner.worldObj.<EntityPlayer>getEntitiesWithinAABB(
              EntityPlayer.class,
    ...
    public void resetTask() {
      ...
      IAttributeInstance iattributeinstance =
          this.enderman.getEntityAttribute(SharedMonsterAttributes.movementSpeed);
