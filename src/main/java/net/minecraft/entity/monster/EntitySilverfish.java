...
public class EntitySilverfish extends EntityMob {
  ...
  public float getBlockPathWeight(BlockPos pos) {
    return this.worldObj.getBlockState(pos.down()).getBlock() == Blocks.stone
        ? 10.0F
    ...
    public boolean shouldExecute() {
      if (this.field_179485_a.getAttackTarget() != null) {
        ...
        if (random.nextInt(10) == 0) {
          ...
          BlockPos blockpos =
              (new BlockPos(
                      this.field_179485_a.posX,
                      this.field_179485_a.posY + 0.5D,
                      this.field_179485_a.posZ))
                  .offset(this.facing);
        ...
        if (BlockSilverfish.canContainSilverfish(iblockstate)) {
          world.setBlockState(
              ...
              Blocks.monster_egg
                  .getDefaultState()
                  .withProperty(
                      BlockSilverfish.VARIANT, BlockSilverfish.EnumType.forModelBlock(iblockstate)),
              3);
