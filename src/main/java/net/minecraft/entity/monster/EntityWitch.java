...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
  ...
  private static final AttributeModifier MODIFIER =
      (new AttributeModifier(MODIFIER_UUID, "Drinking speed penalty", -0.25D, 0)).setSaved(false);
  ...
  /**
   * Timer used as interval for a witch's attack, decremented every tick if aggressive and when
   * reaches zero the witch will throw a potion at the target entity.
   */
    ...
    if (id == 15) {
      for (int i = 0; i < this.rand.nextInt(35) + 10; ++i) {
        this.worldObj.spawnParticle(
            ...
            this.getEntityBoundingBox().maxY
                + 0.5D
