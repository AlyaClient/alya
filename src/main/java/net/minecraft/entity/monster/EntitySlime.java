...
public class EntitySlime extends EntityLiving implements IMob {
  ...
  protected void func_175451_e(EntityLivingBase p_175451_1_) {
    ...
    if (this.canEntityBeSeen(p_175451_1_)
        ...
        && p_175451_1_.attackEntityFrom(
            DamageSource.causeMobDamage(this), (float) this.getAttackStrength())) {
      this.playSound(
  ...
  /**
   * Returns true if the slime makes a sound when it lands after a jump (based upon the slime's
   * size)
   */
  ...
  static class AISlimeAttack extends EntityAIBase {
    ...
    public void updateTask() {
      ...
      ((EntitySlime.SlimeMoveHelper) this.slime.getMoveHelper())
          .func_179920_a(this.slime.rotationYaw, this.slime.canDamagePlayer());
    }
  }
  ...
  static class AISlimeFaceRandom extends EntityAIBase {
    ...
    public void updateTask() {
      ...
      ((EntitySlime.SlimeMoveHelper) this.slime.getMoveHelper())
          .func_179920_a(this.field_179459_b, false);
    }
  }
  ...
  static class SlimeMoveHelper extends EntityMoveHelper {
    ...
    public void onUpdateMoveHelper() {
      this.entity.rotationYaw =
          this.limitAngle(this.entity.rotationYaw, this.field_179922_g, 30.0F);
