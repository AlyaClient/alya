...
public class EntityXPOrb extends Entity {
  /**
   * A constantly increasing value that RenderXPOrb uses to control the colour shifting (Green /
   * yellow)
   */
  public int xpColor;
  ...
  public EntityXPOrb(World worldIn, double x, double y, double z, int expValue) {
    ...
    this.motionX =
        (double) ((float) (Math.random() * 0.20000000298023224D - 0.10000000149011612D) * 2.0F);
  ...
  public void onUpdate() {
    ...
    if (this.closestPlayer != null) {
      ...
      double d2 =
          (this.closestPlayer.posY + (double) this.closestPlayer.getEyeHeight() - this.posY) / d0;
  ...
  public boolean handleWaterMovement() {
    return this.worldObj.handleMaterialAcceleration(
        this.getEntityBoundingBox(), Material.water, this);
  }
  ...
  /**
   * Returns a number from 1 to 10 based on how much XP this orb is worth. This is used by
   * RenderXPOrb to determine what texture to use.
   */
  ...
  /**
   * Get a fragment of the maximum experience points value for the supplied value of experience
   * points value.
   *
