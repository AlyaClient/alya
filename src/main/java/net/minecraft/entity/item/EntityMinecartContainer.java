...
public abstract class EntityMinecartContainer extends EntityMinecart implements ILockableContainer {
  ...
  /**
   * When set to true, the minecart will drop all items when setDead() is called. When false (such
   * as when travelling dimensions) it preserves its contents.
   */
  ...
  public EntityMinecartContainer(
      World worldIn, double p_i1717_2_, double p_i1717_4_, double p_i1717_6_) {
