...
public class EntityItem extends Entity {
  ...
  public void onUpdate() {
    if (this.getEntityItem() == null) {
      ...
      boolean flag =
          (int) this.prevPosX != (int) this.posX
              || (int) this.prevPosY != (int) this.posY
              || (int) this.prevPosZ != (int) this.posZ;

      if (flag || this.ticksExisted % 25 == 0) {
        if (this.worldObj.getBlockState(new BlockPos(this)).getBlock().getMaterial()
            == Material.lava) {
          this.motionY = 0.20000000298023224D;
  ...
  private void searchForOtherItemsNearby() {
    for (EntityItem entityitem :
        this.worldObj.getEntitiesWithinAABB(
            EntityItem.class, this.getEntityBoundingBox().expand(0.5D, 0.0D, 0.5D))) {
      ...
      if (this.delayBeforeCanPickup != 32767 && other.delayBeforeCanPickup != 32767) {
        if (this.age != -32768 && other.age != -32768) {
          if (itemstack1.getItem() != itemstack.getItem()) {
            ...
            other.delayBeforeCanPickup =
                Math.max(other.delayBeforeCanPickup, this.delayBeforeCanPickup);
  ...
  public void onCollideWithPlayer(EntityPlayer entityIn) {
    if (!this.worldObj.isRemote) {
      ...
      if (this.delayBeforeCanPickup == 0
          && (this.owner == null
              || 6000 - this.age <= 200
              || this.owner.equals(entityIn.getCommandSenderName()))
  ...
  /**
   * Returns the ItemStack corresponding to the Entity (Note: if no item exists, will log an error
   * but still return an ItemStack containing Block.stone)
   */
