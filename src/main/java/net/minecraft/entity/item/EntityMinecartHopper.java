...
public class EntityMinecartHopper extends EntityMinecartContainer implements IHopper {
  ...
  public EntityMinecartHopper(
      World worldIn, double p_i1721_2_, double p_i1721_4_, double p_i1721_6_) {
  ...
  public boolean func_96112_aD() {
    if (TileEntityHopper.captureDroppedItems(this)) {
      ...
      List<EntityItem> list =
          this.worldObj.<EntityItem>getEntitiesWithinAABB(
              EntityItem.class,
              this.getEntityBoundingBox().expand(0.25D, 0.0D, 0.25D),
