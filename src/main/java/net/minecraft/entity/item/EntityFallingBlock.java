...
public class EntityFallingBlock extends Entity {
  ...
  public EntityFallingBlock(
      World worldIn, double x, double y, double z, IBlockState fallingBlockState) {
    super(worldIn);
        ...
        if (this.onGround) {
          ...
          if (this.worldObj.getBlockState(blockpos1).getBlock() != Blocks.piston_extension) {
            ...
            if (!this.canSetAsBlock) {
              if (this.worldObj.canBlockBePlaced(
                      block, blockpos1, true, EnumFacing.UP, (Entity) null, (ItemStack) null)
                ...
                if (this.tileEntityData != null && block instanceof ITileEntityProvider) {
                  ...
                  && this.worldObj.getGameRules().getGameRuleBooleanValue("doEntityDrops")) {
                this.entityDropItem(
                ...
                && (blockpos1.getY() < 1 || blockpos1.getY() > 256)
            || this.fallTime > 600) {
      ...
      if (i > 0) {
        ...
        for (Entity entity : list) {
          entity.attackEntityFrom(
              ...
              (float)
                  Math.min(
                      MathHelper.floor_float((float) i * this.fallHurtAmount), this.fallHurtMax));
        }
  ...
  public void addEntityCrashInfo(CrashReportCategory category) {
    ...
    if (this.fallTile != null) {
      ...
      category.addCrashSection(
          "Immitating block data", Integer.valueOf(block.getMetaFromState(this.fallTile)));
    }
  }
