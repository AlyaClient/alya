...
public abstract class EntityLivingBase extends Entity {
  ...
  private static final AttributeModifier sprintingSpeedBoostModifier =
      (new AttributeModifier(
              sprintingSpeedBoostModifierUUID, "Sprinting speed boost", 0.30000001192092896D, 2))
          .setSaved(false);
  private BaseAttributeMap attributeMap;
  private final CombatTracker _combatTracker = new CombatTracker(this);
  private final Map<Integer, PotionEffect> activePotionsMap =
      Maps.<Integer, PotionEffect>newHashMap();
  ...
  /**
   * Only relevant when limbYaw is not 0(the entity is moving). Influences where in its swing legs
   * and arms currently are.
   */
  ...
  /**
   * Set to 60 when hit by the player or the player's wolf, then decrements. Used to determine
   * whether the entity should drop items on death.
   */
  ...
  /**
   * Damage taken in the last hit. Mobs are resistant to damage less than this for a short time
   * after taking damage.
   */
  ...
  public void onEntityUpdate() {
    ...
    if (this.isEntityAlive()) {
      if (this.isEntityInsideOpaqueBlock()) {
        ...
        double d0 =
            this.worldObj.getWorldBorder().getClosestDistance(this)
              ...
              (float)
                  Math.max(
                      ...
                      MathHelper.floor_double(
                          -d0 * this.worldObj.getWorldBorder().getDamageAmount())));
        }
      }
    }
    ...
    if (this.isEntityAlive()) {
      if (this.isInsideOfMaterial(Material.water)) {
        if (!this.canBreatheUnderwater()
            && !this.isPotionActive(Potion.waterBreathing.id)
            && !flag1) {
  ...
  public void writeEntityToNBT(NBTTagCompound tagCompound) {
    ...
    tagCompound.setTag(
        "Attributes", SharedMonsterAttributes.writeBaseAttributeMapToNBT(this.getAttributeMap()));
  ...
  public void readEntityFromNBT(NBTTagCompound tagCompund) {
    ...
    if (tagCompund.hasKey("Attributes", 9) && this.worldObj != null && !this.worldObj.isRemote) {
      SharedMonsterAttributes.func_151475_a(
          this.getAttributeMap(), tagCompund.getTagList("Attributes", 10));
    }
  ...
  protected void updatePotionMetadata() {
    if (this.activePotionsMap.isEmpty()) {
      ...
      this.dataWatcher.updateObject(
          8,
          Byte.valueOf(
              (byte) (PotionHelper.getAreAmbient(this.activePotionsMap.values()) ? 1 : 0)));
  ...
  public void removePotionEffect(int potionId) {
    PotionEffect potioneffect =
        (PotionEffect) this.activePotionsMap.remove(Integer.valueOf(potionId));
  ...
  protected void onNewPotionEffect(PotionEffect id) {
    ...
    if (!this.worldObj.isRemote) {
      Potion.potionTypes[id.getPotionID()].applyAttributesModifiersToEntity(
          this, this.getAttributeMap(), id.getAmplifier());
    }
  }
  ...
  protected void onChangedPotionEffect(PotionEffect id, boolean p_70695_2_) {
    ...
    if (p_70695_2_ && !this.worldObj.isRemote) {
      Potion.potionTypes[id.getPotionID()].removeAttributesModifiersFromEntity(
          this, this.getAttributeMap(), id.getAmplifier());
      Potion.potionTypes[id.getPotionID()].applyAttributesModifiersToEntity(
          this, this.getAttributeMap(), id.getAmplifier());
    }
  ...
  protected void onFinishedPotionEffect(PotionEffect p_70688_1_) {
    ...
    if (!this.worldObj.isRemote) {
      Potion.potionTypes[p_70688_1_.getPotionID()].removeAttributesModifiersFromEntity(
          this, this.getAttributeMap(), p_70688_1_.getAmplifier());
    }
  }
  ...
  public void setHealth(float health) {
    this.dataWatcher.updateObject(
        6, Float.valueOf(MathHelper.clamp_float(health, 0.0F, this.getMaxHealth())));
  }
      ...
      if (this.getHealth() <= 0.0F) {
        ...
        if (flag) {
          ...
          if (entity != null) {
            ...
            this.attackedAtYaw =
                (float)
                    (MathHelper.func_181159_b(d0, d1) * 180.0D / Math.PI
    ...
    if (i > 0) {
      ...
      if (block.getMaterial() != Material.air) {
        ...
        this.playSound(
            ...
            block$soundtype.getVolume() * 0.5F,
  ...
  public EntityLivingBase func_94060_bK() {
    return (EntityLivingBase)
        (this._combatTracker.func_94550_c() != null
  ...
  /**
   * counts the amount of arrows stuck in the entity. getting hit by arrows increases this, used in
   * rendering
   */
  ...
  /**
   * Returns an integer indicating the end point of the swing animation, used by {@link
   * #swingProgress} to provide a progress indicator. Takes dig speed enchantments into account.
   */
  ...
  public void swingItem() {
    if (!this.isSwingInProgress
      ...
      if (this.worldObj instanceof WorldServer) {
        ((WorldServer) this.worldObj)
            .getEntityTracker()
            .sendToAllTrackingEntity(this, new S0BPacketAnimation(this, 0));
      }
    }
  }
      ...
      for (int k = -i; k < i; ++k) {
        if (j != 0 || k != 0) {
          ...
          AxisAlignedBB axisalignedbb =
              this.getEntityBoundingBox().offset((double) j, 1.0D, (double) k);

          if (this.worldObj.func_147461_a(axisalignedbb).isEmpty()) {
            if (World.doesBlockHaveSolidTopSurface(
                this.worldObj, new BlockPos(l, (int) this.posY, i1))) {
              this.setPositionAndUpdate(
                  this.posX + (double) j, this.posY + 1.0D, this.posZ + (double) k);
              return;
            }

            if (World.doesBlockHaveSolidTopSurface(
                    this.worldObj, new BlockPos(l, (int) this.posY - 1, i1))
                || this.worldObj
                        .getBlockState(new BlockPos(l, (int) this.posY - 1, i1))
                        .getBlock()
                        .getMaterial()
                    == Material.water) {
      ...
      if (!this.isInWater()
        ...
        if (!this.isInLava()
          ...
          if (this.isCollidedHorizontally
              && this.isOffsetPositionInLiquid(
                  this.motionX,
                  this.motionY + 0.6000000238418579D - this.posY + d1,
                  this.motionZ)) {
        ...
        if (this.isCollidedHorizontally
            && this.isOffsetPositionInLiquid(
                this.motionX, this.motionY + 0.6000000238418579D - this.posY + d0, this.motionZ)) {
          this.motionY = 0.30000001192092896D;
        }
      }
    }
  ...
  public void onUpdate() {
        ...
        if (!ItemStack.areItemStacksEqual(itemstack1, itemstack)) {
          ((WorldServer) this.worldObj)
              ...
              .sendToAllTrackingEntity(
                  this, new S04PacketEntityEquipment(this.getEntityId(), j, itemstack1));
    ...
    if (this.swingProgress > 0.0F) {
      f1 =
          EntityPlayerSP.motionEvent == null || this != Minecraft.getMinecraft().thePlayer
              ? this.rotationYaw
              : EntityPlayerSP.motionEvent.getYaw();
    }
  ...
  public boolean canEntityBeSeen(Entity entityIn) {
    return this.worldObj.rayTraceBlocks(
            ...
            new Vec3(
                entityIn.posX, entityIn.posY + (double) entityIn.getEyeHeight(), entityIn.posZ))
        == null;
  }
