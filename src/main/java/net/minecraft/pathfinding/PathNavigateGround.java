...
public class PathNavigateGround extends PathNavigate {
  ...
  protected boolean canNavigate() {
    return this.theEntity.onGround
        ...
        || this.theEntity.isRiding()
            && this.theEntity instanceof EntityZombie
  ...
  protected void removeSunnyPath() {
    ...
    if (this.shouldAvoidSun) {
      ...
      for (int i = 0; i < this.currentPath.getCurrentPathLength(); ++i) {
        ...
        if (this.worldObj.canSeeSky(
            new BlockPos(pathpoint.xCoord, pathpoint.yCoord, pathpoint.zCoord))) {
  ...
  protected boolean isDirectPathBetweenPoints(
    ...
    if (d2 < 1.0E-8D) {
      ...
      if (!this.isSafeToStandAt(
          i, (int) posVec31.yCoord, j, sizeX, sizeY, sizeZ, posVec31, d0, d1)) {
        return false;
      } else {
        sizeX = sizeX - 2;
        sizeZ = sizeZ - 2;
  ...
  private boolean isPositionClear(
    ...
    for (BlockPos blockpos :
        BlockPos.getAllInBox(
            ...
            new BlockPos(
                p_179692_1_ + p_179692_4_ - 1,
                p_179692_2_ + p_179692_5_ - 1,
                p_179692_3_ + p_179692_6_ - 1))) {
