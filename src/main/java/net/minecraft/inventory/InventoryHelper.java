...
public class InventoryHelper {
  ...
  public static void dropInventoryItems(World worldIn, BlockPos pos, IInventory p_180175_2_) {
    func_180174_a(
        worldIn, (double) pos.getX(), (double) pos.getY(), (double) pos.getZ(), p_180175_2_);
  }
  ...
  private static void func_180174_a(
      World worldIn, double x, double y, double z, IInventory p_180174_7_) {
