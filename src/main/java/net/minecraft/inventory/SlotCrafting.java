...
public class SlotCrafting extends Slot {
  ...
  /**
   * The number of items that have been crafted so far. Gets passed to ItemStack.onCrafting before
   * being reset.
   */
  ...
  public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
    ...
    ItemStack[] aitemstack =
        CraftingManager.getInstance().func_180303_b(this.craftMatrix, playerIn.worldObj);
