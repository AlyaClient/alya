...
public class ContainerHopper extends Container {
  ...
  public ContainerHopper(
      InventoryPlayer playerInventory, IInventory hopperInventoryIn, EntityPlayer player) {
    ...
    if (slot != null && slot.getHasStack()) {
      ...
      if (index < this.hopperInventory.getSizeInventory()) {
        if (!this.mergeItemStack(
          ...
          itemstack1, 0, this.hopperInventory.getSizeInventory(), false)) {
        return null;
      }
