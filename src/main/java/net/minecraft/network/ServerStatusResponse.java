...
public class ServerStatusResponse {
  ...
  public void setProtocolVersionInfo(
      ServerStatusResponse.MinecraftProtocolVersionIdentifier protocolVersionData) {
  ...
  public static class PlayerCountData {
    ...
    public static class Serializer
      ...
      public ServerStatusResponse.PlayerCountData deserialize(
        ...
        ServerStatusResponse.PlayerCountData serverstatusresponse$playercountdata =
          ...
          if (jsonarray.size() > 0) {
            ...
            for (int i = 0; i < agameprofile.length; ++i) {
              JsonObject jsonobject1 =
                  JsonUtils.getJsonObject(jsonarray.get(i), "player[" + i + "]");
              String s = JsonUtils.getString(jsonobject1, "id");
              agameprofile[i] =
                  new GameProfile(UUID.fromString(s), JsonUtils.getString(jsonobject1, "name"));
            }
      ...
      public JsonElement serialize(
        ...
        jsonobject.addProperty(
            "online", (Number) Integer.valueOf(p_serialize_1_.getOnlinePlayerCount()));
  ...
  public static class Serializer
    ...
    public ServerStatusResponse deserialize(
        JsonElement p_deserialize_1_,
        Type p_deserialize_2_,
        JsonDeserializationContext p_deserialize_3_)
        throws JsonParseException {
        ...
        serverstatusresponse.setPlayerCountData(
            (ServerStatusResponse.PlayerCountData)
                p_deserialize_3_.deserialize(
                    jsonobject.get("players"), ServerStatusResponse.PlayerCountData.class));
      }
    ...
    public JsonElement serialize(
      ...
      if (p_serialize_1_.getServerDescription() != null) {
        jsonobject.add(
            "description", p_serialize_3_.serialize(p_serialize_1_.getServerDescription()));
      }
      ...
      if (p_serialize_1_.getProtocolVersionInfo() != null) {
        jsonobject.add(
            "version", p_serialize_3_.serialize(p_serialize_1_.getProtocolVersionInfo()));
      }
