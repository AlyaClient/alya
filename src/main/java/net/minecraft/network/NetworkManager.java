...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
  ...
  private final Queue<NetworkManager.InboundHandlerTuplePacketListener> outboundPacketsQueue =
  ...
  public void exceptionCaught(
      ChannelHandlerContext p_exceptionCaught_1_, Throwable p_exceptionCaught_2_) throws Exception {
  ...
  protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_)
    ...
    if (this.channel.isOpen()) {
      try {
        ...
        if (!packetReceiveEvent.isCanceled()) p_channelRead0_2_.processPacket(this.packetListener);
              ...
              new Runnable() {
                public void run() {
                  ...
                  ChannelFuture channelfuture1 =
                      NetworkManager.this.channel.writeAndFlush(inPacket);
      ...
      try {
        while (!this.outboundPacketsQueue.isEmpty()) {
          NetworkManager.InboundHandlerTuplePacketListener
              networkmanager$inboundhandlertuplepacketlistener =
                  (NetworkManager.InboundHandlerTuplePacketListener)
                      this.outboundPacketsQueue.poll();
          this.dispatchPacket(
  ...
  public static NetworkManager func_181124_a(
      InetAddress p_181124_0_, int p_181124_1_, boolean p_181124_2_) {
    ...
    ((Bootstrap)
            ((Bootstrap)
                    ((Bootstrap) (new Bootstrap()).group((EventLoopGroup) lazyloadbase.getValue()))
                        .handler(
