...
public class S2APacketParticles implements Packet<INetHandlerPlayClient> {
  ...
  /**
   * These are the block/item ids and possibly metaData ids that are used to color or texture the
   * particle.
   */
  ...
  /**
   * Gets the x coordinate offset for the particle. The particle may use the offset for particle
   * spread.
   */
  ...
  /**
   * Gets the y coordinate offset for the particle. The particle may use the offset for particle
   * spread.
   */
  ...
  /**
   * Gets the z coordinate offset for the particle. The particle may use the offset for particle
   * spread.
   */
  ...
  /**
   * Gets the particle arguments. Some particles rely on block and/or item ids and sometimes
   * metadata ids to color or texture the particle.
   */
