...
public class S20PacketEntityProperties implements Packet<INetHandlerPlayClient> {
  ...
  private final List<S20PacketEntityProperties.Snapshot> field_149444_b =
      Lists.<S20PacketEntityProperties.Snapshot>newArrayList();
    ...
    for (IAttributeInstance iattributeinstance : p_i45236_2_) {
      this.field_149444_b.add(
          new S20PacketEntityProperties.Snapshot(
              iattributeinstance.getAttribute().getAttributeUnlocalizedName(),
      ...
      for (int l = 0; l < k; ++l) {
        ...
        list.add(
            new AttributeModifier(
                uuid, "Unknown synced attribute modifier", buf.readDouble(), buf.readByte()));
      }
  ...
  public class Snapshot {
    ...
    public Snapshot(
        String p_i45235_2_, double p_i45235_3_, Collection<AttributeModifier> p_i45235_5_) {
