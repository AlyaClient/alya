...
public class Scoreboard {
  ...
  private final Map<String, ScorePlayerTeam> teamMemberships =
      Maps.<String, ScorePlayerTeam>newHashMap();
  ...
  public Collection<ScoreObjective> getObjectivesFromCriteria(IScoreObjectiveCriteria criteria) {
    ...
    return collection == null
        ? Lists.<ScoreObjective>newArrayList()
  ...
  public ScorePlayerTeam createTeam(String p_96527_1_) {
    if (p_96527_1_.length() > 16) {
      ...
      if (scoreplayerteam != null) {
        throw new IllegalArgumentException(
            "A team with the name \'" + p_96527_1_ + "\' already exists!");
      } else {
  ...
  /**
   * Removes the team from the scoreboard, updates all player memberships and broadcasts the
   * deletion to all players
   */
