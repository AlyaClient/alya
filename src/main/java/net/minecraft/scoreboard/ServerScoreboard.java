...
public class ServerScoreboard extends Scoreboard {
  ...
  public void func_96516_a(String p_96516_1_) {
    ...
    this.scoreboardMCServer
        .getConfigurationManager()
        .sendPacketToAllPlayers(new S3CPacketUpdateScore(p_96516_1_));
    this.func_96551_b();
  }
  ...
  /**
   * Removes the given username from the given ScorePlayerTeam. If the player is not on the team
  ...
  public void removePlayerFromTeam(String p_96512_1_, ScorePlayerTeam p_96512_2_) {
    ...
    this.scoreboardMCServer
        .getConfigurationManager()
        .sendPacketToAllPlayers(
            new S3EPacketTeams(p_96512_2_, Arrays.asList(new String[] {p_96512_1_}), 4));
    this.func_96551_b();
  }
  ...
  /**
   * This packet will notify the players that this team is created, and that will register it on the
   * client
   */
  public void broadcastTeamCreated(ScorePlayerTeam playerTeam) {
    ...
    this.scoreboardMCServer
        .getConfigurationManager()
        .sendPacketToAllPlayers(new S3EPacketTeams(playerTeam, 0));
    this.func_96551_b();
  }
  ...
  public void sendTeamUpdate(ScorePlayerTeam playerTeam) {
    ...
    this.scoreboardMCServer
        .getConfigurationManager()
        .sendPacketToAllPlayers(new S3EPacketTeams(playerTeam, 2));
    this.func_96551_b();
  }
  ...
  public void func_96513_c(ScorePlayerTeam playerTeam) {
    ...
    this.scoreboardMCServer
        .getConfigurationManager()
        .sendPacketToAllPlayers(new S3EPacketTeams(playerTeam, 1));
    this.func_96551_b();
  }
  ...
  public void func_96549_e(ScoreObjective p_96549_1_) {
    ...
    for (EntityPlayerMP entityplayermp :
        this.scoreboardMCServer.getConfigurationManager().func_181057_v()) {
