...
public abstract class CommandBlockLogic implements ICommandSender {
  ...
  public void writeDataToNBT(NBTTagCompound tagCompound) {
    ...
    if (this.lastOutput != null && this.trackOutput) {
      tagCompound.setString(
          "LastOutput", IChatComponent.Serializer.componentToJson(this.lastOutput));
    }
    ...
    if (minecraftserver != null
      ...
      try {
        ...
        CrashReportCategory crashreportcategory =
            crashreport.makeCategory("Command to be executed");
  ...
  public void addChatMessage(IChatComponent component) {
    if (this.trackOutput && this.getEntityWorld() != null && !this.getEntityWorld().isRemote) {
      this.lastOutput =
          (new ChatComponentText("[" + timestampFormat.format(new Date()) + "] "))
