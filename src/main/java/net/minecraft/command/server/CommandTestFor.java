    ...
    if (args.length < 1) {
      ...
      if (args.length >= 2) {
        try {
          ...
          throw new CommandException(
              "commands.testfor.tagError", new Object[] {nbtexception.getMessage()});
        }
      }
      ...
      if (nbttagcompound != null) {
        ...
        if (!NBTUtil.func_181123_a(nbttagcompound, nbttagcompound1, true)) {
          throw new CommandException(
              "commands.testfor.failure", new Object[] {entity.getCommandSenderName()});
        }
      }

      notifyOperators(
          sender, this, "commands.testfor.success", new Object[] {entity.getCommandSenderName()});
    }
  }
