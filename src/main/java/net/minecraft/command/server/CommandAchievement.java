    ...
    if (args.length < 2) {
      ...
      if (statbase == null && !args[1].equals("*")) {
        throw new CommandException(
            "commands.achievement.unknownAchievement", new Object[] {args[1]});
      } else {
        final EntityPlayerMP entityplayermp =
            args.length >= 3 ? getPlayer(sender, args[2]) : getCommandSenderAsPlayer(sender);
          ...
          if (statbase == null) {
            ...
            if (statbase instanceof Achievement) {
              ...
              if (flag) {
                ...
                for (list = Lists.<Achievement>newArrayList();
                ...
                List<Achievement> list1 =
                    Lists.newArrayList(
                        Iterators.filter(
                            ...
                            new Predicate<Achievement>() {
                              public boolean apply(Achievement p_apply_1_) {
                                return entityplayermp
                                        .getStatFile()
                                        .hasAchievementUnlocked(p_apply_1_)
                                    && p_apply_1_ != statbase;
                              }
                            }));
            ...
            if (flag) {
              ...
              notifyOperators(
                  ...
                  new Object[] {statbase.func_150955_j(), entityplayermp.getCommandSenderName()});
            }
          }
        }
      }
