...
public class CommandSpreadPlayers extends CommandBase {
    ...
    if (args.length < 6) {
      ...
      while (i < args.length) {
        ...
        if (PlayerSelector.hasArguments(s)) {
          ...
          EntityPlayer entityplayer =
              MinecraftServer.getServer().getConfigurationManager().getPlayerByUsername(s);
      ...
      if (list.isEmpty()) {
        ...
        this.func_110669_a(
            sender,
            list,
            new CommandSpreadPlayers.Position(d0, d1),
            d2,
            d3,
            ((Entity) list.get(0)).worldObj,
            flag);
      }
    }
  }
  ...
  private void func_110669_a(
    ...
    CommandSpreadPlayers.Position[] acommandspreadplayers$position =
        this.func_110670_a(
            random,
            p_110669_9_ ? this.func_110667_a(p_110669_2_) : p_110669_2_.size(),
            d0,
            d1,
            d2,
            d3);
    int i =
        this.func_110668_a(
            ...
            p_110669_9_);
    double d4 =
        this.func_110671_a(p_110669_2_, worldIn, acommandspreadplayers$position, p_110669_9_);
    notifyOperators(
        p_110669_1_,
        this,
    ...
    if (acommandspreadplayers$position.length > 1) {
      p_110669_1_.addChatMessage(
          new ChatComponentTranslation(
              ...
              new Object[] {
                String.format("%.2f", new Object[] {Double.valueOf(d4)}), Integer.valueOf(i)
              }));
    }
  }
  ...
  private int func_110668_a(
    ...
    for (i = 0; i < 10000 && flag; ++i) {
      ...
      for (int j = 0; j < p_110668_14_.length; ++j) {
        ...
        int k = 0;
        CommandSpreadPlayers.Position commandspreadplayers$position1 =
            new CommandSpreadPlayers.Position();
        ...
        for (int l = 0; l < p_110668_14_.length; ++l) {
          if (j != l) {
            ...
            if (d1 < p_110668_2_) {
              ++k;
              commandspreadplayers$position1.field_111101_a +=
                  commandspreadplayers$position2.field_111101_a
                      - commandspreadplayers$position.field_111101_a;
              commandspreadplayers$position1.field_111100_b +=
                  commandspreadplayers$position2.field_111100_b
        ...
        if (k > 0) {
          ...
          if (d2 > 0.0D) {
            ...
            commandspreadplayers$position.func_111097_a(
                p_110668_5_, p_110668_6_, p_110668_8_, p_110668_10_, p_110668_12_);
          }

          flag = true;
        }

        if (commandspreadplayers$position.func_111093_a(
            p_110668_6_, p_110668_8_, p_110668_10_, p_110668_12_)) {
          flag = true;
        }
      }
      ...
      if (!flag) {
        for (CommandSpreadPlayers.Position commandspreadplayers$position3 : p_110668_14_) {
          if (!commandspreadplayers$position3.func_111098_b(worldIn)) {
            commandspreadplayers$position3.func_111097_a(
                p_110668_5_, p_110668_6_, p_110668_8_, p_110668_10_, p_110668_12_);
            flag = true;
          }
        }
  ...
  private double func_110671_a(
      List<Entity> p_110671_1_,
      World worldIn,
      CommandSpreadPlayers.Position[] p_110671_3_,
      boolean p_110671_4_) {
    double d0 = 0.0D;
    int i = 0;
    Map<Team, CommandSpreadPlayers.Position> map =
        Maps.<Team, CommandSpreadPlayers.Position>newHashMap();
    ...
    for (int j = 0; j < p_110671_1_.size(); ++j) {
      ...
      entity.setPositionAndUpdate(
          (double)
              ((float) MathHelper.floor_double(commandspreadplayers$position.field_111101_a)
                  + 0.5F),
  ...
  private CommandSpreadPlayers.Position[] func_110670_a(
      ...
      double p_110670_9_) {
    CommandSpreadPlayers.Position[] acommandspreadplayers$position =
        new CommandSpreadPlayers.Position[p_110670_2_];

    for (int i = 0; i < acommandspreadplayers$position.length; ++i) {
      CommandSpreadPlayers.Position commandspreadplayers$position =
          new CommandSpreadPlayers.Position();
      commandspreadplayers$position.func_111097_a(
          p_110670_1_, p_110670_3_, p_110670_5_, p_110670_7_, p_110670_9_);
  ...
  static class Position {
    ...
    float func_111096_b() {
      return MathHelper.sqrt_double(
          this.field_111101_a * this.field_111101_a + this.field_111100_b * this.field_111100_b);
    }
    ...
    public boolean func_111093_a(
        double p_111093_1_, double p_111093_3_, double p_111093_5_, double p_111093_7_) {
      boolean flag = false;
    ...
    public void func_111097_a(
        ...
        double p_111097_8_) {
      this.field_111101_a =
          MathHelper.getRandomDoubleInRange(p_111097_1_, p_111097_2_, p_111097_6_);
      this.field_111100_b =
