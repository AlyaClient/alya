    ...
    if (args.length < 2) {
      ...
      if (args.length >= 5) {
        ...
        try {
          ...
          throw new CommandException(
              "commands.give.tagError", new Object[] {nbtexception.getMessage()});
        }
      }
      ...
      if (flag) {
        entityplayer.worldObj.playSoundAtEntity(
            ...
            "random.pop",
            0.2F,
            ((entityplayer.getRNG().nextFloat() - entityplayer.getRNG().nextFloat()) * 0.7F + 1.0F)
                * 2.0F);
      ...
      notifyOperators(
          ...
          new Object[] {
            itemstack.getChatComponent(), Integer.valueOf(i), entityplayer.getCommandSenderName()
          });
    }
  }
