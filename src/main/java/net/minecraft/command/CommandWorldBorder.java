  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    if (args.length < 1) {
      ...
      if (args[0].equals("set")) {
        ...
        if (i > 0L) {
          ...
          if (d0 > d2) {
            notifyOperators(
                ...
                new Object[] {
                  String.format("%.1f", new Object[] {Double.valueOf(d2)}),
        ...
        long i1 =
            worldborder.getTimeUntilTarget()
        ...
        if (i1 > 0L) {
          ...
          if (d4 > d8) {
            notifyOperators(
                ...
                "commands.worldborder.setSlowly.shrink.success",
                new Object[] {
                  String.format("%.1f", new Object[] {Double.valueOf(d8)}),
        ...
        if (args[1].equals("buffer")) {
          ...
          notifyOperators(
              ...
              new Object[] {
                String.format("%.1f", new Object[] {Double.valueOf(d5)}),
          ...
          notifyOperators(
              ...
              new Object[] {
                String.format("%.2f", new Object[] {Double.valueOf(d6)}),
        ...
        sender.setCommandStat(
            CommandResultStats.Type.QUERY_RESULT, MathHelper.floor_double(d7 + 0.5D));
  ...
  public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
    return args.length == 1
        ? getListOfStringsMatchingLastWord(
            args, new String[] {"set", "center", "damage", "warning", "add", "get"})
