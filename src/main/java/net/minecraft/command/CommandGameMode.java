  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    if (args.length <= 0) {
      ...
      EntityPlayer entityplayer =
          args.length >= 2 ? getPlayer(sender, args[1]) : getCommandSenderAsPlayer(sender);
      ...
      if (sender.getEntityWorld().getGameRules().getGameRuleBooleanValue("sendCommandFeedback")) {
        entityplayer.addChatMessage(
            new ChatComponentTranslation("gameMode.changed", new Object[0]));
      }
      ...
      if (entityplayer != sender) {
        notifyOperators(
            ...
            new Object[] {entityplayer.getCommandSenderName(), ichatcomponent});
      } else {
        notifyOperators(
            sender, this, 1, "commands.gamemode.success.self", new Object[] {ichatcomponent});
      }
    }
  }
    ...
    return !p_71539_2_.equalsIgnoreCase(WorldSettings.GameType.SURVIVAL.getName())
        ...
        ? (!p_71539_2_.equalsIgnoreCase(WorldSettings.GameType.CREATIVE.getName())
            ...
            ? (!p_71539_2_.equalsIgnoreCase(WorldSettings.GameType.ADVENTURE.getName())
                ...
                ? (!p_71539_2_.equalsIgnoreCase(WorldSettings.GameType.SPECTATOR.getName())
  ...
  public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
    return args.length == 1
        ? getListOfStringsMatchingLastWord(
            args, new String[] {"survival", "creative", "adventure", "spectator"})
        : (args.length == 2
            ? getListOfStringsMatchingLastWord(args, this.getListOfPlayerUsernames())
            : null);
  }
