...
public class CommandStats extends CommandBase {
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    if (args.length < 1) {
      ...
      CommandResultStats.Type commandresultstats$type =
          CommandResultStats.Type.getTypeByName(args[i++]);
      ...
      if (commandresultstats$type == null) {
        ...
        if ("set".equals(s)) {
          ...
          CommandResultStats.func_179667_a(
              commandresultstats, commandresultstats$type, (String) null, (String) null);
          notifyOperators(
              sender,
              this,
                ...
                : ((args.length != 3 || !args[0].equals("entity"))
                    ...
                    ? ((args.length != 4 || !args[0].equals("entity"))
                        ...
                        : getListOfStringsMatchingLastWord(
                            args, CommandResultStats.Type.getTypeNames()))
  ...
  protected List<String> func_175777_e() {
    Collection<ScoreObjective> collection =
        MinecraftServer.getServer().worldServerForDimension(0).getScoreboard().getScoreObjectives();
