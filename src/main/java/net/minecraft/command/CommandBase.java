...
public abstract class CommandBase implements ICommand {
  ...
  public static int parseInt(String input, int min, int max) throws NumberInvalidException {
    ...
    if (i < min) {
      throw new NumberInvalidException(
          "commands.generic.num.tooSmall", new Object[] {Integer.valueOf(i), Integer.valueOf(min)});
    } else if (i > max) {
      throw new NumberInvalidException(
          "commands.generic.num.tooBig", new Object[] {Integer.valueOf(i), Integer.valueOf(max)});
    } else {
      return i;
    }
  }
  ...
  public static long parseLong(String input, long min, long max) throws NumberInvalidException {
    ...
    if (i < min) {
      throw new NumberInvalidException(
          "commands.generic.num.tooSmall", new Object[] {Long.valueOf(i), Long.valueOf(min)});
    } else if (i > max) {
      throw new NumberInvalidException(
          "commands.generic.num.tooBig", new Object[] {Long.valueOf(i), Long.valueOf(max)});
    } else {
      return i;
    }
  }

  public static BlockPos parseBlockPos(
    ...
    return new BlockPos(
        ...
        parseDouble(
            (double) blockpos.getZ(), args[startIndex + 2], -30000000, 30000000, centerBlock));
  }
  ...
  public static double parseDouble(String input, double min, double max)
    ...
    if (d0 < min) {
      ...
      throw new NumberInvalidException(
          "commands.generic.double.tooBig", new Object[] {Double.valueOf(d0), Double.valueOf(max)});
    } else {
      return d0;
    }
  }
  ...
  public static EntityPlayerMP getCommandSenderAsPlayer(ICommandSender sender)
    ...
    if (sender instanceof EntityPlayerMP) {
      ...
      throw new PlayerNotFoundException(
          "You must specify which player you wish to perform this action on.", new Object[0]);
    }
  }
  ...
  public static <T extends Entity> T getEntity(
      ICommandSender commandSender, String p_175759_1_, Class<? extends T> p_175759_2_)
      throws EntityNotFoundException {
  ...
  public static List<Entity> func_175763_c(ICommandSender p_175763_0_, String p_175763_1_)
      throws EntityNotFoundException {
    return (List<Entity>)
        (PlayerSelector.hasArguments(p_175763_1_)
  ...
  /**
   * Attempts to retrieve an entity's name, first assuming that the entity is a player, and then
  ...
  public static IChatComponent getChatComponentFromNthArg(
  ...
  public static IChatComponent getChatComponentFromNthArg(
      ICommandSender sender, String[] args, int index, boolean p_147176_3_)
      throws PlayerNotFoundException {
    ...
    for (int i = index; i < args.length; ++i) {
      ...
      if (p_147176_3_) {
        IChatComponent ichatcomponent2 =
            PlayerSelector.matchEntitiesToChatComponent(sender, args[i]);
  ...
  public static CommandBase.CoordinateArg parseCoordinate(
      double base, String p_175770_2_, boolean centerBlock) throws NumberInvalidException {
    return parseCoordinate(base, p_175770_2_, -30000000, 30000000, centerBlock);
  }

  public static CommandBase.CoordinateArg parseCoordinate(
      double p_175767_0_, String p_175767_2_, int min, int max, boolean centerBlock)
      throws NumberInvalidException {
    boolean flag = p_175767_2_.startsWith("~");

    if (flag && Double.isNaN(p_175767_0_)) {
      throw new NumberInvalidException(
          "commands.generic.num.invalid", new Object[] {Double.valueOf(p_175767_0_)});
    } else {
      double d0 = 0.0D;
  ...
  public static double parseDouble(double base, String input, int min, int max, boolean centerBlock)
    ...
    if (flag && Double.isNaN(base)) {
      throw new NumberInvalidException(
          "commands.generic.num.invalid", new Object[] {Double.valueOf(base)});
    } else {
  ...
  /**
   * Gets the Item specified by the given text string. First checks the item registry, then tries by
   * parsing the string as an integer ID (deprecated). Warns the sender if we matched by parsing the
   * ID. Throws if the item wasn't found. Returns the item if it was found.
   */
  ...
  /**
   * Gets the Block specified by the given text string. First checks the block registry, then tries
   * by parsing the string as an integer ID (deprecated). Warns the sender if we matched by parsing
   * the ID. Throws if the block wasn't found. Returns the block if it was found.
   */
  ...
  /**
   * Creates a linguistic series joining the input objects together. Examples: 1) {} --> "", 2)
   * {"Steve"} --> "Steve", 3) {"Steve", "Phil"} --> "Steve and Phil", 4) {"Steve", "Phil", "Mark"}
   * --> "Steve, Phil and Mark"
   */
   ...
   * {} --> "", 2) {"Steve"} --> "Steve", 3) {"Steve", "Phil"} --> "Steve and Phil", 4) {"Steve",
  ...
  public static List<String> func_175771_a(
      String[] p_175771_0_, int p_175771_1_, BlockPos p_175771_2_) {
    if (p_175771_2_ == null) {
      return null;
    } else {
  ...
  public static List<String> func_181043_b(
      String[] p_181043_0_, int p_181043_1_, BlockPos p_181043_2_) {
    if (p_181043_2_ == null) {
      return null;
    } else {
  ...
  /**
   * Returns true if the given substring is exactly equal to the start of the given string (case
   * insensitive).
   */
  ...
  public static void notifyOperators(
      ICommandSender sender, ICommand command, String msgFormat, Object... msgParams) {
