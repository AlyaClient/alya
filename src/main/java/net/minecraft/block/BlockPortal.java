...
public class BlockPortal extends BlockBreakable {
  public static final PropertyEnum<EnumFacing.Axis> AXIS =
      PropertyEnum.<EnumFacing.Axis>create(
          "axis",
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
    ...
    if (worldIn.provider.isSurfaceWorld()
      ...
      for (blockpos = pos;
          !World.doesBlockHaveSolidTopSurface(worldIn, blockpos) && blockpos.getY() > 0;
  ...
  public boolean func_176548_d(World worldIn, BlockPos p_176548_2_) {
    BlockPortal.Size blockportal$size =
        new BlockPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
    ...
    if (blockportal$size.func_150860_b() && blockportal$size.field_150864_e == 0) {
      ...
      BlockPortal.Size blockportal$size1 =
          new BlockPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
  ...
  public void onNeighborBlockChange(
    ...
    if (enumfacing$axis == EnumFacing.Axis.X) {
      ...
      if (!blockportal$size.func_150860_b()
          || blockportal$size.field_150864_e
              < blockportal$size.field_150868_h * blockportal$size.field_150862_g) {
      ...
      if (!blockportal$size1.func_150860_b()
          || blockportal$size1.field_150864_e
              < blockportal$size1.field_150868_h * blockportal$size1.field_150862_g) {
        worldIn.setBlockState(pos, Blocks.air.getDefaultState());
      }
    }
  }
  ...
  public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
    ...
    boolean flag =
        worldIn.getBlockState(pos.west()).getBlock() == this
    ...
    boolean flag2 =
        worldIn.getBlockState(pos.north()).getBlock() == this
  ...
  public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
    ...
    BlockPortal.Size blockportal$size =
        new BlockPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.X);
    LoadingCache<BlockPos, BlockWorldState> loadingcache =
        BlockPattern.func_181627_a(p_181089_1_, true);
    ...
    if (!blockportal$size.func_150860_b()) {
      return new BlockPattern.PatternHelper(
          p_181089_2_, EnumFacing.NORTH, EnumFacing.UP, loadingcache, 1, 1, 1);
    } else {
        ...
        BlockPattern.PatternHelper blockpattern$patternhelper =
            new BlockPattern.PatternHelper(
                enumfacing.getAxisDirection() == enumfacing$axisdirection
                    ? blockpos
                    : blockpos.offset(
                        blockportal$size.field_150866_c, blockportal$size.func_181101_b() - 1),
  ...
  public static class Size {
    ...
    public Size(World worldIn, BlockPos p_i45694_2_, EnumFacing.Axis p_i45694_3_) {
      ...
      for (BlockPos blockpos = p_i45694_2_;
          p_i45694_2_.getY() > blockpos.getY() - 21
              && p_i45694_2_.getY() > 0
              && this.func_150857_a(worldIn.getBlockState(p_i45694_2_.down()).getBlock());
    ...
    protected int func_150858_a() {
      ...
      for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g) {
        for (int i = 0; i < this.field_150868_h; ++i) {
          BlockPos blockpos =
              this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g);
      ...
      for (int j = 0; j < this.field_150868_h; ++j) {
        if (this.world
                .getBlockState(
                    this.field_150861_f.offset(this.field_150866_c, j).up(this.field_150862_g))
                .getBlock()
            != Blocks.obsidian) {
    ...
    public boolean func_150860_b() {
      return this.field_150861_f != null
          && this.field_150868_h >= 2
      ...
      for (int i = 0; i < this.field_150868_h; ++i) {
        ...
        for (int j = 0; j < this.field_150862_g; ++j) {
          this.world.setBlockState(
              blockpos.up(j),
              Blocks.portal.getDefaultState().withProperty(BlockPortal.AXIS, this.axis),
              2);
        }
      }
    }
