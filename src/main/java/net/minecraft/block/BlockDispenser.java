...
public class BlockDispenser extends BlockContainer {
  ...
  private void setDefaultDirection(World worldIn, BlockPos pos, IBlockState state) {
    if (!worldIn.isRemote) {
      ...
      worldIn.setBlockState(
          pos,
          state.withProperty(FACING, enumfacing).withProperty(TRIGGERED, Boolean.valueOf(false)),
          2);
    }
  }
  ...
  protected void dispense(World worldIn, BlockPos pos) {
    ...
    TileEntityDispenser tileentitydispenser =
        (TileEntityDispenser) blocksourceimpl.getBlockTileEntity();
    ...
    if (tileentitydispenser != null) {
      ...
      if (i < 0) {
        ...
        if (ibehaviordispenseitem != IBehaviorDispenseItem.itemDispenseBehaviorProvider) {
          ...
          tileentitydispenser.setInventorySlotContents(
  ...
  protected IBehaviorDispenseItem getBehavior(ItemStack stack) {
    return (IBehaviorDispenseItem)
        dispenseBehaviorRegistry.getObject(stack == null ? null : stack.getItem());
  }
  ...
  public IBlockState onBlockPlaced(
    ...
    return this.getDefaultState()
        .withProperty(FACING, BlockPistonBase.getFacingFromEntity(worldIn, pos, placer))
        .withProperty(TRIGGERED, Boolean.valueOf(false));
  }
  ...
  public void onBlockPlacedBy(
    ...
    worldIn.setBlockState(
        pos,
        state.withProperty(FACING, BlockPistonBase.getFacingFromEntity(worldIn, pos, placer)),
        2);
