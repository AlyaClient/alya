...
public class BlockStoneBrick extends Block {
  public static final PropertyEnum<BlockStoneBrick.EnumType> VARIANT =
      PropertyEnum.<BlockStoneBrick.EnumType>create("variant", BlockStoneBrick.EnumType.class);
  ...
  public BlockStoneBrick() {
    ...
    this.setDefaultState(
        this.blockState.getBaseState().withProperty(VARIANT, BlockStoneBrick.EnumType.DEFAULT));
  ...
  public static enum EnumType implements IStringSerializable {
    ...
    private static final BlockStoneBrick.EnumType[] META_LOOKUP =
        new BlockStoneBrick.EnumType[values().length];
