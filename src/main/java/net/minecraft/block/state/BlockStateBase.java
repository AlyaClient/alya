...
public abstract class BlockStateBase implements IBlockState {
        ...
        public String apply(Entry<IProperty, Comparable> p_apply_1_) {
          if (p_apply_1_ == null) {
            ...
            return iproperty.getName()
                + "="
                + iproperty.getName((Comparable) p_apply_1_.getValue());
          }
        }
      };
  ...
  public <T extends Comparable<T>> IBlockState cycleProperty(IProperty<T> property) {
    return this.withProperty(
        property, cyclePropertyValue(property.getAllowedValues(), this.getValue(property)));
  }
  ...
  public String toString() {
    ...
    if (!this.getProperties().isEmpty()) {
      ...
      COMMA_JOINER.appendTo(
          stringbuilder, Iterables.transform(this.getProperties().entrySet(), MAP_ENTRY_TO_STRING));
      stringbuilder.append("]");
    }
