...
public class BlockCommandBlock extends BlockContainer {
  ...
  public BlockCommandBlock() {
    ...
    this.setDefaultState(
        this.blockState.getBaseState().withProperty(TRIGGERED, Boolean.valueOf(false)));
  }
  ...
  public boolean onBlockActivated(
    ...
    return tileentity instanceof TileEntityCommandBlock
        ? ((TileEntityCommandBlock) tileentity)
            .getCommandBlockLogic()
            .tryOpenEditCommandBlock(playerIn)
        : false;
  }
  ...
  public void onBlockPlacedBy(
    ...
    if (tileentity instanceof TileEntityCommandBlock) {
      ...
      if (!worldIn.isRemote) {
        commandblocklogic.setTrackOutput(
            worldIn.getGameRules().getGameRuleBooleanValue("sendCommandFeedback"));
      }
    }
  }
