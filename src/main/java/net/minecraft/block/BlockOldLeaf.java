...
public class BlockOldLeaf extends BlockLeaves {
  public static final PropertyEnum<BlockPlanks.EnumType> VARIANT =
      PropertyEnum.<BlockPlanks.EnumType>create(
          "variant",
  ...
  public int getRenderColor(IBlockState state) {
    if (state.getBlock() != this) {
      ...
      return blockplanks$enumtype == BlockPlanks.EnumType.SPRUCE
          ...
          : (blockplanks$enumtype == BlockPlanks.EnumType.BIRCH
  ...
  public int colorMultiplier(IBlockAccess worldIn, BlockPos pos, int renderPass) {
    ...
    if (iblockstate.getBlock() == this) {
      BlockPlanks.EnumType blockplanks$enumtype =
          (BlockPlanks.EnumType) iblockstate.getValue(VARIANT);
  ...
  protected int getSaplingDropChance(IBlockState state) {
    return state.getValue(VARIANT) == BlockPlanks.EnumType.JUNGLE
        ? 40
