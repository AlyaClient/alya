...
public abstract class BlockLeaves extends BlockLeavesBase {
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
    ...
    if (worldIn.isAreaLoaded(
        new BlockPos(k - j, l - j, i1 - j), new BlockPos(k + j, l + j, i1 + j))) {
          ...
          for (int l1 = -i; l1 <= i; ++l1) {
            ...
            if (iblockstate.getBlock().getMaterial() == Material.leaves
              ...
              worldIn.setBlockState(
                  blockpos, iblockstate.withProperty(CHECK_DECAY, Boolean.valueOf(true)), 4);
            }
          }
        }
      }
            ...
            for (int j2 = -i; j2 <= i; ++j2) {
              for (int k2 = -i; k2 <= i; ++k2) {
                Block block =
                    worldIn
                        .getBlockState(
                            blockpos$mutableblockpos.func_181079_c(k + i2, l + j2, i1 + k2))
                        .getBlock();
