...
public class BlockTripWireHook extends Block {
  ...
  public void onNeighborBlockChange(
    ...
    if (neighborBlock != this) {
      if (this.checkForDrop(worldIn, pos, state)) {
        ...
        if (!worldIn
            .getBlockState(pos.offset(enumfacing.getOpposite()))
            .getBlock()
            .isNormalCube()) {
  ...
  public void func_176260_a(
    ...
    IBlockState iblockstate1 =
        this.getDefaultState()
            .withProperty(ATTACHED, Boolean.valueOf(flag3))
      ...
      for (int k = 1; k < i; ++k) {
        ...
        if (iblockstate2 != null && worldIn.getBlockState(blockpos2).getBlock() != Blocks.air) {
          worldIn.setBlockState(
              blockpos2, iblockstate2.withProperty(ATTACHED, Boolean.valueOf(flag3)), 3);
        }
      }
    }
  }
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
    ...
    if (flag1) {
      ...
      worldIn.notifyNeighborsOfStateChange(
          pos.offset(((EnumFacing) state.getValue(FACING)).getOpposite()), this);
    }
