      ...
      if (blockpattern$patternhelper != null) {
        for (int i = 0; i < 3; ++i) {
          ...
          worldIn.setBlockState(
              ...
              blockworldstate.getBlockState().withProperty(NODROP, Boolean.valueOf(true)),
              2);
        }
        ...
        for (int i1 = 0; i1 < blockpattern.getPalmLength(); ++i1) {
          for (int j1 = 0; j1 < blockpattern.getThumbLength(); ++j1) {
            BlockWorldState blockworldstate2 =
                blockpattern$patternhelper.translateOffset(i1, j1, 0);
