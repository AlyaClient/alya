...
public class CrashReport {
  ...
  private final CrashReportCategory theReportCategory =
      new CrashReportCategory(this, "System Details");

  private final List<CrashReportCategory> crashReportSections =
      Lists.<CrashReportCategory>newArrayList();
  ...
  private void populateEnvironment() {
    ...
    if (Reflector.FMLCommonHandler_enhanceCrashReport.exists()) {
      ...
      Reflector.callString(
          object,
          Reflector.FMLCommonHandler_enhanceCrashReport,
    ...
    if ((this.stacktrace == null || this.stacktrace.length <= 0)
      ...
      this.stacktrace =
          (StackTraceElement[])
              ((StackTraceElement[])
                  ArrayUtils.subarray(
                      ((CrashReportCategory) this.crashReportSections.get(0)).getStackTrace(),
                      0,
                      1));
    }
  ...
  /**
   * Saves this CrashReport to the given file and returns a value indicating whether we were
  ...
  public CrashReportCategory makeCategoryDepth(String categoryName, int stacktraceLength) {
    ...
    if (this.field_85059_f) {
      ...
      this.field_85059_f =
          crashreportcategory.firstTwoElementsOfStackTraceMatch(
              stacktraceelement, stacktraceelement1);

      if (i > 0 && !this.crashReportSections.isEmpty()) {
        CrashReportCategory crashreportcategory1 =
            (CrashReportCategory) this.crashReportSections.get(this.crashReportSections.size() - 1);
