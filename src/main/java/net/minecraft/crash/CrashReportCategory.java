...
public class CrashReportCategory {
  ...
  private final List<CrashReportCategory.Entry> children =
      Lists.<CrashReportCategory.Entry>newArrayList();
  ...
  /**
   * Resets our stack trace according to the current trace, pruning the deepest 3 entries. The
   * parameter indicates how many additional deepest entries to prune. Returns the number of entries
  ...
  /**
   * Do the deepest two elements of our saved stack trace match the given elements, in order from
   * the deepest?
   */
  ...
  public static void addBlockInfo(
      CrashReportCategory category, final BlockPos pos, final Block blockIn, final int blockData) {
        ...
        new Callable<String>() {
          public String call() throws Exception {
            if (blockData < 0) {
              ...
              String s =
                  String.format("%4s", new Object[] {Integer.toBinaryString(blockData)})
                      .replace(" ", "0");
              return String.format(
                  "%1$d / 0x%1$X / 0b%2$s", new Object[] {Integer.valueOf(blockData), s});
            }
          }
        });
    category.addCrashSectionCallable(
  ...
  public static void addBlockInfo(
      CrashReportCategory category, final BlockPos pos, final IBlockState state) {
    category.addCrashSectionCallable(
        "Block",
        new Callable<String>() {
          public String call() throws Exception {
