...
public class RecipesDyes {
    ...
    public void addRecipes(CraftingManager p_77607_1_) {
        for(int i = 0; i < 16; ++i) {
            ...
            p_77607_1_.addRecipe(
                    new ItemStack(Blocks.stained_glass, 8, 15 - i),
                    new Object[]{
                            "###",
                            "#X#",
                            "###",
            ...
            p_77607_1_.addRecipe(
                    new ItemStack(Blocks.stained_glass_pane, 16, i),
        ...
        p_77607_1_.addShapelessRecipe(
                new ItemStack(Items.dye, 3, EnumDyeColor.WHITE.getDyeDamage()), new Object[]{Items.bone});
        p_77607_1_.addShapelessRecipe(
        ...
        for(int j = 0; j < 16; ++j) {
            p_77607_1_.addRecipe(
                    new ItemStack(Blocks.carpet, 3, j),
