...
public class FurnaceRecipes {
  ...
  private FurnaceRecipes() {
    ...
    this.addSmeltingRecipeForBlock(
        Blocks.cactus, new ItemStack(Items.dye, 1, EnumDyeColor.GREEN.getDyeDamage()), 0.2F);
    ...
    this.addSmeltingRecipe(
        new ItemStack(Blocks.sponge, 1, 1), new ItemStack(Blocks.sponge, 1, 0), 0.15F);
    ...
    this.addSmeltingRecipeForBlock(
        Blocks.lapis_ore, new ItemStack(Items.dye, 1, EnumDyeColor.BLUE.getDyeDamage()), 0.2F);
  ...
  /**
   * Compares two itemstacks to ensure that they are the same. This checks both the item and the
