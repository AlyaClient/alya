...
public class ItemSlab extends ItemBlock {
    ...
    public boolean onItemUse(
        ...
        if(stack.stackSize == 0) {
            ...
            if(iblockstate.getBlock() == this.singleSlab) {
                ...
                BlockSlab.EnumBlockHalf blockslab$enumblockhalf =
                ...
                if((side == EnumFacing.UP && blockslab$enumblockhalf == BlockSlab.EnumBlockHalf.BOTTOM
                    ...
                    IBlockState iblockstate1 =
                            this.doubleSlab.getDefaultState().withProperty(iproperty, comparable);

                    if(worldIn.checkNoEntityCollision(
                            this.doubleSlab.getCollisionBoundingBox(worldIn, pos, iblockstate1))
    ...
    public boolean canPlaceBlockOnSide(
            World worldIn, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack) {
