...
public class ItemPotion extends Item {
  private Map<Integer, List<PotionEffect>> effectCache =
      Maps.<Integer, List<PotionEffect>>newHashMap();
  private static final Map<List<PotionEffect>, Integer> SUB_ITEMS_CACHE =
      Maps.<List<PotionEffect>, Integer>newLinkedHashMap();
  ...
  public String getItemStackDisplayName(ItemStack stack) {
    if (stack.getMetadata() == 0) {
      ...
      if (list != null && !list.isEmpty()) {
        ...
        return StatCollector.translateToLocal(s1).trim()
            + " "
            ...
            for (Entry<IAttribute, AttributeModifier> entry : map.entrySet()) {
              ...
              AttributeModifier attributemodifier1 =
                  new AttributeModifier(
                      ...
                      potion.getAttributeModifierAmount(
                          potioneffect.getAmplifier(), attributemodifier),
            ...
            s1 =
                s1
                    ...
                    + StatCollector.translateToLocal(
                            "potion.potency." + potioneffect.getAmplifier())
                        .trim();
          }
