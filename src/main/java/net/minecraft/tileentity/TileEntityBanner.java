...
public class TileEntityBanner extends TileEntity {
  ...
  /**
   * This is a String representation of this banners pattern and color lists, used for texture
   * caching.
   */
  ...
  public static void func_181020_a(
      NBTTagCompound p_181020_0_, int p_181020_1_, NBTTagList p_181020_2_) {
  ...
  public static int getBaseColor(ItemStack stack) {
    ...
    return nbttagcompound != null && nbttagcompound.hasKey("Base")
        ? nbttagcompound.getInteger("Base")
        : stack.getMetadata();
  }

  /**
   * Retrieves the amount of patterns stored on an ItemStack. If the tag does not exist this value
   * will be 0.
   *
  ...
  /**
   * Establishes all of the basic properties for the banner. This will also apply the data from the
   * tile entities nbt tag compounds.
   */
        ...
        if (this.patterns != null) {
          for (int i = 0; i < this.patterns.tagCount(); ++i) {
            ...
            TileEntityBanner.EnumBannerPattern tileentitybanner$enumbannerpattern =
                TileEntityBanner.EnumBannerPattern.getPatternByID(
            ...
            if (tileentitybanner$enumbannerpattern != null) {
              ...
              this.patternResourceLocation =
                  this.patternResourceLocation
                      + tileentitybanner$enumbannerpattern.getPatternID()
                      + j;
            }
          }
        }
  ...
  public static enum EnumBannerPattern {
    ...
    private EnumBannerPattern(
        String name, String id, String craftingTop, String craftingMid, String craftingBot) {
      this(name, id);
