...
public class TileEntityPiston extends TileEntity implements ITickable {
  ...
  /**
   * Get interpolated progress value (between lastProgress and progress) given the fractional time
   * between ticks as an argument
   */
  ...
  private void launchWithSlimeBlock(float p_145863_1_, float p_145863_2_) {
    ...
    AxisAlignedBB axisalignedbb =
        Blocks.piston_extension.getBoundingBox(
            this.worldObj, this.pos, this.pistonState, p_145863_1_, this.pistonFacing);

    if (axisalignedbb != null) {
      List<Entity> list =
          this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity) null, axisalignedbb);
  ...
  public void writeToNBT(NBTTagCompound compound) {
    ...
    compound.setInteger(
        "blockData", this.pistonState.getBlock().getMetaFromState(this.pistonState));
