...
public class EntityCrit2FX extends EntityFX {
  ...
  protected EntityCrit2FX(
    ...
    this.particleRed =
        this.particleGreen =
            this.particleBlue =
                (float) (Math.random() * 0.30000001192092896D + 0.6000000238418579D);
  ...
  public static class MagicFactory implements IParticleFactory {
    public EntityFX getEntityFX(
        ...
        int... p_178902_15_) {
      EntityFX entityfx =
          new EntityCrit2FX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
      entityfx.setRBGColorF(
          entityfx.getRedColorF() * 0.3F,
