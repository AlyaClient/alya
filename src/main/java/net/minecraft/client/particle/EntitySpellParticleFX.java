...
public class EntitySpellParticleFX extends EntityFX {
  ...
  protected EntitySpellParticleFX(
      World worldIn,
      double xCoordIn,
      double yCoordIn,
      double zCoordIn,
  ...
  public void onUpdate() {
    ...
    this.setParticleTextureIndex(
        this.baseSpellTextureIndex + (7 - this.particleAge * 8 / this.particleMaxAge));
    this.motionY += 0.004D;
  ...
  public static class Factory implements IParticleFactory {
    public EntityFX getEntityFX(
        ...
        double zSpeedIn,
        int... p_178902_15_) {
      return new EntitySpellParticleFX(
          worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
    }
  }
