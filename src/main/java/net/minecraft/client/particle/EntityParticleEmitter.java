...
public class EntityParticleEmitter extends EntityFX {
  ...
  public EntityParticleEmitter(
      World worldIn, Entity p_i46279_2_, EnumParticleTypes particleTypesIn) {
    super(
        worldIn,
        p_i46279_2_.posX,
  ...
  public void onUpdate() {
    for (int i = 0; i < 16; ++i) {
      ...
      if (d0 * d0 + d1 * d1 + d2 * d2 <= 1.0D) {
        ...
        double d4 =
            this.attachedEntity.getEntityBoundingBox().minY
        ...
        this.worldObj.spawnParticle(
            this.particleTypes, false, d3, d4, d5, d0, d1 + 0.2D, d2, new int[0]);
      }
    }
