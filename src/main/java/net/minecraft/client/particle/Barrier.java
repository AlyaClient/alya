...
public class Barrier extends EntityFX {
  protected Barrier(
      World worldIn, double p_i46286_2_, double p_i46286_4_, double p_i46286_6_, Item p_i46286_8_) {
  ...
  public void renderParticle(
    ...
    worldRendererIn
        .pos(
            (double) (f5 - p_180434_4_ * 0.5F - p_180434_7_ * 0.5F),
            (double) (f6 - p_180434_5_ * 0.5F),
  ...
  public static class Factory implements IParticleFactory {
    public EntityFX getEntityFX(
        ...
        int... p_178902_15_) {
      return new Barrier(
          worldIn, xCoordIn, yCoordIn, zCoordIn, Item.getItemFromBlock(Blocks.barrier));
    }
  }
}
