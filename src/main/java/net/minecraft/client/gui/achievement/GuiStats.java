...
public class GuiStats extends GuiScreen implements IProgressMeter {
  ...
  private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
    ...
    worldrenderer
        .pos((double) (p_146527_1_ + 0), (double) (p_146527_2_ + 18), (double) this.zLevel)
        .tex(
            (double) ((float) (p_146527_3_ + 0) * 0.0078125F),
            (double) ((float) (p_146527_4_ + 18) * 0.0078125F))
        .endVertex();
    worldrenderer
        .pos((double) (p_146527_1_ + 18), (double) (p_146527_2_ + 18), (double) this.zLevel)
        .tex(
            (double) ((float) (p_146527_3_ + 18) * 0.0078125F),
            (double) ((float) (p_146527_4_ + 18) * 0.0078125F))
        .endVertex();
    worldrenderer
        .pos((double) (p_146527_1_ + 18), (double) (p_146527_2_ + 0), (double) this.zLevel)
        .tex(
            (double) ((float) (p_146527_3_ + 18) * 0.0078125F),
            (double) ((float) (p_146527_4_ + 0) * 0.0078125F))
        .endVertex();
    worldrenderer
        .pos((double) (p_146527_1_ + 0), (double) (p_146527_2_ + 0), (double) this.zLevel)
        .tex(
            (double) ((float) (p_146527_3_ + 0) * 0.0078125F),
            (double) ((float) (p_146527_4_ + 0) * 0.0078125F))
        .endVertex();
  ...
  abstract class Stats extends GuiSlot {
    ...
    protected void func_148209_a(
        StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
      if (p_148209_1_ != null) {
        String s = p_148209_1_.format(GuiStats.this.field_146546_t.readStat(p_148209_1_));
        GuiStats.this.drawString(
            s,
            p_148209_2_ - (int) font.getStringWidth(s),
            p_148209_3_ + 5,
        ...
        GuiStats.this.drawString(
            s1,
            p_148209_2_ - (int) font.getStringWidth(s1),
            p_148209_3_ + 5,
            p_148209_4_ ? 16777215 : 9474192);
      }
    }
      ...
      if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
        ...
        if (i >= 0) {
          ...
          if (s.length() > 0) {
            ...
            int i1 = (int) font.getStringWidth(s);
            GuiStats.this.drawGradientRect(
                k - 3, l - 3, k + i1 + 3, l + 8 + 3, -1073741824, -1073741824);
    ...
    protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
      if (p_148213_1_ != null) {
        ...
        if (s1.length() > 0) {
          ...
          int k = (int) font.getStringWidth(s1);
          GuiStats.this.drawGradientRect(
              i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
  ...
  class StatsBlock extends GuiStats.Stats {
    ...
    protected void drawSlot(
      ...
      this.func_148209_a(
          StatList.objectCraftStats[i], p_180791_2_ + 115, p_180791_3_, entryID % 2 == 0);
      this.func_148209_a(
          StatList.objectUseStats[i], p_180791_2_ + 165, p_180791_3_, entryID % 2 == 0);
  ...
  class StatsGeneral extends GuiSlot {
    ...
    protected void drawSlot(
      ...
      GuiStats.this.drawString(
          s,
          p_180791_2_ + 2 + 213 - (int) font.getStringWidth(s),
          p_180791_3_ + 1,
          entryID % 2 == 0 ? 16777215 : 9474192);
    }
  }
  ...
  class StatsItem extends GuiStats.Stats {
    ...
    protected void drawSlot(
      ...
      int i = Item.getIdFromItem(item);
      this.func_148209_a(
          StatList.objectBreakStats[i], p_180791_2_ + 115, p_180791_3_, entryID % 2 == 0);
      this.func_148209_a(
          StatList.objectCraftStats[i], p_180791_2_ + 165, p_180791_3_, entryID % 2 == 0);
      this.func_148209_a(statcrafting, p_180791_2_ + 215, p_180791_3_, entryID % 2 == 0);
    }
  ...
  class StatsMobsList extends GuiSlot {
    private final List<EntityList.EntityEggInfo> field_148222_l =
        Lists.<EntityList.EntityEggInfo>newArrayList();
    ...
    protected int getContentHeight() {
      return this.getSize() * (int) font.getFontHeight() * 4;
    }
    ...
    protected void drawSlot(
      ...
      EntityList.EntityEggInfo entitylist$entityegginfo =
          (EntityList.EntityEggInfo) this.field_148222_l.get(entryID);
      String s =
          I18n.format(
              "entity." + EntityList.getStringFromID(entitylist$entityegginfo.spawnedID) + ".name",
              new Object[0]);
      ...
      GuiStats.this.drawString(
          s1,
          p_180791_2_ + 2,
          p_180791_3_ + 1 + (int) font.getFontHeight(),
          i == 0 ? 6316128 : 9474192);
      GuiStats.this.drawString(
          s2,
          p_180791_2_ + 2,
          p_180791_3_ + 1 + (int) font.getFontHeight() * 2,
          j == 0 ? 6316128 : 9474192);
    }
  }
}
