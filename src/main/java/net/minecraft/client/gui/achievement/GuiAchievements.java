...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
  ...
  public GuiAchievements(GuiScreen parentScreenIn, StatFileWriter statFileWriterIn) {
    ...
    this.field_146569_s =
        this.field_146567_u =
            this.field_146565_w =
                (double) (AchievementList.openInventory.displayColumn * 24 - i / 2 - 12);
    this.field_146568_t =
        this.field_146566_v =
            this.field_146573_x = (double) (AchievementList.openInventory.displayRow * 24 - j / 2);
  }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    if (this.loadingAchievements) {
      ...
      if (Mouse.isButtonDown(0)) {
        ...
        if ((this.field_146554_D == 0 || this.field_146554_D == 1)
            && mouseX >= k
            && mouseX < k + 224
            && mouseY >= l
            && mouseY < l + 155) {
          if (this.field_146554_D == 0) {
            ...
            this.field_146567_u -=
                (double) ((float) (mouseX - this.field_146563_h) * this.field_146570_r);
            this.field_146566_v -=
                (double) ((float) (mouseY - this.field_146564_i) * this.field_146570_r);
  ...
  protected void drawTitle() {
    ...
    int j = (this.height - this.field_146557_g) / 2;
    font.drawString(
        I18n.format("gui.achievements", new Object[0]), (float) (i + 15), (float) (j + 5), 4210752);
  }
  ...
  protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
    ...
    for (int l3 = 0; (float) l3 * f - (float) j2 < 155.0F; ++l3) {
      ...
      for (int i4 = 0; (float) i4 * f1 - (float) i2 < 224.0F; ++i4) {
        random.setSeed(
            (long) (this.mc.getSession().getPlayerID().hashCode() + k1 + i4 + (l1 + l3) * 16));
    ...
    for (int i6 = 0; i6 < AchievementList.achievementList.size(); ++i6) {
      ...
      if (l6 >= -24
          && j7 >= -24
          && (float) l6 <= 224.0F * this.field_146570_r
    ...
    if (achievement != null) {
      ...
      if (this.statFileWriter.canUnlockAchievement(achievement)) {
        int j8 = Math.max((int) font.getStringWidth(s), 120);
        ...
        this.drawGradientRect(
            i7 - 3, k7 - 3, i7 + j8 + 3, k7 + i9 + 3 + 12, -1073741824, -1073741824);
        ...
        int k8 = Math.max((int) font.getStringWidth(s), 120);
        String s2 =
            (new ChatComponentTranslation(
                    "achievement.requires",
                    new Object[] {achievement.parentAchievement.getStatName()}))
                .getUnformattedText();
        int i5 = this.fontRendererObj.splitStringWidth(s2, k8);
        this.drawGradientRect(
            i7 - 3, k7 - 3, i7 + k8 + 3, k7 + i5 + 12 + 3, -1073741824, -1073741824);
        this.fontRendererObj.drawSplitString(s2, i7, k7 + 12, k8, -9416624);
      } else if (i8 < 3) {
        int l8 = Math.max((int) font.getStringWidth(s), 120);
        String s3 =
            (new ChatComponentTranslation(
                    "achievement.requires",
                    new Object[] {achievement.parentAchievement.getStatName()}))
        ...
        this.drawGradientRect(
            i7 - 3, k7 - 3, i7 + l8 + 3, k7 + j9 + 12 + 3, -1073741824, -1073741824);
