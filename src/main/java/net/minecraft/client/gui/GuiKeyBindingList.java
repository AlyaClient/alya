...
public class GuiKeyBindingList extends GuiListExtended {
  ...
  public class CategoryEntry implements IGuiListEntry {
    ...
    public CategoryEntry(String p_i45028_2_) {
      ...
      this.labelWidth = (int) font.getStringWidth(this.labelText);
    }
    ...
    public void drawEntry(
      ...
      font.drawString(
          ...
          y + slotHeight - (int) font.getFontHeight() - 1,
          16777215);
    }
  ...
  public class KeyEntry implements IGuiListEntry {
    ...
    private KeyEntry(KeyBinding p_i45029_2_) {
      ...
      this.btnChangeKeyBinding =
          new GuiButton(
              0, 0, 0, 75, 20, I18n.format(p_i45029_2_.getKeyDescription(), new Object[0]));
    ...
    public void drawEntry(
      ...
      font.drawString(
          ...
          y + slotHeight / 2 - (int) font.getFontHeight() / 2,
          16777215);
      ...
      if (this.keybinding.getKeyCode() != 0) {
        for (KeyBinding keybinding : GuiKeyBindingList.this.mc.gameSettings.keyBindings) {
          if (keybinding != this.keybinding
              && keybinding.getKeyCode() == this.keybinding.getKeyCode()) {
            flag1 = true;
            break;
          }
        }
    ...
    public boolean mousePressed(
        ...
        int p_148278_5_,
        int p_148278_6_) {
      if (this.btnChangeKeyBinding.mousePressed(
          GuiKeyBindingList.this.mc, p_148278_2_, p_148278_3_)) {
        ...
        GuiKeyBindingList.this.mc.gameSettings.setOptionKeyBinding(
            this.keybinding, this.keybinding.getKeyCodeDefault());
