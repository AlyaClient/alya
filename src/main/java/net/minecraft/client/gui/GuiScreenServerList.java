...
public class GuiScreenServerList extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.field_146302_g =
        new GuiTextField(2, this.fontRendererObj, this.width / 2 - 100, 116, 200, 20);
    ...
    ((GuiButton) this.buttonList.get(0)).enabled =
        this.field_146302_g.getText().length() > 0
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this.drawCenteredString(
        I18n.format("selectServer.direct", new Object[0]), this.width / 2, 20, 16777215);
    this.drawString(
        I18n.format("addServer.enterIp", new Object[0]), this.width / 2 - 100, 100, 10526880);
