...
public class GuiPageButtonList extends GuiListExtended {
  ...
  public GuiPageButtonList(
      ...
      int bottomIn,
      int slotHeightIn,
      GuiResponder p_i45536_7_,
      GuiListEntry[]... p_i45536_8_) {
  ...
  private void func_178069_s() {
    for (GuiListEntry[] aguipagebuttonlist$guilistentry : this.field_178078_x) {
      for (int i = 0; i < aguipagebuttonlist$guilistentry.length; i += 2) {
        GuiListEntry guipagebuttonlist$guilistentry =
            aguipagebuttonlist$guilistentry[i];
        GuiListEntry guipagebuttonlist$guilistentry1 =
        ...
        GuiEntry guipagebuttonlist$guientry =
            new GuiEntry(gui, gui1);
  ...
  private void func_178060_e(int p_178060_1_, int p_178060_2_) {
    for (GuiListEntry guipagebuttonlist$guilistentry :
    ...
    for (GuiListEntry guipagebuttonlist$guilistentry1 :
  ...
  private Gui func_178058_a(
      GuiListEntry p_178058_1_, int p_178058_2_, boolean p_178058_3_) {
    return (Gui)
        (p_178058_1_ instanceof GuiSlideEntry
            ? this.func_178067_a(
  ...
  private GuiSlider func_178067_a(
      int p_178067_1_, int p_178067_2_, GuiSlideEntry p_178067_3_) {
    GuiSlider guislider =
        new GuiSlider(
            this.field_178076_z,
  ...
  private GuiListButton func_178065_a(
      int p_178065_1_, int p_178065_2_, GuiButtonEntry p_178065_3_) {
  ...
  private GuiTextField func_178068_a(
      int p_178068_1_, int p_178068_2_, EditBoxEntry p_178068_3_) {
