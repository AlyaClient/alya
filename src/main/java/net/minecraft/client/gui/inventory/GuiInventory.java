...
public class GuiInventory extends InventoryEffectRenderer {
  ...
  protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
    font.drawString(
        I18n.format("container.crafting", new Object[0]), (float) (86), (float) (16), 4210752);
  }
  ...
  public static void drawEntityOnScreen(
      int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent) {
    ...
    GlStateManager.rotate(
        -((float) Math.atan((double) (mouseY / 40.0F))) * 20.0F, 1.0F, 0.0F, 0.0F);
