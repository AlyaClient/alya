...
public class GuiBeacon extends GuiContainer {
  ...
  public void initGui() {
    super.initGui();
    this.buttonList.add(
        this.beaconConfirmButton =
            new ConfirmButton(-1, this.guiLeft + 164, this.guiTop + 107));
    ...
    if (this.buttonsNotDrawn && i >= 0) {
      ...
      for (int l = 0; l <= 2; ++l) {
        ...
        for (int k1 = 0; k1 < i1; ++k1) {
          ...
          PowerButton guibeacon$powerbutton =
              new PowerButton(
                  l << 8 | l1,
                  this.guiLeft + 76 + k1 * 24 - j1 / 2,
                  this.guiTop + 22 + l * 25,
                  l1,
                  l);
      ...
      for (int l2 = 0; l2 < j2 - 1; ++l2) {
        ...
        PowerButton guibeacon$powerbutton2 =
            new PowerButton(
      ...
      if (j > 0) {
        PowerButton guibeacon$powerbutton1 =
            new PowerButton(
  ...
  protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
    ...
    this.itemRender.renderItemAndEffectIntoGUI(
        new ItemStack(Items.gold_ingot), i + 42 + 44, j + 109);
    this.itemRender.renderItemAndEffectIntoGUI(
        new ItemStack(Items.iron_ingot), i + 42 + 66, j + 109);
  ...
  class CancelButton extends Button {
    ...
    public void drawButtonForegroundLayer(int mouseX, int mouseY) {
      GuiBeacon.this.drawCreativeTabHoveringText(
          I18n.format("gui.cancel", new Object[0]), mouseX, mouseY);
    }
  }
  ...
  class ConfirmButton extends Button {
    ...
    public void drawButtonForegroundLayer(int mouseX, int mouseY) {
      GuiBeacon.this.drawCreativeTabHoveringText(
          I18n.format("gui.done", new Object[0]), mouseX, mouseY);
    }
  }
  ...
  class PowerButton extends Button {
    ...
    public PowerButton(
        int p_i1076_2_, int p_i1076_3_, int p_i1076_4_, int p_i1076_5_, int p_i1076_6_) {
      super(
          p_i1076_2_,
          p_i1076_3_,
          p_i1076_4_,
