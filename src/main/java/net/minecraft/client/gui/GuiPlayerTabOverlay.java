...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list)
        {
            ...
            {
                k = (int) font.getStringWidth(" " + scoreboardIn.getValueFromObjective(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
                j = Math.max(j, k);
            }
        }
        ...
        if (list1 != null)
        {
            drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * (int) font.getFontHeight(), Integer.MIN_VALUE);
        ...
        {
            k1 = k1 + i4 * 9 + 1;
            drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list2.size() * (int) font.getFontHeight(), Integer.MIN_VALUE);
    ...
    private void drawScoreboardValues(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
    {
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
        {
            ...
            if (j > 0)
            {
                ...
                else
                {
                    ...
                    font.drawStringWithShadow(s, (float)((p_175247_5_ + p_175247_4_) / 2 - (int) font.getStringWidth(s) / 2), (float)p_175247_2_, i1);
                }
            }
        }
        else
        {
            ...
            font.drawStringWithShadow(s1, (float)(p_175247_5_ - (int) font.getStringWidth(s1)), (float)p_175247_2_, 16777215);
        }
    }
