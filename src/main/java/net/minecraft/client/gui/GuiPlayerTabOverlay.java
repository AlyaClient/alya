...
public class GuiPlayerTabOverlay extends Gui {
  private static final Ordering<NetworkPlayerInfo> field_175252_a =
      Ordering.from(new GuiPlayerTabOverlay.PlayerComparator());
  ...
  public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
    return networkPlayerInfoIn.getDisplayName() != null
        ...
        : ScorePlayerTeam.formatPlayerName(
            networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName());
  }
  ...
  public void renderPlayerlist(
      int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
    NetHandlerPlayClient nethandlerplayclient = this.mc.thePlayer.sendQueue;
    List<NetworkPlayerInfo> list =
        field_175252_a.<NetworkPlayerInfo>sortedCopy(nethandlerplayclient.getPlayerInfoMap());
    int i = 0;
    int j = 0;

    for (NetworkPlayerInfo networkplayerinfo : list) {
      int k = (int) font.getStringWidth(this.getPlayerName(networkplayerinfo));
      i = Math.max(i, k);
                    ...
                    " "
                        + scoreboardIn
                            .getValueFromObjective(
                                networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn)
                            .getScorePoints());
        j = Math.max(j, k);
      }
    }
    ...
    if (this.header != null) {
      list1 =
          this.mc.fontRendererObj.listFormattedStringToWidth(
              this.header.getFormattedText(), width - 50);

      for (String s : list1) {
        l1 = Math.max(l1, (int) font.getStringWidth(s));
      }
    }
    ...
    if (this.footer != null) {
      list2 =
          this.mc.fontRendererObj.listFormattedStringToWidth(
              this.footer.getFormattedText(), width - 50);

      for (String s2 : list2) {
        l1 = Math.max(l1, (int) font.getStringWidth(s2));
      }
    }
    ...
    if (list1 != null) {
      drawRect(
          ...
          k1 - 1,
          width / 2 + l1 / 2 + 1,
          k1 + list1.size() * (int) font.getFontHeight(),
          Integer.MIN_VALUE);

      for (String s3 : list1) {
        int i2 = (int) font.getStringWidth(s3);
        font.drawStringWithShadow(s3, (float) (width / 2 - i2 / 2), (float) k1, -1);
        k1 += (int) font.getFontHeight();
      }
    ...
    drawRect(
        width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + i4 * 9, Integer.MIN_VALUE);
    ...
    for (int k4 = 0; k4 < l3; ++k4) {
      ...
      if (k4 < list.size()) {
        ...
        if (flag) {
          ...
          boolean flag1 =
              entityplayer != null
                  ...
                  && (gameprofile.getName().equals("Dinnerbone")
        ...
        if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
          ...
          font.drawStringWithShadow(s1, (float) j2, (float) k2, -1862270977);
        } else {
        ...
        if (scoreObjectiveIn != null
          ...
          if (l5 - k5 > 5) {
            this.drawScoreboardValues(
                scoreObjectiveIn, k2, gameprofile.getName(), k5, l5, networkplayerinfo1);
          }
        }
    ...
    if (list2 != null) {
      ...
      drawRect(
          ...
          k1 - 1,
          width / 2 + l1 / 2 + 1,
          k1 + list2.size() * (int) font.getFontHeight(),
          Integer.MIN_VALUE);

      for (String s4 : list2) {
        int j5 = (int) font.getStringWidth(s4);
        font.drawStringWithShadow(s4, (float) (width / 2 - j5 / 2), (float) k1, -1);
        k1 += (int) font.getFontHeight();
      }
    }
  }

  protected void drawPing(
      int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    this.drawTexturedModalRect(
        p_175245_2_ + p_175245_1_ - 11, p_175245_3_, 0 + i * 10, 176 + j * 8, 10, 8);
    this.zLevel -= 100.0F;
  }

  private void drawScoreboardValues(
      ScoreObjective p_175247_1_,
      int p_175247_2_,
      String p_175247_3_,
      int p_175247_4_,
      int p_175247_5_,
    ...
    int i =
        p_175247_1_
            .getScoreboard()
            .getValueFromObjective(p_175247_3_, p_175247_1_)
            .getScorePoints();
    ...
    if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
      ...
      int k =
          Math.max(
              MathHelper.ceiling_float_int((float) (i / 2)),
              Math.max(
                  MathHelper.ceiling_float_int((float) (p_175247_6_.func_178860_m() / 2)), 10));
      boolean flag =
          p_175247_6_.func_178858_o() > (long) this.guiIngame.getUpdateCounter()
              && (p_175247_6_.func_178858_o() - (long) this.guiIngame.getUpdateCounter()) / 3L % 2L
                  == 1L;
      ...
      if (j > 0) {
        ...
        if (f > 3.0F) {
          for (int l = j; l < k; ++l) {
            this.drawTexturedModalRect(
                (float) p_175247_4_ + (float) l * f, (float) p_175247_2_, flag ? 25 : 16, 0, 9, 9);
          }

          for (int j1 = 0; j1 < j; ++j1) {
            this.drawTexturedModalRect(
                (float) p_175247_4_ + (float) j1 * f, (float) p_175247_2_, flag ? 25 : 16, 0, 9, 9);

            if (flag) {
              if (j1 * 2 + 1 < p_175247_6_.func_178860_m()) {
                this.drawTexturedModalRect(
                    (float) p_175247_4_ + (float) j1 * f, (float) p_175247_2_, 70, 0, 9, 9);
              }

              if (j1 * 2 + 1 == p_175247_6_.func_178860_m()) {
                this.drawTexturedModalRect(
                    (float) p_175247_4_ + (float) j1 * f, (float) p_175247_2_, 79, 0, 9, 9);
              }
            }
          ...
          if (p_175247_5_ - (int) font.getStringWidth(s + "hp") >= p_175247_4_) {
            s = s + "hp";
          }

          font.drawStringWithShadow(
              s,
              (float) ((p_175247_5_ + p_175247_4_) / 2 - (int) font.getStringWidth(s) / 2),
              (float) p_175247_2_,
              i1);
        }
      }
      ...
      font.drawStringWithShadow(
          s1, (float) (p_175247_5_ - (int) font.getStringWidth(s1)), (float) p_175247_2_, 16777215);
    }
  }
