...
public class GuiIngame extends Gui {
        ...
        if(this.recordPlayingUpFor > 0) {
            ...
            if(l1 > 8) {
                ...
                this.getFontRenderer()
                        .drawString(
                                this.recordPlaying,
                                -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2,
                                -4,
                                l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
                        ...
                        Iterables.filter(
                                ...
                                new Predicate<Score>() {
                                    public boolean apply(Score p_apply_1_) {
                                        return p_apply_1_.getPlayerName() != null
        ...
        int totalHeight = lineCount * fontHeight + fontHeight + 1; // lines + header + separator
        int bottomPadding = 3;
    ...
    private void renderPumpkinOverlay(ScaledResolution p_180476_1_) {
        ...
        worldrenderer
                .pos(0.0D, (double) p_180476_1_.getScaledHeight(), -90.0D)
                .tex(0.0D, 1.0D)
                .endVertex();
        worldrenderer
                .pos((double) p_180476_1_.getScaledWidth(), (double) p_180476_1_.getScaledHeight(), -90.0D)
                .tex(1.0D, 1.0D)
                .endVertex();
        worldrenderer
                .pos((double) p_180476_1_.getScaledWidth(), 0.0D, -90.0D)
                .tex(1.0D, 0.0D)
                .endVertex();
    ...
    private void renderVignette(float p_180480_1_, ScaledResolution p_180480_2_) {
        if(!Config.isVignetteEnabled()) {
            ...
            worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
            worldrenderer
                    .pos(0.0D, (double) p_180480_2_.getScaledHeight(), -90.0D)
                    .tex(0.0D, 1.0D)
                    .endVertex();
            worldrenderer
                    .pos(
                            (double) p_180480_2_.getScaledWidth(), (double) p_180480_2_.getScaledHeight(), -90.0D)
                    .tex(1.0D, 1.0D)
                    .endVertex();
            worldrenderer
                    .pos((double) p_180480_2_.getScaledWidth(), 0.0D, -90.0D)
                    .tex(1.0D, 0.0D)
                    .endVertex();
            worldrenderer.pos(0.0D, 0.0D, -90.0D).tex(0.0D, 0.0D).endVertex();
            tessellator.draw();
    ...
    private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_) {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
        worldrenderer
                .pos(0.0D, (double) p_180474_2_.getScaledHeight(), -90.0D)
                .tex((double) f, (double) f3)
                .endVertex();
        worldrenderer
                .pos((double) p_180474_2_.getScaledWidth(), (double) p_180474_2_.getScaledHeight(), -90.0D)
                .tex((double) f2, (double) f3)
                .endVertex();
        worldrenderer
                .pos((double) p_180474_2_.getScaledWidth(), 0.0D, -90.0D)
    ...
    private void renderHotbarItem(
            int index, int xPos, int yPos, float partialTicks, EntityPlayer p_175184_5_) {
    ...
    public void displayTitle(
            String p_175178_1_, String p_175178_2_, int p_175178_3_, int p_175178_4_, int p_175178_5_) {
        if(p_175178_1_ == null
                && p_175178_2_ == null
                && p_175178_3_ < 0
                && p_175178_4_ < 0
