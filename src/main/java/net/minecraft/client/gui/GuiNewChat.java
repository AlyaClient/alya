                    ...
                    if(chatline != null) {
                        ...
                        if(j1 < 200 || flag) {
                            ...
                            if(l1 > 3) {
                                ...
                                Optional<Module> hudModuleOpt = Alya.getInstance().getModuleManager().getModule("HUD");
                                ...
                                drawRect(i2, (int) (j2 - 9 + animationOffsetY), i2 + l + 4, (int) (j2 + animationOffsetY), l1 / 2 << 24);
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                font.drawStringWithShadow(s, (float) i2, (float) (j2 - 8) + animationOffsetY, 16777215 + (l1 << 24));
    ...
    public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_) {
        if(!this.getChatOpen()) {
            ...
            if(j >= 0 && k >= 0) {
                ...
                if(j <= MathHelper.floor_float((float) this.getChatWidth() / this.getChatScale()) && k < (int) font.getFontHeight() * l + l) {
                    ...
                    if(i1 >= 0 && i1 < this.field_146253_i.size()) {
                        ...
                        for(IChatComponent ichatcomponent : chatline.getChatComponent()) {
                            if(ichatcomponent instanceof ChatComponentText) {
                                j1 += (int) font.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText) ichatcomponent).getChatComponentText_TextValue(), false));
