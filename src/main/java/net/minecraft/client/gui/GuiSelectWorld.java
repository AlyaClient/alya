...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback {
  ...
  public void initGui() {
    ...
    try {
      ...
      this.mc.displayGuiScreen(
          new GuiErrorScreen("Unable to load worlds", anvilconverterexception.getMessage()));
      return;
    }
    ...
    if (button.enabled) {
      if (button.id == 2) {
        ...
        ISaveHandler isavehandler =
            this.mc.getSaveLoader().getSaveLoader(this.func_146621_a(this.field_146640_r), false);
  ...
  public static GuiYesNo func_152129_a(
      GuiYesNoCallback p_152129_0_, String p_152129_1_, int p_152129_2_) {
    String s = I18n.format("selectWorld.deleteQuestion", new Object[0]);
    String s1 =
        "\'" + p_152129_1_ + "\' " + I18n.format("selectWorld.deleteWarning", new Object[0]);
  ...
  class List extends GuiSlot {
    public List(Minecraft mcIn) {
      super(
          mcIn,
          GuiSelectWorld.this.width,
          GuiSelectWorld.this.height,
          32,
          GuiSelectWorld.this.height - 64,
          36);
    }
    ...
    protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
      ...
      boolean flag =
          GuiSelectWorld.this.field_146640_r >= 0
    ...
    protected void drawSlot(
        ...
        int mouseXIn,
        int mouseYIn) {
      SaveFormatComparator saveformatcomparator =
          (SaveFormatComparator) GuiSelectWorld.this.field_146639_s.get(entryID);
      ...
      s1 =
          s1
              + " ("
              + GuiSelectWorld.this.field_146633_h.format(
