...
public class GuiCommandBlock extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.commandTextField =
        new GuiTextField(2, this.fontRendererObj, this.width / 2 - 150, 50, 300, 20);
    this.commandTextField.setMaxStringLength(32767);
    this.commandTextField.setFocused(true);
    this.commandTextField.setText(this.localCommandBlock.getCommand());
    this.previousOutputTextField =
        new GuiTextField(3, this.fontRendererObj, this.width / 2 - 150, 150, 276, 20);
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled) {
      if (button.id == 1) {
        ...
        this.mc
            .getNetHandler()
            .addToSendQueue(new C17PacketCustomPayload("MC|AdvCdm", packetbuffer));
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this.drawCenteredString(
        I18n.format("advMode.setCommand", new Object[0]), this.width / 2, 20, 16777215);
    this.drawString(
        I18n.format("advMode.command", new Object[0]), this.width / 2 - 150, 37, 10526880);
    this.commandTextField.drawTextBox();
    int i = 75;
    int j = 0;
    this.drawString(
        I18n.format("advMode.nearestPlayer", new Object[0]),
        this.width / 2 - 150,
        i + j++ * (int) font.getFontHeight(),
        10526880);
    this.drawString(
    ...
    this.drawString(
        ...
        10526880);
    this.drawString(
        I18n.format("advMode.allEntities", new Object[0]),
        this.width / 2 - 150,
        i + j++ * (int) font.getFontHeight(),
        10526880);
    this.drawString("", this.width / 2 - 150, i + j++ * (int) font.getFontHeight(), 10526880);

    if (this.previousOutputTextField.getText().length() > 0) {
      i = i + j * (int) font.getFontHeight() + 16;
      this.drawString(
          I18n.format("advMode.previousOutput", new Object[0]), this.width / 2 - 150, i, 10526880);
  ...
  private void func_175388_a() {
    if (this.localCommandBlock.shouldTrackOutput()) {
      ...
      if (this.localCommandBlock.getLastOutput() != null) {
        this.previousOutputTextField.setText(
            this.localCommandBlock.getLastOutput().getUnformattedText());
      }
    } else {
