...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
  private static final GameSettings.Options[] field_146440_f =
      new GameSettings.Options[] {GameSettings.Options.FOV};
    ...
    if (this.mc.theWorld != null) {
      ...
      this.field_175357_i =
          new GuiButton(
              ...
              150,
              20,
              this.func_175355_a(enumdifficulty));
  ...
  public String func_175355_a(EnumDifficulty p_175355_1_) {
    ...
    ichatcomponent.appendSibling(
        new ChatComponentTranslation(p_175355_1_.getDifficultyResourceKey(), new Object[0]));
    ...
    if (button.enabled) {
      if (button.id < 100 && button instanceof GuiOptionButton) {
        ...
        button.displayString =
            this.game_settings_1.getKeyBinding(GameSettings.Options.getEnumOptions(button.id));
      }
        ...
        this.mc
            ...
            .setDifficulty(
                EnumDifficulty.getDifficultyEnum(
                    this.mc.theWorld.getDifficulty().getDifficultyId() + 1));
      ...
      if (button.id == 102) {
        this.mc.gameSettings.saveOptions();
        this.mc.displayGuiScreen(
            new GuiLanguage(this, this.game_settings_1, this.mc.getLanguageManager()));
      }
