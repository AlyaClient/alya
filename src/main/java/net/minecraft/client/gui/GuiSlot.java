...
public abstract class GuiSlot {
  ...
  /**
   * What to multiply the amount you moved your mouse by (used for slowing down scrolling when over
   * the items and not on the scroll bar)
   */
  ...
  /**
   * Sets hasListHeader and headerHeight. Params: hasListHeader, headerHeight. If hasListHeader is
   * false headerHeight is set to 0.
   */
  ...
  protected abstract void elementClicked(
      int slotIndex, boolean isDoubleClick, int mouseX, int mouseY);
  ...
  public int getSlotIndexFromScreenCoords(int p_148124_1_, int p_148124_2_) {
    ...
    return p_148124_1_ < this.getScrollBarX()
            && p_148124_1_ >= i
            && p_148124_1_ <= j
            && l >= 0
            && k >= 0
  ...
  protected void bindAmountScrolled() {
    this.amountScrolled =
        MathHelper.clamp_float(this.amountScrolled, 0.0F, (float) this.func_148135_f());
  }
  ...
  /**
   * Scrolls the slot by the given amount. A positive value scrolls down, and a negative value
   * scrolls up.
   */
    ...
    if (this.isMouseYWithinSlotBounds(this.mouseY)) {
      if (Mouse.getEventButton() == 0
        ...
        if (l < this.getSize() && this.mouseX >= i && this.mouseX <= j && l >= 0 && k >= 0) {
          ...
          this.func_148132_a(
              this.mouseX - i, this.mouseY - this.top + (int) this.amountScrolled - 4);
        }
      }
      ...
      if (Mouse.isButtonDown(0) && this.getEnabled()) {
        if (this.initialClickY != -1) {
          if (this.initialClickY >= 0) {
            this.amountScrolled -=
                (float) (this.mouseY - this.initialClickY) * this.scrollMultiplier;
          ...
          if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
            ...
            if (i1 < this.getSize()
                ...
                && l2 >= 0) {
              boolean flag =
                  i1 == this.selectedElement && Minecraft.getSystemTime() - this.lastClicked < 250L;
              this.elementClicked(i1, flag, this.mouseX, this.mouseY);
              this.selectedElement = i1;
              this.lastClicked = Minecraft.getSystemTime();
            } else if (this.mouseX >= j2 && this.mouseX <= k2 && l2 < 0) {
              this.func_148132_a(
                  this.mouseX - j2, this.mouseY - this.top + (int) this.amountScrolled - 4);
              flag1 = false;
            }
  ...
  protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn) {
    ...
    for (int j = 0; j < i; ++j) {
      ...
      if (!(this instanceof GuiResourcePackList)
          || k >= this.top - this.slotHeight && k <= this.bottom) {
  ...
  /**
   * Sets the left and right bounds of the slot. Param is the left bound, right is calculated as
   * left + width.
   */
