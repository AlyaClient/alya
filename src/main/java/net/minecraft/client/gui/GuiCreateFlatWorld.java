...
public class GuiCreateFlatWorld extends GuiScreen {
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    int i =
        this.theFlatGeneratorInfo.getFlatLayers().size()
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this.drawString(
        this.field_146391_r,
        i + 2 + 213 - (int) font.getStringWidth(this.field_146391_r),
        32,
        16777215);
  ...
  class Details extends GuiSlot {
    ...
    private void func_148225_a(int p_148225_1_, int p_148225_2_, ItemStack p_148225_3_) {
      ...
      if (p_148225_3_ != null && p_148225_3_.getItem() != null) {
        ...
        GuiCreateFlatWorld.this.itemRender.renderItemIntoGUI(
    ...
    private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
      ...
      worldrenderer
          .pos(
              (double) (p_148224_1_ + 0),
              (double) (p_148224_2_ + 18),
              (double) GuiCreateFlatWorld.this.zLevel)
          .tex(
              (double) ((float) (p_148224_3_ + 0) * 0.0078125F),
              (double) ((float) (p_148224_4_ + 18) * 0.0078125F))
          .endVertex();
      worldrenderer
          .pos(
              (double) (p_148224_1_ + 18),
              (double) (p_148224_2_ + 18),
              (double) GuiCreateFlatWorld.this.zLevel)
          .tex(
              (double) ((float) (p_148224_3_ + 18) * 0.0078125F),
              (double) ((float) (p_148224_4_ + 18) * 0.0078125F))
          .endVertex();
      worldrenderer
          .pos(
              (double) (p_148224_1_ + 18),
              (double) (p_148224_2_ + 0),
              (double) GuiCreateFlatWorld.this.zLevel)
          .tex(
              (double) ((float) (p_148224_3_ + 18) * 0.0078125F),
    ...
    protected void drawSlot(
      ...
      FlatLayerInfo flatlayerinfo =
          (FlatLayerInfo)
              GuiCreateFlatWorld.this
                  ...
                  .getFlatLayers()
                  .get(
                      GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size()
                          - entryID
                          - 1);
      ...
      font.drawString(s, (float) (p_180791_2_ + 18 + 5), (float) (p_180791_3_ + 3), 16777215);
      String s1;
      ...
      if (entryID == 0) {
        s1 =
          ...
          == GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - 1) {
        s1 =
            I18n.format(
      ...
      font.drawString(
          s1,
          (float) (p_180791_2_ + 2 + 213 - (int) font.getStringWidth(s1)),
          (float) (p_180791_3_ + 3),
          16777215);
    }
