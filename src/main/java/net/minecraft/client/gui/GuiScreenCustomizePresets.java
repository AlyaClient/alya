...
public class GuiScreenCustomizePresets extends GuiScreen {
  ...
  private boolean func_175305_g() {
    return this.field_175311_g.field_178053_u > -1
            && this.field_175311_g.field_178053_u < field_175310_f.size()
        || this.field_175317_i.getText().length() > 1;
  }

  static {
    ChunkProviderSettings.Factory chunkprovidersettings$factory =
        ChunkProviderSettings.Factory.jsonToFactory(
            "{ \"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":512.0,"
                + " \"lowerLimitScale\":512.0, \"depthNoiseScaleX\":200.0,"
                + " \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5,"
                + " \"mainNoiseScaleX\":5000.0, \"mainNoiseScaleY\":1000.0,"
                + " \"mainNoiseScaleZ\":5000.0, \"baseSize\":8.5, \"stretchY\":8.0,"
                + " \"biomeDepthWeight\":2.0, \"biomeDepthOffset\":0.5, \"biomeScaleWeight\":2.0,"
                + " \"biomeScaleOffset\":0.375, \"useCaves\":true, \"useDungeons\":true,"
                + " \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true,"
                + " \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true,"
                + " \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true,"
    ...
    chunkprovidersettings$factory =
        ChunkProviderSettings.Factory.jsonToFactory(
            "{\"coordinateScale\":3000.0, \"heightScale\":6000.0, \"upperLimitScale\":250.0,"
                + " \"lowerLimitScale\":512.0, \"depthNoiseScaleX\":200.0,"
                + " \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5,"
                + " \"mainNoiseScaleX\":80.0, \"mainNoiseScaleY\":160.0, \"mainNoiseScaleZ\":80.0,"
                + " \"baseSize\":8.5, \"stretchY\":10.0, \"biomeDepthWeight\":1.0,"
                + " \"biomeDepthOffset\":0.0, \"biomeScaleWeight\":1.0, \"biomeScaleOffset\":0.0,"
                + " \"useCaves\":true, \"useDungeons\":true, \"dungeonChance\":8,"
                + " \"useStrongholds\":true, \"useVillages\":true, \"useMineShafts\":true,"
                + " \"useTemples\":true, \"useRavines\":true, \"useWaterLakes\":true,"
                + " \"waterLakeChance\":4, \"useLavaLakes\":true, \"lavaLakeChance\":80,"
    ...
    chunkprovidersettings$factory =
        ChunkProviderSettings.Factory.jsonToFactory(
            "{\"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":512.0,"
                ...
                + " \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5,"
                + " \"mainNoiseScaleX\":5000.0, \"mainNoiseScaleY\":1000.0,"
                + " \"mainNoiseScaleZ\":5000.0, \"baseSize\":8.5, \"stretchY\":5.0,"
                + " \"biomeDepthWeight\":2.0, \"biomeDepthOffset\":1.0, \"biomeScaleWeight\":4.0,"
                + " \"biomeScaleOffset\":1.0, \"useCaves\":true, \"useDungeons\":true,"
                + " \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true,"
                + " \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true,"
                + " \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true,"
    ...
    chunkprovidersettings$factory =
        ChunkProviderSettings.Factory.jsonToFactory(
            "{\"coordinateScale\":738.41864, \"heightScale\":157.69133,"
                + " \"upperLimitScale\":801.4267, \"lowerLimitScale\":1254.1643,"
                + " \"depthNoiseScaleX\":374.93652, \"depthNoiseScaleZ\":288.65228,"
                + " \"depthNoiseScaleExponent\":1.2092624, \"mainNoiseScaleX\":1355.9908,"
                + " \"mainNoiseScaleY\":745.5343, \"mainNoiseScaleZ\":1183.464,"
                + " \"baseSize\":1.8758626, \"stretchY\":1.7137525, \"biomeDepthWeight\":1.7553768,"
                + " \"biomeDepthOffset\":3.4701107, \"biomeScaleWeight\":1.0,"
                + " \"biomeScaleOffset\":2.535211, \"useCaves\":true, \"useDungeons\":true,"
                + " \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true,"
                + " \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true,"
                + " \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true,"
                + " \"lavaLakeChance\":80, \"useLavaOceans\":false, \"seaLevel\":63 }");
    ...
    chunkprovidersettings$factory =
        ChunkProviderSettings.Factory.jsonToFactory(
            "{\"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":512.0,"
                + " \"lowerLimitScale\":512.0, \"depthNoiseScaleX\":200.0,"
                + " \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5,"
                + " \"mainNoiseScaleX\":1000.0, \"mainNoiseScaleY\":3000.0,"
                + " \"mainNoiseScaleZ\":1000.0, \"baseSize\":8.5, \"stretchY\":10.0,"
                + " \"biomeDepthWeight\":1.0, \"biomeDepthOffset\":0.0, \"biomeScaleWeight\":1.0,"
                + " \"biomeScaleOffset\":0.0, \"useCaves\":true, \"useDungeons\":true,"
                + " \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true,"
                + " \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true,"
                + " \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true,"
    ...
    chunkprovidersettings$factory =
        ChunkProviderSettings.Factory.jsonToFactory(
            "{\"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":2.0,"
                + " \"lowerLimitScale\":64.0, \"depthNoiseScaleX\":200.0,"
                + " \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5,"
                + " \"mainNoiseScaleX\":80.0, \"mainNoiseScaleY\":160.0, \"mainNoiseScaleZ\":80.0,"
                + " \"baseSize\":8.5, \"stretchY\":12.0, \"biomeDepthWeight\":1.0,"
                + " \"biomeDepthOffset\":0.0, \"biomeScaleWeight\":1.0, \"biomeScaleOffset\":0.0,"
                + " \"useCaves\":true, \"useDungeons\":true, \"dungeonChance\":8,"
                + " \"useStrongholds\":true, \"useVillages\":true, \"useMineShafts\":true,"
                + " \"useTemples\":true, \"useRavines\":true, \"useWaterLakes\":true,"
  ...
  static class Info {
    ...
    public Info(
        String p_i45523_1_,
        ResourceLocation p_i45523_2_,
        ChunkProviderSettings.Factory p_i45523_3_) {
  ...
  class ListPreset extends GuiSlot {
    ...
    private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_) {
      ...
      GuiScreenCustomizePresets.this.drawVerticalLine(
          i - 1, p_178051_2_ - 1, p_178051_2_ + 32, -2039584);
      GuiScreenCustomizePresets.this.drawVerticalLine(
          i + 32, p_178051_2_ - 1, p_178051_2_ + 32, -6250336);
      ...
      worldrenderer
          ...
          .endVertex();
      worldrenderer
          .pos((double) (i + 32), (double) (p_178051_2_ + 32), 0.0D)
          .tex(1.0D, 1.0D)
          .endVertex();
      worldrenderer
          .pos((double) (i + 32), (double) (p_178051_2_ + 0), 0.0D)
          .tex(1.0D, 0.0D)
          .endVertex();
      worldrenderer
          .pos((double) (i + 0), (double) (p_178051_2_ + 0), 0.0D)
          .tex(0.0D, 0.0D)
          .endVertex();
      tessellator.draw();
    }
    ...
    protected void drawSlot(
      ...
      font.drawString(
          ...
          (float) (p_180791_2_ + 32 + 10),
          (float) (p_180791_3_ + 14),
          16777215);
    }
  }
}
