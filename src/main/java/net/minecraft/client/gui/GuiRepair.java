...
public class GuiRepair extends GuiContainer implements ICrafting {
  ...
  protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
    ...
    font.drawString(
        I18n.format("container.repair", new Object[0]), (float) (60), (float) (6), 4210752);
    ...
    if (this.anvil.maximumCost > 0) {
      ...
      String s =
          I18n.format(
              "container.repair.cost", new Object[] {Integer.valueOf(this.anvil.maximumCost)});
  ...
  private void renameItem() {
    ...
    this.mc.thePlayer.sendQueue.addToSendQueue(
        new C17PacketCustomPayload(
            "MC|ItemName", (new PacketBuffer(Unpooled.buffer())).writeString(s)));
  }
  ...
  protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
    ...
    this.drawTexturedModalRect(
        i + 59, j + 20, 0, this.ySize + (this.anvil.getSlot(0).getHasStack() ? 0 : 16), 110, 16);
