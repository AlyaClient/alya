...
public class GuiRenameWorld extends GuiScreen {
  ...
  public void initGui() {
    ...
    this.field_146583_f =
        new GuiTextField(2, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
  ...
  protected void keyTyped(char typedChar, int keyCode) throws IOException {
    ...
    ((GuiButton) this.buttonList.get(0)).enabled =
        this.field_146583_f.getText().trim().length() > 0;
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this.drawCenteredString(
        I18n.format("selectWorld.renameTitle", new Object[0]), this.width / 2, 20, 16777215);
    this.drawString(
        I18n.format("selectWorld.enterName", new Object[0]), this.width / 2 - 100, 47, 10526880);
