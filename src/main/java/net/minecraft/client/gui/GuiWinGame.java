...
public class GuiWinGame extends GuiScreen {
  ...
  private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
    ...
    float f1 =
        (float) this.height
            - ((float) this.field_146581_h + p_146575_3_) * 0.5F * this.field_146578_s;
    float f2 = 0.015625F;
    ...
    f3 = f3 * 96.0F / 255.0F;
    worldrenderer
        .pos(0.0D, (double) this.height, (double) this.zLevel)
        .tex(0.0D, (double) (f * f2))
        .func_181666_a(f3, f3, f3, 1.0F)
        .endVertex();
    worldrenderer
        .pos((double) i, (double) this.height, (double) this.zLevel)
        .tex((double) ((float) i * f2), (double) (f * f2))
        .func_181666_a(f3, f3, f3, 1.0F)
        .endVertex();
    worldrenderer
        .pos((double) i, 0.0D, (double) this.zLevel)
        .tex((double) ((float) i * f2), (double) (f1 * f2))
        .func_181666_a(f3, f3, f3, 1.0F)
        .endVertex();
    worldrenderer
        .pos(0.0D, 0.0D, (double) this.zLevel)
        .tex(0.0D, (double) (f1 * f2))
        .func_181666_a(f3, f3, f3, 1.0F)
        .endVertex();
    tessellator.draw();
  }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if ((float) l + f + 12.0F + 8.0F > 0.0F && (float) l + f < (float) this.height) {
        ...
        if (s.startsWith("[C]")) {
          font.drawStringWithShadow(
              s.substring(3),
              (float) (j + (i - (int) font.getStringWidth(s.substring(3))) / 2),
              (float) l,
              16777215);
        } else {
          this.fontRendererObj.fontRandom.setSeed(
              (long) i1 * 4238972211L + (long) (this.field_146581_h / 4));
    ...
    worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
    worldrenderer
        .pos(0.0D, (double) k1, (double) this.zLevel)
        .tex(0.0D, 1.0D)
        .func_181666_a(1.0F, 1.0F, 1.0F, 1.0F)
        .endVertex();
    worldrenderer
        .pos((double) j1, (double) k1, (double) this.zLevel)
        .tex(1.0D, 1.0D)
        .func_181666_a(1.0F, 1.0F, 1.0F, 1.0F)
        .endVertex();
    worldrenderer
        .pos((double) j1, 0.0D, (double) this.zLevel)
        .tex(1.0D, 0.0D)
        .func_181666_a(1.0F, 1.0F, 1.0F, 1.0F)
        .endVertex();
    worldrenderer
