...
public class AnimationMetadataSectionSerializer
  ...
  public AnimationMetadataSection deserialize(
      ...
      for (int i = 0; i < p_serialize_1_.getFrameCount(); ++i) {
        if (p_serialize_1_.frameHasTime(i)) {
          ...
          jsonobject1.addProperty(
              "index", (Number) Integer.valueOf(p_serialize_1_.getFrameIndex(i)));
          jsonobject1.addProperty(
              "time", (Number) Integer.valueOf(p_serialize_1_.getFrameTimeSingle(i)));
