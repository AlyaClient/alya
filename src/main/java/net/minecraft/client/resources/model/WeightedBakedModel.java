...
public class WeightedBakedModel implements IBakedModel {
  ...
  public IBakedModel getAlternativeModel(long p_177564_1_) {
    return ((WeightedBakedModel.MyWeighedRandomItem)
            WeightedRandom.getRandomItem(
                this.models, Math.abs((int) p_177564_1_ >> 16) % this.totalWeight))
        .model;
  }

  public static class Builder {
    private List<WeightedBakedModel.MyWeighedRandomItem> listItems =
        Lists.<WeightedBakedModel.MyWeighedRandomItem>newArrayList();
