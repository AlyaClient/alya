...
public class FallbackResourceManager implements IResourceManager {
    ...
    static class InputStreamLeakedResourceLogger extends InputStream {
        ...
        public InputStreamLeakedResourceLogger(InputStream p_i46093_1_, ResourceLocation location, String resourcePack) {
            ...
            this.cleanable = CLEANER.register(this, new LeakAction(this));
        }

        private static final class LeakAction implements Runnable {
            private final InputStreamLeakedResourceLogger logger;

            LeakAction(InputStreamLeakedResourceLogger logger) {
                this.logger = logger;
            }
            ...
            public void run() {
                if(!logger.isClosed) {
                    FallbackResourceManager.logger.warn(logger.message);
                }
            }
        }
