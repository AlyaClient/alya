            ...
            if(settingOption.getEnumFloat()) {
                ...
                if(settingOption == GameSettings.Options.MIPMAP_LEVELS && (double) f1 >= 4.0D) {
                    ...
                    if(f == 0.0F) {
                        ...
                        return s1 + I18n.format("options.sensitivity.max", new Object[0]);
                    } else {
                    ...
                    if(f1 == 70.0F) {
                        ...
                        return s1 + I18n.format("options.fov.max", new Object[0]);
                    } else {
                        return s1 + (int) f1;
                    }
                } else if(settingOption == GameSettings.Options.FRAMERATE_LIMIT) {
                    if(f1 == settingOption.valueMax) {
                        return s1 + I18n.format("options.framerateLimit.max", new Object[0]);
                    } else {
                        return s1 + (int) f1 + " fps";
                    }
                } else if(settingOption == GameSettings.Options.RENDER_CLOUDS) {
                    if(f1 == settingOption.valueMin) {
                        return s1 + I18n.format("options.cloudHeight.min", new Object[0]);
                    } else {
                    ...
                    if(f == 0.0F) {
                        ...
                        return s1 + I18n.format("options.gamma.max", new Object[0]);
                    } else {
