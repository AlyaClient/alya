...
public class GameSettings {
  ...
  private static final String[] AMBIENT_OCCLUSIONS =
      new String[] {"options.ao.off", "options.ao.min", "options.ao.max"};
  private static final String[] field_181149_aW =
      new String[] {"options.off", "options.graphics.fast", "options.graphics.fancy"};
  ...
  private final Set<EnumPlayerModelParts> setModelParts =
      Sets.newHashSet(EnumPlayerModelParts.values());
  ...
  public KeyBinding keyBindInventory =
      new KeyBinding("key.inventory", 18, "key.categories.inventory");
  ...
  public KeyBinding keyBindPickBlock =
      new KeyBinding("key.pickItem", -98, "key.categories.gameplay");
  ...
  public KeyBinding keyBindStreamPauseUnpause =
      new KeyBinding("key.streamPauseUnpause", 65, "key.categories.stream");
  public KeyBinding keyBindStreamCommercials =
      new KeyBinding("key.streamCommercial", 0, "key.categories.stream");
  public KeyBinding keyBindStreamToggleMic =
      new KeyBinding("key.streamToggleMic", 0, "key.categories.stream");
  ...
  public static String getKeyDisplayString(int p_74298_0_) {
    return p_74298_0_ < 0
        ? I18n.format("key.mouseButton", new Object[] {Integer.valueOf(p_74298_0_ + 101)})
        : (p_74298_0_ < 256
  ...
  public static boolean isKeyDown(KeyBinding p_100015_0_) {
    return p_100015_0_.getKeyCode() == 0
        ...
        : (p_100015_0_.getKeyCode() < 0
            ? Mouse.isButtonDown(p_100015_0_.getKeyCode() + 100)
  ...
  public void setOptionValue(GameSettings.Options p_74306_1_, int p_74306_2_) {
    ...
    if (p_74306_1_ == GameSettings.Options.FORCE_UNICODE_FONT) {
      ...
      this.mc.fontRendererObj.setUnicodeFlag(
          this.mc.getLanguageManager().isCurrentLocaleUnicode() || this.forceUnicodeFont);
    }
    ...
    if (p_74306_1_ == GameSettings.Options.ANAGLYPH) {
      if (!this.anaglyph && Config.isShaders()) {
        Config.showGuiMessage(
            Lang.get("of.message.an.shaders1"), Lang.get("of.message.an.shaders2"));
        return;
      }
    ...
    if (p_74306_1_ == GameSettings.Options.CHAT_VISIBILITY) {
      this.chatVisibility =
          EntityPlayer.EnumChatVisibility.getEnumChatVisibility(
              (this.chatVisibility.getChatVisibility() + p_74306_2_) % 3);
    }
  ...
  public float getOptionFloatValue(GameSettings.Options p_74296_1_) {
    ...
    if (p_74296_1_ == GameSettings.Options.FOV) return this.fovSetting;
    if (p_74296_1_ == GameSettings.Options.GAMMA) return this.gammaSetting;
    if (p_74296_1_ == GameSettings.Options.SATURATION) return this.saturation;
    if (p_74296_1_ == GameSettings.Options.SENSITIVITY) return this.mouseSensitivity;
    if (p_74296_1_ == GameSettings.Options.CHAT_OPACITY) return this.chatOpacity;
    if (p_74296_1_ == GameSettings.Options.CHAT_HEIGHT_FOCUSED) return this.chatHeightFocused;
    if (p_74296_1_ == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED) return this.chatHeightUnfocused;
    if (p_74296_1_ == GameSettings.Options.CHAT_SCALE) return this.chatScale;
    if (p_74296_1_ == GameSettings.Options.CHAT_WIDTH) return this.chatWidth;
    if (p_74296_1_ == GameSettings.Options.FRAMERATE_LIMIT) return (float) this.limitFramerate;
    if (p_74296_1_ == GameSettings.Options.MIPMAP_LEVELS) return (float) this.mipmapLevels;
    if (p_74296_1_ == GameSettings.Options.RENDER_DISTANCE)
  ...
  public String getKeyBinding(GameSettings.Options p_74297_1_) {
    ...
    if (s != null) {
      ...
      if (p_74297_1_.getEnumFloat()) {
        ...
        return p_74297_1_ == GameSettings.Options.MIPMAP_LEVELS && (double) f1 >= 4.0D
            ? s1 + Lang.get("of.general.max")
            : (p_74297_1_ == GameSettings.Options.SENSITIVITY
                ? (f == 0.0F
                    ? s1 + I18n.format("options.sensitivity.min", new Object[0])
                    : (f == 1.0F
                        ? s1 + I18n.format("options.sensitivity.max", new Object[0])
                        : s1 + (int) (f * 200.0F) + "%"))
                : (p_74297_1_ == GameSettings.Options.FOV
                    ? (f1 == 70.0F
                        ? s1 + I18n.format("options.fov.min", new Object[0])
                        : (f1 == 110.0F
                            ? s1 + I18n.format("options.fov.max", new Object[0])
                            : s1 + (int) f1))
                        ...
                        : (p_74297_1_ == GameSettings.Options.RENDER_CLOUDS
                            ...
                            : (p_74297_1_ == GameSettings.Options.GAMMA
                                ? (f == 0.0F
                                    ...
                                    : (f == 1.0F
                                        ? s1 + I18n.format("options.gamma.max", new Object[0])
                                        : s1 + "+" + (int) (f * 100.0F) + "%"))
                                        ...
                                        : (p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED
                                            ...
                                            : (p_74297_1_
                                                ...
                                                : (p_74297_1_ == GameSettings.Options.CHAT_WIDTH
                                                    ? s1
                                                        + GuiNewChat.calculateChatboxWidth(f)
                                                        + "px"
                                                    : (p_74297_1_
        ...
        return flag
            ? s1 + I18n.format("options.on", new Object[0])
          ...
          while ((s = bufferedreader.readLine()) != null) {
            try {
              ...
              if (astring[0].equals("resourcePacks")) {
                this.resourcePacks =
                    (List) gson.fromJson((String) s.substring(s.indexOf(58) + 1), typeListString);
              ...
              for (SoundCategory soundcategory : SoundCategory.values()) {
                if (astring[0].equals("soundCategory_" + soundcategory.getCategoryName())) {
                  this.mapSoundLevels.put(
                      soundcategory, Float.valueOf(this.parseFloat(astring[1])));
                }
              }
  ...
  private float parseFloat(String p_74305_1_) {
    return p_74305_1_.equals("true")
        ? 1.0F
        : (p_74305_1_.equals("false") ? 0.0F : Float.parseFloat(p_74305_1_));
  }
  ...
  public void saveOptions() {
    if (Reflector.FMLClientHandler.exists()) {
      ...
      if (object != null
          && Reflector.callBoolean(object, Reflector.FMLClientHandler_isLoading, new Object[0])) {
        return;
      }
    }
    ...
    try {
      ...
      for (KeyBinding keybinding : this.keyBindings) {
        printwriter.println(
            "key_" + keybinding.getKeyDescription() + ":" + keybinding.getKeyCode());
      }

      for (SoundCategory soundcategory : SoundCategory.values()) {
        printwriter.println(
            "soundCategory_"
                + soundcategory.getCategoryName()
                + ":"
                + this.getSoundLevel(soundcategory));
      }

      for (EnumPlayerModelParts enumplayermodelparts : EnumPlayerModelParts.values()) {
        printwriter.println(
            "modelPart_"
                + enumplayermodelparts.getPartName()
                + ":"
    ...
    if (this.mc.thePlayer != null) {
      ...
      this.mc.thePlayer.sendQueue.addToSendQueue(
          new C15PacketClientSettings(
              this.language, this.renderDistanceChunks, this.chatVisibility, this.chatColours, i));
    }
  }
  ...
  private void setOptionFloatValueOF(
      GameSettings.Options p_setOptionFloatValueOF_1_, float p_setOptionFloatValueOF_2_) {
    ...
    if (p_setOptionFloatValueOF_1_ == GameSettings.Options.AA_LEVEL) {
      ...
      if (i > 0 && Config.isShaders()) {
        Config.showGuiMessage(
            Lang.get("of.message.aa.shaders1"), Lang.get("of.message.aa.shaders2"));
        return;
      }
    ...
    if (p_setOptionFloatValueOF_1_ == GameSettings.Options.AF_LEVEL) {
      ...
      if (k > 1 && Config.isShaders()) {
        Config.showGuiMessage(
            Lang.get("of.message.af.shaders1"), Lang.get("of.message.af.shaders2"));
        return;
      }
  ...
  private float getOptionFloatValueOF(GameSettings.Options p_getOptionFloatValueOF_1_) {
    if (p_getOptionFloatValueOF_1_ == GameSettings.Options.CLOUD_HEIGHT) {
      ...
      return (float) this.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax()
              && this.enableVsync
          ? 0.0F
  ...
  private void setOptionValueOF(
      GameSettings.Options p_setOptionValueOF_1_, int p_setOptionValueOF_2_) {
    ...
    if (p_setOptionValueOF_1_ == GameSettings.Options.FAST_RENDER) {
      if (!this.ofFastRender && Config.isShaders()) {
        Config.showGuiMessage(
            Lang.get("of.message.fr.shaders1"), Lang.get("of.message.fr.shaders2"));
        return;
      }
  ...
  private String getKeyBindingOF(GameSettings.Options p_getKeyBindingOF_1_) {
    ...
    if (p_getKeyBindingOF_1_ == GameSettings.Options.RENDER_DISTANCE) {
          ...
          : (this.ofAutoSaveTicks <= 2 * l
              ...
              : (this.ofAutoSaveTicks <= 4 * l
                  ...
                  : (this.ofAutoSaveTicks <= 8 * l
                      ...
                      : (this.ofAutoSaveTicks <= 16 * l
                          ? s + Lang.get("of.options.save.12min")
      ...
      return this.ofTranslucentBlocks == 1
          ? s + Lang.getFast()
      ...
      return this.ofFullscreenMode.equals("Default")
          ? s + Lang.getDefault()
          : s + this.ofFullscreenMode;
      ...
      return f == 0.0F
          ...
          : (f == p_getKeyBindingOF_1_.valueMax
  ...
  public void saveOfOptions() {
    try {
      ...
      printwriter.println(
          "key_" + this.ofKeyBindZoom.getKeyDescription() + ":" + this.ofKeyBindZoom.getKeyCode());
      printwriter.close();
    } catch (Exception exception) {
  ...
  public static enum Options {
    ...
    FULLSCREEN_MODE(
        ...
        false,
        0.0F,
        (float) Config.getDisplayModes().length,
        1.0F),
    ...
    public float normalizeValue(float p_148266_1_) {
      return MathHelper.clamp_float(
          (this.snapToStepClamp(p_148266_1_) - this.valueMin) / (this.valueMax - this.valueMin),
          0.0F,
          1.0F);
    }
    ...
    public float denormalizeValue(float p_148262_1_) {
      return this.snapToStepClamp(
          this.valueMin
              + (this.valueMax - this.valueMin) * MathHelper.clamp_float(p_148262_1_, 0.0F, 1.0F));
    }
