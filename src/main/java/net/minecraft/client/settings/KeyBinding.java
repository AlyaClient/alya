...
public class KeyBinding implements Comparable<KeyBinding> {
  ...
  /**
   * Returns true on the initial key press. For continuous querying use {@link isKeyDown()}. Should
   * be used in key events.
   */
  ...
  public int compareTo(KeyBinding p_compareTo_1_) {
    int i =
        I18n.format(this.keyCategory, new Object[0])
            .compareTo(I18n.format(p_compareTo_1_.keyCategory, new Object[0]));

    if (i == 0) {
      i =
          I18n.format(this.keyDescription, new Object[0])
