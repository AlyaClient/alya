      ...
      if (i - this.systemTime >= 100L) {
          ...
          if (object != null) {
            flag =
                !Reflector.callBoolean(
                    object,
                    Reflector.FMLClientHandler_handleLoadingScreen,
        ...
        if (flag) {
          ...
          if (customloadingscreen != null) {
            customloadingscreen.drawBackground(
            ...
            worldrenderer
                .pos(0.0D, (double) l, 0.0D)
                .tex(0.0D, (double) ((float) l / f))
                .func_181669_b(64, 64, 64, 255)
                .endVertex();
            worldrenderer
                .pos((double) k, (double) l, 0.0D)
                .tex((double) ((float) k / f), (double) ((float) l / f))
                .func_181669_b(64, 64, 64, 255)
                .endVertex();
            worldrenderer
                .pos((double) k, 0.0D, 0.0D)
                .tex((double) ((float) k / f), 0.0D)
                .func_181669_b(64, 64, 64, 255)
                .endVertex();
            worldrenderer
                .pos(0.0D, 0.0D, 0.0D)
          ...
          if (progress >= 0) {
            ...
            worldrenderer
                .pos((double) j1, (double) k1, 0.0D)
                .func_181669_b(128, 128, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) j1, (double) (k1 + i1), 0.0D)
                .func_181669_b(128, 128, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) (j1 + l1), (double) (k1 + i1), 0.0D)
                .func_181669_b(128, 128, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) (j1 + l1), (double) k1, 0.0D)
                .func_181669_b(128, 128, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) j1, (double) k1, 0.0D)
                .func_181669_b(128, 255, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) j1, (double) (k1 + i1), 0.0D)
                .func_181669_b(128, 255, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) (j1 + progress), (double) (k1 + i1), 0.0D)
                .func_181669_b(128, 255, 128, 255)
                .endVertex();
            worldrenderer
                .pos((double) (j1 + progress), (double) k1, 0.0D)
                .func_181669_b(128, 255, 128, 255)
                .endVertex();
            tessellator.draw();
          ...
          this.mc.fontRendererObj.drawStringWithShadow(
              ...
              (float)
                  ((k - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2),
              (float) (l / 2 - 4 - 16),
              16777215);
          this.mc.fontRendererObj.drawStringWithShadow(
              this.message,
