...
public class ServerList {
  ...
  /**
   * Loads a list of servers from servers.dat, by running ServerData.getServerDataFromNBTCompound on
   * each NBT compound found in the "servers" tag list.
   */
  public void loadServerList() {
    try {
      this.servers.clear();
      NBTTagCompound nbttagcompound =
          CompressedStreamTools.read(new File(this.mc.mcDataDir, "servers.dat"));
  ...
  /**
   * Runs getNBTCompound on each ServerData instance, puts everything into a "servers" NBT list and
   * writes it to servers.dat.
   */
