...
public class JsonBlendingMode {
  ...
  public JsonBlendingMode(
      int p_i45086_1_, int p_i45086_2_, int p_i45086_3_, int p_i45086_4_, int p_i45086_5_) {
    ...
    if (!this.equals(field_148118_a)) {
      ...
      if (this.field_148113_g) {
        GlStateManager.tryBlendFuncSeparate(
            this.field_148116_b, this.field_148114_d, this.field_148117_c, this.field_148115_e);
      } else {
  ...
  private static int func_148108_a(String p_148108_0_) {
    ...
    return s.equals("add")
        ...
        : (s.equals("subtract")
            ? 32778
            : (s.equals("reversesubtract")
                ? 32779
                : (s.equals("reverse_subtract")
                    ? 32779
