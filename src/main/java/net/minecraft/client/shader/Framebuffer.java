...
public class Framebuffer {
  ...
  public void setFramebufferColor(
      float p_147604_1_, float p_147604_2_, float p_147604_3_, float p_147604_4_) {
  ...
  public void framebufferRenderExt(int p_178038_1_, int p_178038_2_, boolean p_178038_3_) {
    if (OpenGlHelper.isFramebufferEnabled()) {
      ...
      GlStateManager.ortho(
          0.0D, (double) p_178038_1_, (double) p_178038_2_, 0.0D, 1000.0D, 3000.0D);
      ...
      worldrenderer
          .pos(0.0D, (double) f1, 0.0D)
          .tex(0.0D, 0.0D)
          .setColor(255, 255, 255, 255)
          .endVertex();
      worldrenderer
          .pos((double) f, (double) f1, 0.0D)
          .tex((double) f2, 0.0D)
          .setColor(255, 255, 255, 255)
          .endVertex();
      worldrenderer
          .pos((double) f, 0.0D, 0.0D)
