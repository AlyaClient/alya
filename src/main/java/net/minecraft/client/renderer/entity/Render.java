...
public abstract class Render<T extends Entity> implements IEntityRenderer {
  ...
  private void func_180549_a(
    ...
    if (blockIn.isFullCube()) {
      ...
      WorldRenderer worldrenderer = tessellator.getWorldRenderer();
      double d0 =
          ((double) p_180549_9_ - (p_180549_4_ - ((double) pos.getY() + p_180549_13_)) / 2.0D)
              * 0.5D
      ...
      if (d0 >= 0.0D) {
        ...
        worldrenderer
            ...
            .func_181666_a(1.0F, 1.0F, 1.0F, (float) d0)
            .endVertex();
        worldrenderer
            .pos(d1, d3, d5)
  ...
  public static void renderOffsetAABB(AxisAlignedBB boundingBox, double x, double y, double z) {
    ...
    worldrenderer
        .pos(boundingBox.minX, boundingBox.maxY, boundingBox.minZ)
        .func_181663_c(0.0F, 0.0F, -1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.maxX, boundingBox.maxY, boundingBox.minZ)
        .func_181663_c(0.0F, 0.0F, -1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.maxX, boundingBox.minY, boundingBox.minZ)
        .func_181663_c(0.0F, 0.0F, -1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.minX, boundingBox.minY, boundingBox.minZ)
        .func_181663_c(0.0F, 0.0F, -1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.minX, boundingBox.minY, boundingBox.maxZ)
        .func_181663_c(0.0F, 0.0F, 1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.maxX, boundingBox.minY, boundingBox.maxZ)
        .func_181663_c(0.0F, 0.0F, 1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.maxX, boundingBox.maxY, boundingBox.maxZ)
        .func_181663_c(0.0F, 0.0F, 1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.minX, boundingBox.maxY, boundingBox.maxZ)
        .func_181663_c(0.0F, 0.0F, 1.0F)
        .endVertex();
    worldrenderer
        .pos(boundingBox.minX, boundingBox.minY, boundingBox.minZ)
  ...
  public static void setModelBipedMain(
      RenderBiped p_setModelBipedMain_0_, ModelBiped p_setModelBipedMain_1_) {
