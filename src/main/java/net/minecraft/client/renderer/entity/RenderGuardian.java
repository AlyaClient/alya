...
public class RenderGuardian extends RenderLiving<EntityGuardian> {
  private static final ResourceLocation GUARDIAN_TEXTURE =
      new ResourceLocation("textures/entity/guardian.png");
  ...
  public boolean shouldRender(
      EntityGuardian livingEntity, ICamera camera, double camX, double camY, double camZ) {
    if (super.shouldRender(livingEntity, camera, camX, camY, camZ)) {
      ...
      if (livingEntity.hasTargetedEntity()) {
        ...
        if (entitylivingbase != null) {
          Vec3 vec3 =
              this.func_177110_a(entitylivingbase, (double) entitylivingbase.height * 0.5D, 1.0F);
  ...
  private Vec3 func_177110_a(
      EntityLivingBase entityLivingBaseIn, double p_177110_2_, float p_177110_4_) {
    double d0 =
        entityLivingBaseIn.lastTickPosX
            + (entityLivingBaseIn.posX - entityLivingBaseIn.lastTickPosX) * (double) p_177110_4_;
    double d1 =
        p_177110_2_
            + entityLivingBaseIn.lastTickPosY
            + (entityLivingBaseIn.posY - entityLivingBaseIn.lastTickPosY) * (double) p_177110_4_;
    double d2 =
        entityLivingBaseIn.lastTickPosZ
  ...
  public void doRender(
      EntityGuardian entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    if (entitylivingbase != null) {
      ...
      Vec3 vec3 =
          this.func_177110_a(
              entitylivingbase, (double) entitylivingbase.height * 0.5D, partialTicks);
      ...
      GlStateManager.rotate(
          (((float) Math.PI / 2F) + -f6) * (180F / (float) Math.PI), 0.0F, 1.0F, 0.0F);
      ...
      worldrenderer.pos(d12, d0, d13).tex(0.4999D, d23).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d12, 0.0D, d13).tex(0.4999D, d22).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d14, 0.0D, d15).tex(0.0D, d22).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d14, d0, d15).tex(0.0D, d23).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d16, d0, d17).tex(0.4999D, d23).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d16, 0.0D, d17).tex(0.4999D, d22).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d18, 0.0D, d19).tex(0.0D, d22).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d18, d0, d19).tex(0.0D, d23).setColor(j, k, l, 255).endVertex();
      double d24 = 0.0D;
      ...
      worldrenderer.pos(d4, d0, d5).tex(0.5D, d24 + 0.5D).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d6, d0, d7).tex(1.0D, d24 + 0.5D).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d10, d0, d11).tex(1.0D, d24).setColor(j, k, l, 255).endVertex();
      worldrenderer.pos(d8, d0, d9).tex(0.5D, d24).setColor(j, k, l, 255).endVertex();
      tessellator.draw();
