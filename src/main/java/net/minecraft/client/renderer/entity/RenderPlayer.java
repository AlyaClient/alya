...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer> {
            ...
            if(itemstack == null) {
                ...
                if(flag) {
                    EnumAction enumaction =
                            (clientPlayer == Minecraft.getMinecraft().thePlayer && LuaCombatApi.isForcedBlocking)
                                    ? EnumAction.BLOCK
    ...
    protected void renderOffsetLivingLabel(
        ...
        if(p_177069_10_ < 100.0D) {
            ...
            if(scoreobjective != null) {
                Score score =
                        scoreboard.getValueFromObjective(entityIn.getCommandSenderName(), scoreobjective);
                this.renderLivingLabel(
                        entityIn, score.getScorePoints() + " " + scoreobjective.getDisplayName(), x, y, z, 64);
                y +=
                        (float) this.getFontRendererFromRenderManager().FONT_HEIGHT * 1.15F * p_177069_9_;
            }
        }
    ...
    protected void renderLivingAt(
            AbstractClientPlayer entityLivingBaseIn, double x, double y, double z) {
    ...
    protected void rotateCorpse(
            AbstractClientPlayer bat, float p_77043_2_, float p_77043_3_, float partialTicks) {
