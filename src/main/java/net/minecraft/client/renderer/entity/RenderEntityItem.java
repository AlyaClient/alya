...
public class RenderEntityItem extends Render<EntityItem> {
  ...
  private int func_177077_a(
    ...
    if (item == null) {
      ...
      float f = 0.25F;
      float f1 =
          MathHelper.sin(((float) itemIn.getAge() + p_177077_8_) / 10.0F + itemIn.hoverStart) * 0.1F
              + 0.1F;
      float f2 =
          p_177077_9_
      ...
      GlStateManager.translate(
          (float) p_177077_2_, (float) p_177077_4_ + f1 + 0.25F * f2, (float) p_177077_6_);
  ...
  public void doRender(
      EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    if (this.bindEntityTexture(entity)) {
      this.renderManager
          .renderEngine
          .getTexture(this.getEntityTexture(entity))
    ...
    for (int j = 0; j < i; ++j) {
      if (ibakedmodel.isGui3d()) {
        ...
        ibakedmodel
            .getItemCameraTransforms()
            .func_181689_a(ItemCameraTransforms.TransformType.GROUND);
