...
public class LayerCustomHead implements LayerRenderer<EntityLivingBase> {
  ...
  public void doRenderLayer(
    ...
    if (itemstack != null && itemstack.getItem() != null) {
      ...
      boolean flag =
          entitylivingbaseIn instanceof EntityVillager
              || entitylivingbaseIn instanceof EntityZombie
                  && ((EntityZombie) entitylivingbaseIn).isVillager();
      ...
      if (item instanceof ItemBlock) {
        ...
        TileEntitySkullRenderer.instance.renderSkull(
            -0.5F, 0.0F, -0.5F, EnumFacing.UP, 180.0F, itemstack.getMetadata(), gameprofile, -1);
      }
