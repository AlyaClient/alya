    ...
    if (p_181679_1_.getVertexCount() > 0) {
      ...
      if (p_181679_1_.isMultiTexture()) {
        ...
        SVertexBuilder.drawArrays(
            p_181679_1_.getDrawMode(), 0, p_181679_1_.getVertexCount(), p_181679_1_);
      } else {
      ...
      for (int k1 = list.size(); j1 < k1; ++j1) {
        ...
        VertexFormatElement.EnumUsage vertexformatelement$enumusage1 =
            vertexformatelement1.getUsage();

        if (flag1) {
          Reflector.callVoid(
              vertexformatelement$enumusage1,
