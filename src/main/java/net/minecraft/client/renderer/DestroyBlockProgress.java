...
public class DestroyBlockProgress {
  /**
   * entity ID of the player associated with this partially destroyed Block. Used to identify the
   * Blocks in the client Renderer, max 1 per player on a server
   */
  ...
  /**
   * inserts damage value into this partially destroyed Block. -1 causes client renderer to delete
   * it, otherwise ranges from 1 to 10
   */
