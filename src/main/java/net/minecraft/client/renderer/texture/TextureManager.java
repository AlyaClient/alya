...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
  ...
  private final Map<ResourceLocation, ITextureObject> mapTextureObjects =
      Maps.<ResourceLocation, ITextureObject>newHashMap();
  ...
  public boolean loadTickableTexture(
      ResourceLocation textureLocation, ITickableTextureObject textureObj) {
  ...
  public ResourceLocation getDynamicTextureLocation(String name, DynamicTexture texture) {
    ...
    ResourceLocation resourcelocation =
        new ResourceLocation(String.format("dynamic/%s_%d", new Object[] {name, integer}));
