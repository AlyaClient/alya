...
public class BlockFluidRenderer {
  ...
  public boolean renderFluid(
    ...
    try {
      ...
      TextureAtlasSprite[] atextureatlassprite =
          blockliquid.getMaterial() == Material.lava
      ...
      boolean flag1 =
          blockliquid.shouldSideBeRendered(blockAccess, blockPosIn.down(), EnumFacing.DOWN);
      ...
      if (flag || flag1 || aboolean[0] || aboolean[1] || aboolean[2] || aboolean[3]) {
        ...
        if (flag) {
          ...
          float f26 = f4 * f2;
          worldRendererIn
              .pos(d0 + 0.0D, d1 + (double) f7, d2 + 0.0D)
              .func_181666_a(f24, f25, f26, 1.0F)
              .tex((double) f13, (double) f17)
              .func_181671_a(l2, i3)
              .endVertex();
          worldRendererIn
              .pos(d0 + 0.0D, d1 + (double) f8, d2 + 1.0D)
              .func_181666_a(f24, f25, f26, 1.0F)
              .tex((double) f14, (double) f18)
              .func_181671_a(l2, i3)
              .endVertex();
          worldRendererIn
              .pos(d0 + 1.0D, d1 + (double) f9, d2 + 1.0D)
              .func_181666_a(f24, f25, f26, 1.0F)
              .tex((double) f15, (double) f19)
              .func_181671_a(l2, i3)
              .endVertex();
          worldRendererIn
              .pos(d0 + 1.0D, d1 + (double) f10, d2 + 0.0D)
              .func_181666_a(f24, f25, f26, 1.0F)
        ...
        for (int i1 = 0; i1 < 4; ++i1) {
          ...
          if (aboolean[i1]) {
            ...
            float f31 =
                i1 < 2
                    ? FaceBakery.getFaceBrightness(EnumFacing.NORTH)
                    : FaceBakery.getFaceBrightness(EnumFacing.WEST);
            float f32 = f4 * f31 * f;
            float f33 = f4 * f31 * f1;
            float f34 = f4 * f31 * f2;
            worldRendererIn
                .pos(d3, d1 + (double) f39, d4)
                .func_181666_a(f32, f33, f34, 1.0F)
                .tex((double) f42, (double) f28)
                .func_181671_a(k, l)
                .endVertex();
            worldRendererIn
                .pos(d5, d1 + (double) f40, d6)
                .func_181666_a(f32, f33, f34, 1.0F)
  ...
  private float getFluidHeight(
      IBlockAccess blockAccess, BlockPos blockPosIn, Material blockMaterial) {
    int i = 0;
    float f = 0.0F;
