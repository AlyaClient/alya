...
public class BlockPart {
  ...
  public BlockPart(
      Vector3f positionFromIn,
      Vector3f positionToIn,
      Map<EnumFacing, BlockPartFace> mapFacesIn,
  ...
  private float[] getFaceUvs(EnumFacing p_178236_1_) {
    ...
    switch (p_178236_1_) {
      ...
      case UP:
        afloat =
            new float[] {
              this.positionFrom.x, this.positionFrom.z, this.positionTo.x, this.positionTo.z
            };
        break;
      case NORTH:
      case SOUTH:
  ...
  static class Deserializer implements JsonDeserializer<BlockPart> {
    ...
    private Map<EnumFacing, BlockPartFace> parseFacesCheck(
        JsonDeserializationContext p_178250_1_, JsonObject p_178250_2_) {
    ...
    private Map<EnumFacing, BlockPartFace> parseFaces(
        JsonDeserializationContext p_178253_1_, JsonObject p_178253_2_) {
      ...
      for (Entry<String, JsonElement> entry : jsonobject.entrySet()) {
        ...
        map.put(
            enumfacing,
            (BlockPartFace)
                p_178253_1_.deserialize((JsonElement) entry.getValue(), BlockPartFace.class));
      }
    ...
    private Vector3f parsePositionTo(JsonObject p_178247_1_) {
      ...
      if (vector3f.x >= -16.0F
        ...
        throw new JsonParseException(
            "\'to\' specifier exceeds the allowed boundaries: " + vector3f);
      }
    }
    ...
    private Vector3f parsePositionFrom(JsonObject p_178249_1_) {
      ...
      if (vector3f.x >= -16.0F
        ...
        throw new JsonParseException(
            "\'from\' specifier exceeds the allowed boundaries: " + vector3f);
      }
    }
    ...
    private Vector3f parsePosition(JsonObject p_178251_1_, String p_178251_2_) {
      ...
      if (jsonarray.size() != 3) {
        throw new JsonParseException(
            "Expected 3 " + p_178251_2_ + " values, found: " + jsonarray.size());
      } else {
