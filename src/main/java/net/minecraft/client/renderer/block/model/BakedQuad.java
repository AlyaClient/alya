...
public class BakedQuad implements IVertexProducer {
  ...
  private static int[] makeVertexDataSingle(
      int[] p_makeVertexDataSingle_0_, TextureAtlasSprite p_makeVertexDataSingle_1_) {
  ...
  private static TextureAtlasSprite getSpriteByUv(int[] p_getSpriteByUv_0_) {
    ...
    TextureAtlasSprite textureatlassprite =
        Minecraft.getMinecraft().getTextureMapBlocks().getIconByUV((double) f6, (double) f7);
