...
public class FaceBakery {
  ...
  private void fillVertexData(
    ...
    EnumFaceDirection.VertexInformation enumfacedirection$vertexinformation =
        EnumFaceDirection.getFacing(p_fillVertexData_3_).func_179025_a(p_fillVertexData_2_);
    Vector3f vector3f =
        new Vector3f(
    ...
    faceData[j + 4] =
        Float.floatToRawIntBits(
            sprite.getInterpolatedU(
                (double) faceUV.func_178348_a(vertexIndex) * 0.999D
                    + (double) faceUV.func_178348_a((vertexIndex + 2) % 4) * 0.001D));
    faceData[j + 4 + 1] =
        Float.floatToRawIntBits(
            sprite.getInterpolatedV(
                (double) faceUV.func_178346_b(vertexIndex) * 0.999D
  ...
  private void func_178407_a(Vector3f p_178407_1_, BlockPartRotation partRotation) {
    if (partRotation != null) {
      ...
      switch (partRotation.axis) {
        case X:
          Matrix4f.rotate(
              partRotation.angle * 0.017453292F,
  ...
  private void rotateScale(
      Vector3f position, Vector3f rotationOrigin, Matrix4f rotationMatrix, Vector3f scale) {
    Vector4f vector4f =
        new Vector4f(
    ...
    vector4f.z *= scale.z;
    position.set(
        vector4f.x + rotationOrigin.x,
        vector4f.y + rotationOrigin.y,
        vector4f.z + rotationOrigin.z);
  }
  ...
  public static EnumFacing getFacingFromVertexData(int[] faceData) {
    ...
    Vector3f vector3f1 =
        new Vector3f(
            Float.intBitsToFloat(faceData[i]),
            Float.intBitsToFloat(faceData[i + 1]),
            Float.intBitsToFloat(faceData[i + 2]));
    Vector3f vector3f2 =
        new Vector3f(
            Float.intBitsToFloat(faceData[j]),
            Float.intBitsToFloat(faceData[j + 1]),
    ...
    float f =
        (float)
            Math.sqrt(
                (double)
                    (vector3f5.x * vector3f5.x
                        + vector3f5.y * vector3f5.y
                        + vector3f5.z * vector3f5.z));
    vector3f5.x /= f;
    vector3f5.y /= f;
    vector3f5.z /= f;
  ...
  private void func_178408_a(int[] p_178408_1_, EnumFacing p_178408_2_) {
    ...
    for (int j1 = 0; j1 < 4; ++j1) {
      int k1 = i * j1;
      EnumFaceDirection.VertexInformation enumfacedirection$vertexinformation =
          enumfacedirection.func_179025_a(j1);
      ...
      for (int l = 0; l < 4; ++l) {
        ...
        if (MathHelper.epsilonEquals(f8, f5)
            && MathHelper.epsilonEquals(f3, f6)
  ...
  private void func_178401_a(
      int p_178401_1_,
      int[] p_178401_2_,
      EnumFacing facing,
      BlockFaceUV p_178401_4_,
