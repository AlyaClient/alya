...
public class ItemRenderer {
    ...
    if (heldStack != null) {
      ...
      if (this.itemRenderer.shouldRenderItemIn3D(heldStack)) {
        ...
        if (this.isBlockTranslucent(block)
            && (!Config.isShaders() || !Shaders.renderItemKeepDepthMask)) {
  ...
  private void func_178109_a(AbstractClientPlayer clientPlayer) {
    int i =
        this.mc.theWorld.getCombinedLight(
            new BlockPos(
                clientPlayer.posX,
  ...
  private void func_178110_a(EntityPlayerSP entityplayerspIn, float partialTicks) {
    float f =
        entityplayerspIn.prevRenderArmPitch
            + (entityplayerspIn.renderArmPitch - entityplayerspIn.prevRenderArmPitch)
                * partialTicks;
    float f1 =
        entityplayerspIn.prevRenderArmYaw
  ...
  private void renderPlayerArms(AbstractClientPlayer clientPlayer) {
    ...
    Render<AbstractClientPlayer> render =
        this.renderManager.<AbstractClientPlayer>getEntityRenderObject(this.mc.thePlayer);
  ...
  private void renderItemMap(
      AbstractClientPlayer clientPlayer, float p_178097_2_, float p_178097_3_, float p_178097_4_) {
  ...
  private void func_178095_a(
      AbstractClientPlayer clientPlayer, float p_178095_2_, float p_178095_3_) {
   ...
   *
   * @param equipProgress The progress of the animation to equip (raise from out of frame) while
  ...
  private void func_178098_a(float p_178098_1_, AbstractClientPlayer clientPlayer) {
    ...
    float f =
        (float) this.itemToRender.getMaxItemUseDuration()
  ...
  public void renderItemInFirstPerson(float partialTicks) {
    if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
      ...
      float f2 =
          abstractclientplayer.prevRotationPitch
              + (abstractclientplayer.rotationPitch - abstractclientplayer.prevRotationPitch)
                  * partialTicks;
      float f3 =
          abstractclientplayer.prevRotationYaw
      ...
      if (this.itemToRender != null) {
        ...
        // todo: kilaura block check
            ...
            || dev.thoq.lua.api.LuaCombatApi.isForcedBlocking) {
          EnumAction enumaction =
              dev.thoq.lua.api.LuaCombatApi.isForcedBlocking
                  ? net.minecraft.item.EnumAction.BLOCK
          ...
          switch (enumaction) {
            ...
            case BLOCK:
              // todo: implement block module
              // final BlockAnimationModule blockAnimationModule =
              // Alya.getInstance().getModuleRepository().getModule(BlockAnimationModule.class);
  ...
  public void renderOverlays(float partialTicks) {
    ...
    if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
      ...
      for (int i = 0; i < 8; ++i) {
        double d0 =
            entityplayer.posX
                + (double) (((float) ((i >> 0) % 2) - 0.5F) * entityplayer.width * 0.8F);
        double d1 = entityplayer.posY + (double) (((float) ((i >> 1) % 2) - 0.5F) * 0.1F);
        double d2 =
            entityplayer.posZ
                + (double) (((float) ((i >> 2) % 2) - 0.5F) * entityplayer.width * 0.8F);
      ...
      if (iblockstate.getBlock().getRenderType() != -1) {
        Object object =
            Reflector.getFieldValue(Reflector.RenderBlockOverlayEvent_OverlayType_BLOCK);

        if (!Reflector.callBoolean(
            Reflector.ForgeEventFactory_renderBlockOverlay,
            new Object[] {
    ...
    if (!this.mc.thePlayer.isSpectator()) {
      if (this.mc.thePlayer.isInsideOfMaterial(Material.water)
          && !Reflector.callBoolean(
              Reflector.ForgeEventFactory_renderWaterOverlay,
      ...
      if (this.mc.thePlayer.isBurning()
          && !Reflector.callBoolean(
              Reflector.ForgeEventFactory_renderFireOverlay,
              new Object[] {this.mc.thePlayer, Float.valueOf(partialTicks)})) {
  ...
  private void renderFireInFirstPerson(float p_78442_1_) {
    ...
    for (int i = 0; i < 2; ++i) {
      ...
      TextureAtlasSprite textureatlassprite =
          this.mc.getTextureMapBlocks().getAtlasSprite("minecraft:blocks/fire_layer_1");
      this.mc.getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
      ...
      worldrenderer
          .pos((double) f5, (double) f7, (double) f9)
          .tex((double) f2, (double) f4)
          .endVertex();
      worldrenderer
          .pos((double) f6, (double) f7, (double) f9)
          .tex((double) f1, (double) f4)
          .endVertex();
      worldrenderer
          .pos((double) f6, (double) f8, (double) f9)
          .tex((double) f1, (double) f3)
          .endVertex();
      worldrenderer
          .pos((double) f5, (double) f8, (double) f9)
