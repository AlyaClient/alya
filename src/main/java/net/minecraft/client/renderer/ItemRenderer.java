...
public class ItemRenderer {
    ...
    private void renderPlayerArms(AbstractClientPlayer clientPlayer) {
        ...
        Render<AbstractClientPlayer> render =
                this.renderManager.getEntityRenderObject(this.mc.thePlayer);
            ...
            if(this.itemToRender != null) {
                if(this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    switch(enumaction) {
                        ...
                        case BLOCK:
                            if(LuaCombatApi.isForcedBlocking) {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if(this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            for(int i = 0; i < 8; ++i) {
                double d0 =
                        entityplayer.posX
                                + (double) (((float) ((i) % 2) - 0.5F) * entityplayer.width * 0.8F);
            ...
            if(iblockstate.getBlock().getRenderType() != -1) {
                ...
                if(!Reflector.callBoolean(
                        ...
                        this.mc.thePlayer, partialTicks, object, iblockstate, blockpos)) {
    ...
    private void renderWaterOverlayTexture(float p_78448_1_) {
        if(!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
            ...
            worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
            for(WorldRenderer worldRenderer : Arrays.asList(worldrenderer
                    .pos(-1.0D, -1.0D, -0.5D)
                    .tex(4.0F + f7, 4.0F + f8), worldrenderer
                    .pos(1.0D, -1.0D, -0.5D)
                    .tex(0.0F + f7, 4.0F + f8), worldrenderer
                    .pos(1.0D, 1.0D, -0.5D)
                    .tex(0.0F + f7, 0.0F + f8), worldrenderer
                    .pos(-1.0D, 1.0D, -0.5D)
                    .tex(4.0F + f7, 0.0F + f8))) {
                worldRenderer
                        .endVertex();
