...
public class RenderHelper {
  ...
  private static final Vec3 LIGHT0_POS =
      (new Vec3(0.20000000298023224D, 1.0D, -0.699999988079071D)).normalize();
  ...
  public static void enableStandardItemLighting() {
    ...
    GL11.glLight(
        GL11.GL_LIGHT0, GL11.GL_AMBIENT, (FloatBuffer) setColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
    ...
    GL11.glLight(
        GL11.GL_LIGHT1, GL11.GL_AMBIENT, (FloatBuffer) setColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
  ...
  private static FloatBuffer setColorBuffer(
