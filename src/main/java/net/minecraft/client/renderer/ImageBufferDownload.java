...
public class ImageBufferDownload implements IImageBuffer {
  ...
  /**
   * Makes the given area of the image transparent if it was previously completely opaque (used to
   * remove the outer layer of a skin around the head if it was saved all opaque; this would be
   * redundant so it's assumed that the skin maker is just using an image editor without an alpha
   * channel)
   */
