...
public class RenderItemFrame extends Render<EntityItemFrame> {
  ...
  public void doRender(
      EntityItemFrame entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    if (entity.getDisplayedItem() != null
        && entity.getDisplayedItem().getItem() == Items.filled_map) {
  ...
  private void renderItem(EntityItemFrame itemFrame) {
    ...
    if (itemstack != null) {
      ...
      if (!Reflector.postForgeBusEvent(
          Reflector.RenderItemInFrameEvent_Constructor, new Object[] {itemFrame, this})) {
        if (item instanceof ItemMap) {
          ...
          MapData mapdata =
              Items.filled_map.getMapData(entityitem.getEntityItem(), itemFrame.worldObj);
          ...
          this.itemRenderer.func_181564_a(
              entityitem.getEntityItem(), ItemCameraTransforms.TransformType.FIXED);
