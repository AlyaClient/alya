...
public class TileEntityBeaconRenderer extends TileEntitySpecialRenderer<TileEntityBeacon> {
  ...
  public void renderTileEntityAt(
      TileEntityBeacon te, double x, double y, double z, float partialTicks, int destroyStage) {
      ...
      if (f > 0.0F) {
        ...
        for (int j = 0; j < list.size(); ++j) {
          TileEntityBeacon.BeamSegment tileentitybeacon$beamsegment =
              (TileEntityBeacon.BeamSegment) list.get(j);
          ...
          double d1 =
              MathHelper.func_181162_h(-d0 * 0.2D - (double) MathHelper.floor_double(-d0 * 0.1D));
          ...
          worldrenderer
              .pos(x + d4, y + (double) k, z + d5)
              .tex(1.0D, d15)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
              .pos(x + d4, y + (double) i, z + d5)
              .tex(1.0D, d14)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
              .pos(x + d6, y + (double) i, z + d7)
              .tex(0.0D, d14)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
              .pos(x + d6, y + (double) k, z + d7)
              .tex(0.0D, d15)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
              .pos(x + d10, y + (double) k, z + d11)
              .tex(1.0D, d15)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
              ...
              .endVertex();
          worldrenderer
              .pos(x + d8, y + (double) i, z + d9)
              .tex(0.0D, d14)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
              .pos(x + d8, y + (double) k, z + d9)
              .tex(0.0D, d15)
              .func_181666_a(f1, f2, f3, 1.0F)
              .endVertex();
          worldrenderer
          ...
          worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
          worldrenderer
              .pos(x + 0.2D, y + (double) k, z + 0.2D)
              .tex(1.0D, d13)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.2D, y + (double) i, z + 0.2D)
              .tex(1.0D, d12)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.8D, y + (double) i, z + 0.2D)
              .tex(0.0D, d12)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.8D, y + (double) k, z + 0.2D)
              .tex(0.0D, d13)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.8D, y + (double) k, z + 0.8D)
              .tex(1.0D, d13)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.8D, y + (double) i, z + 0.8D)
              .tex(1.0D, d12)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.2D, y + (double) i, z + 0.8D)
              .tex(0.0D, d12)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
              .pos(x + 0.2D, y + (double) k, z + 0.8D)
              .tex(0.0D, d13)
              .func_181666_a(f1, f2, f3, 0.125F)
              .endVertex();
          worldrenderer
