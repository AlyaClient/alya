...
public class NetHandlerLoginClient implements INetHandlerLoginClient {
  ...
  public void handleEncryptionRequest(S01PacketEncryptionRequest packetIn) {
    ...
    String s1 =
        (new BigInteger(CryptManager.getServerIdHash(s, publickey, secretkey))).toString(16);
      ...
      try {
        ...
        this.networkManager.closeChannel(
            new ChatComponentTranslation(
                ...
                new Object[] {
                  new ChatComponentTranslation(
                      "disconnect.loginFailedInfo.serversUnavailable", new Object[0])
                }));
        return;
        ...
        this.networkManager.closeChannel(
            new ChatComponentTranslation(
                ...
                new Object[] {
                  new ChatComponentTranslation(
                      "disconnect.loginFailedInfo.invalidSession", new Object[0])
                }));
        return;
      } catch (AuthenticationException authenticationexception) {
        this.networkManager.closeChannel(
            new ChatComponentTranslation(
                "disconnect.loginFailedInfo", new Object[] {authenticationexception.getMessage()}));
        return;
      }
    }
  ...
  public void handleLoginSuccess(S02PacketLoginSuccess packetIn) {
    ...
    this.networkManager.setNetHandler(
        new NetHandlerPlayClient(
            this.mc, this.previousGuiScreen, this.networkManager, this.gameProfile));
  }
