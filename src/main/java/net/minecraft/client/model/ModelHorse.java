...
public class ModelHorse extends ModelBase {
  ...
  private void setBoxRotation(
      ModelRenderer p_110682_1_, float p_110682_2_, float p_110682_3_, float p_110682_4_) {
  ...
  public void setLivingAnimations(
    ...
    float f1 =
        this.updateHorseRotation(
            ...
            partialTickTime);
    float f2 =
        entitylivingbaseIn.prevRotationPitch
    ...
    this.head.rotateAngleX =
        f6 * (0.2617994F + f4) + f5 * 2.18166F + (1.0F - Math.max(f6, f5)) * this.head.rotateAngleX;
    this.head.rotateAngleY =
        f6 * f3 / (180F / (float) Math.PI) + (1.0F - Math.max(f6, f5)) * this.head.rotateAngleY;
    ...
    this.backLeftShin.rotationPointZ =
        this.backLeftLeg.rotationPointZ
            + MathHelper.cos(((float) Math.PI * 3F / 2F) + f15 + f7 * -f10 * 0.5F * p_78086_3_)
                * 7.0F;
    ...
    this.frontLeftShin.rotationPointY =
        this.frontLeftLeg.rotationPointY + MathHelper.sin(((float) Math.PI / 2F) + f17) * 7.0F;
    this.frontLeftShin.rotationPointZ =
        this.frontLeftLeg.rotationPointZ + MathHelper.cos(((float) Math.PI * 3F / 2F) + f17) * 7.0F;
    this.frontRightShin.rotationPointY =
        this.frontRightLeg.rotationPointY + MathHelper.sin(((float) Math.PI / 2F) + f18) * 7.0F;
    ...
    this.backLeftShin.rotateAngleX =
        -0.08726646F * f6
    ...
    this.backRightShin.rotateAngleX =
        -0.08726646F * f6
            + (f10 * 0.5F * p_78086_3_ - Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
    ...
    this.frontLeftShin.rotateAngleX =
        (this.frontLeftLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F + f16 * 0.2F)) * f6
    ...
    this.frontRightShin.rotateAngleX =
        (this.frontRightLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F - f16 * 0.2F)) * f6
            + (-f11 + Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
