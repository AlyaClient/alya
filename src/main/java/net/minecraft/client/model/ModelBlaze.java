...
public class ModelBlaze extends ModelBase {
  ...
  public void setRotationAngles(
    ...
    for (int i = 0; i < 4; ++i) {
      this.blazeSticks[i].rotationPointY =
          -2.0F + MathHelper.cos(((float) (i * 2) + p_78087_3_) * 0.25F);
    ...
    for (int j = 4; j < 8; ++j) {
      this.blazeSticks[j].rotationPointY =
          2.0F + MathHelper.cos(((float) (j * 2) + p_78087_3_) * 0.25F);
    ...
    for (int k = 8; k < 12; ++k) {
      this.blazeSticks[k].rotationPointY =
          11.0F + MathHelper.cos(((float) k * 1.5F + p_78087_3_) * 0.5F);
