...
public class ModelBiped extends ModelBase {
  ...
  /**
   * Records whether the model should be rendered holding an item in the right hand, and if that
   * item is a block.
   */
  ...
  public void setRotationAngles(
    ...
    this.bipedRightArm.rotateAngleX =
        MathHelper.cos(p_78087_1_ * 0.6662F + (float) Math.PI) * 2.0F * p_78087_2_ * 0.5F;
    this.bipedLeftArm.rotateAngleX =
        MathHelper.cos(p_78087_1_ * 0.6662F) * 2.0F * p_78087_2_ * 0.5F;
    ...
    this.bipedLeftLeg.rotateAngleX =
        MathHelper.cos(p_78087_1_ * 0.6662F + (float) Math.PI) * 1.4F * p_78087_2_;
    ...
    if (this.swingProgress > -9990.0F) {
      ...
      this.bipedBody.rotateAngleY =
          MathHelper.sin(MathHelper.sqrt_float(f) * (float) Math.PI * 2.0F) * 0.2F;
      ...
      float f2 =
          MathHelper.sin(this.swingProgress * (float) Math.PI)
              ...
              * 0.75F;
      this.bipedRightArm.rotateAngleX =
          (float) ((double) this.bipedRightArm.rotateAngleX - ((double) f1 * 1.2D + (double) f2));
