  ...
  public void setLivingAnimations(
    ...
    if (i > 0) {
      this.ironGolemRightArm.rotateAngleX =
          -2.0F + 1.5F * this.func_78172_a((float) i - partialTickTime, 10.0F);
