  ...
  public SoundList deserialize(
    ...
    SoundCategory soundcategory =
        SoundCategory.getCategory(
            JsonUtils.getString(jsonobject, "category", SoundCategory.MASTER.getCategoryName()));
      ...
      for (int i = 0; i < jsonarray.size(); ++i) {
        ...
        if (JsonUtils.isString(jsonelement)) {
          ...
          if (jsonobject1.has("type")) {
            SoundList.SoundEntry.Type soundlist$soundentry$type =
                SoundList.SoundEntry.Type.getType(JsonUtils.getString(jsonobject1, "type"));
