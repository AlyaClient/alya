...
public class IntegratedServer extends MinecraftServer {
  ...
  public IntegratedServer(
      Minecraft mcIn, String folderName, String worldName, WorldSettings settings) {
    super(
        new File(mcIn.mcDataDir, "saves"),
        mcIn.getProxy(),
        new File(mcIn.mcDataDir, USER_CACHE_FILE.getName()));
  ...
  protected void loadAllWorlds(
    ...
    if (flag) {
      WorldServer worldserver =
          (WorldServer)
              (new WorldServer(this, isavehandler, worldinfo, 0, this.theProfiler)).init();
      ...
      for (int j = 0; j < i; ++j) {
        ...
        WorldServer worldserver1 =
            k == 0
                ...
                : (WorldServer)
                    ((WorldServer)
                        (new WorldServerMulti(this, isavehandler, k, worldserver, this.theProfiler))
                            .init());
        ...
        if (Reflector.EventBus.exists()) {
          Reflector.postForgeBusEvent(
              Reflector.WorldEvent_Load_Constructor, new Object[] {worldserver1});
        }
      }
      ...
      for (int l = 0; l < this.worldServers.length; ++l) {
        ...
        if (l == 0) {
          this.worldServers[l] =
              (WorldServer)
                  (new WorldServer(this, isavehandler, worldinfo, i1, this.theProfiler)).init();
          this.worldServers[l].initialize(this.theWorldSettings);
        } else {
          this.worldServers[l] =
              (WorldServer)
                  (new WorldServerMulti(
                          this, isavehandler, i1, this.worldServers[0], this.theProfiler))
                      .init();
        }
  ...
  protected boolean startServer() throws IOException {
    ...
    if (Reflector.FMLCommonHandler_handleServerAboutToStart.exists()) {
      ...
      if (!Reflector.callBoolean(
          object, Reflector.FMLCommonHandler_handleServerAboutToStart, new Object[] {this})) {
        return false;
      }
    }
    ...
    this.setMOTD(
        this.getServerOwner() + " - " + this.worldServers[0].getWorldInfo().getWorldName());
    ...
    if (Reflector.FMLCommonHandler_handleServerStarting.exists()) {
      ...
      if (Reflector.FMLCommonHandler_handleServerStarting.getReturnType() == Boolean.TYPE) {
        return Reflector.callBoolean(
            object1, Reflector.FMLCommonHandler_handleServerStarting, new Object[] {this});
      }
  ...
  public void tick() {
    ...
    this.isGamePaused =
        Minecraft.getMinecraft().getNetHandler() != null && Minecraft.getMinecraft().isGamePaused();
    ...
    if (this.isGamePaused) {
      ...
      if (this.mc.gameSettings.renderDistanceChunks
          != this.getConfigurationManager().getViewDistance()) {
        logger.info(
      ...
      if (this.mc.theWorld != null) {
        ...
        if (!worldinfo1.isDifficultyLocked()
                ...
                if (!s.equals("vanilla")) {
                  ...
                  return !s.equals("vanilla")
                      ...
                      : (Minecraft.class.getSigners() == null
                          ...
                          : "Probably not. Jar signature remains and both client + server brands"
                                + " are untouched.");
                }
              }
            });
              ...
              new Runnable() {
                public void run() {
                  for (EntityPlayerMP entityplayermp :
                      Lists.newArrayList(
                          IntegratedServer.this.getConfigurationManager().func_181057_v())) {
  ...
  public DifficultyInstance getDifficultyAsync(
      World p_getDifficultyAsync_1_, BlockPos p_getDifficultyAsync_2_) {
