...
public class AnvilSaveConverter extends SaveFormatOld {
  ...
  public List<SaveFormatComparator> getSaveList() throws AnvilConverterException {
    if (this.savesDirectory != null
        && this.savesDirectory.exists()
        && this.savesDirectory.isDirectory()) {
  ...
  public boolean convertMapFormat(String filename, IProgressUpdate progressCallback) {
    ...
    if (worldinfo.getTerrainType() == WorldType.FLAT) {
      ...
      worldchunkmanager =
          new WorldChunkManager(
              worldinfo.getSeed(), worldinfo.getTerrainType(), worldinfo.getGeneratorOptions());
    }
    ...
    this.convertFile(
        ...
        list2,
        new WorldChunkManagerHell(BiomeGenBase.sky, 0.0F),
  ...
  private void convertChunks(
    ...
    try {
      ...
      for (int i = 0; i < 32; ++i) {
        ...
        int k =
            (int) Math.round(100.0D * (double) (p_75811_4_ * 1024) / (double) (p_75811_5_ * 1024));
        int l =
            (int)
                Math.round(
                    100.0D
                        * (double) ((i + 1) * 32 + p_75811_4_ * 1024)
                        / (double) (p_75811_5_ * 1024));
