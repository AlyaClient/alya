        ...
        new Callable<String>() {
          public String call() throws Exception {
            return CrashReportCategory.getCoordinateInfo(
                (double) WorldInfo.this.spawnX,
                (double) WorldInfo.this.spawnY,
                (double) WorldInfo.this.spawnZ);
          }
        });
    category.addCrashSectionCallable(
        "Level time",
    ...
    category.addCrashSectionCallable(
        ...
        new Callable<String>() {
          public String call() throws Exception {
            ...
            return String.format(
                "0x%05X - %s", new Object[] {Integer.valueOf(WorldInfo.this.saveVersion), s});
          }
        });
    category.addCrashSectionCallable(
        "Level weather",
          ...
          public String call() throws Exception {
            return String.format(
                ...
                new Object[] {
                  ...
                  Integer.valueOf(WorldInfo.this.theGameType.getID()),
