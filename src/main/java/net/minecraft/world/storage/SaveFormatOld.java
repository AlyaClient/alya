...
public class SaveFormatOld implements ISaveFormat {
      ...
      if (file2.exists()) {
        try {
          NBTTagCompound nbttagcompound2 =
              CompressedStreamTools.readCompressed(new FileInputStream(file2));
  ...
  /**
   * Renames the world by storing the new name in level.dat. It does *not* rename the directory
  ...
  /**
   * @args: Takes one argument - the name of the directory of the world to delete. @desc: Delete the
   *     world by deleting the associated directory recursively.
   */
  ...
  /**
   * @args: Takes one argument - the list of files and directories to delete. @desc: Deletes the
   *     files and directory listed in the list recursively.
   */
