...
public class WorldGenLakes extends WorldGenerator {
  ...
  public boolean generate(World worldIn, Random rand, BlockPos position) {
    for (position = position.add(-8, 0, -8);
        position.getY() > 5 && worldIn.isAirBlock(position);
      ...
      for (int k1 = 0; k1 < 16; ++k1) {
        for (int l2 = 0; l2 < 16; ++l2) {
          for (int k = 0; k < 8; ++k) {
            ...
            if (flag) {
              Material material =
                  worldIn.getBlockState(position.add(k1, k, l2)).getBlock().getMaterial();
          ...
          for (int k3 = 0; k3 < 16; ++k3) {
            for (int k4 = 0; k4 < 8; ++k4) {
              ...
              if (flag1
                  ...
                  && worldIn
                      .getBlockState(position.add(j2, k4, k3))
                      .getBlock()
                      .getMaterial()
                      .isSolid()) {
