...
public class WorldGenBigTree extends WorldGenAbstractTree {
        ...
        for (int l = 0; l < i; ++l) {
          ...
          if (this.checkBlockLine(blockpos, blockpos1) == -1) {
            ...
            if (this.checkBlockLine(blockpos2, blockpos) == -1) {
              this.field_175948_j.add(
                  new WorldGenBigTree.FoliageCoordinates(blockpos, blockpos2.getY()));
            }
          }
        }
      }
  ...
  void func_175937_a(BlockPos p_175937_1_, BlockPos p_175937_2_, Block p_175937_3_) {
    BlockPos blockpos =
        p_175937_2_.add(-p_175937_1_.getX(), -p_175937_1_.getY(), -p_175937_1_.getZ());
  ...
  void generateLeaves() {
    for (WorldGenBigTree.FoliageCoordinates worldgenbigtree$foliagecoordinates :
        this.field_175948_j) {
