...
public class WorldGenMegaJungle extends WorldGenHugeTrees {
  public WorldGenMegaJungle(
      boolean p_i46448_1_,
      int p_i46448_2_,
      int p_i46448_3_,
      IBlockState p_i46448_4_,
  ...
  public boolean generate(World worldIn, Random rand, BlockPos position) {
    ...
    if (!this.func_175929_a(worldIn, rand, position, i)) {
      ...
      for (int j = position.getY() + i - 2 - rand.nextInt(4);
          j > position.getY() + i / 2;
          j -= 2 + rand.nextInt(4)) {
        ...
        for (int i1 = 0; i1 < 5; ++i1) {
          ...
          this.setBlockAndNotifyAdequately(
              worldIn, new BlockPos(k, j - 3 + i1 / 2, l), this.woodMetadata);
        }
  ...
  private void func_181632_a(
      World p_181632_1_, Random p_181632_2_, BlockPos p_181632_3_, PropertyBool p_181632_4_) {
