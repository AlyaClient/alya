    ...
    for (int i = 0; i < areaHeight; ++i) {
      for (int j = 0; j < areaWidth; ++j) {
        ...
        if (k == BiomeGenBase.mushroomIsland.biomeID) {
          ...
          if (this.func_151631_c(i2)
              && this.func_151631_c(l2)
              && this.func_151631_c(k3)
              && this.func_151631_c(j4)) {
            if (!isBiomeOceanic(i2)
                && !isBiomeOceanic(l2)
                && !isBiomeOceanic(k3)
                && !isBiomeOceanic(j4)) {
              aint1[j + i * areaWidth] = k;
            ...
            && k != BiomeGenBase.extremeHillsPlus.biomeID
          ...
          if (biomegenbase != null && biomegenbase.isSnowyBiome()) {
            ...
            if (!isBiomeOceanic(l)
                ...
                && !isBiomeOceanic(j1)
                && !isBiomeOceanic(k1)) {
              if (this.func_151633_d(l)
                  && this.func_151633_d(i1)
                  && this.func_151633_d(j1)
