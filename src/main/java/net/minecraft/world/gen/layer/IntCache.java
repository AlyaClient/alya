...
public class IntCache {
  ...
  /**
   * Mark all pre-allocated arrays as available for re-use by moving them to the appropriate free
   * lists.
   */
  ...
  /**
   * Gets a human-readable string that indicates the sizes of all the cache fields. Basically a
   * synchronized static toString.
   */
