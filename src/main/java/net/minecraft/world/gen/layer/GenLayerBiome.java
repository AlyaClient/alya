...
public class GenLayerBiome extends GenLayer {
  ...
  public GenLayerBiome(
      long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, String p_i45560_5_) {
    super(p_i45560_1_);
    ...
    if (p_i45560_4_ == WorldType.DEFAULT_1_1) {
      ...
      this.field_175973_g =
          ChunkProviderSettings.Factory.jsonToFactory(p_i45560_5_).func_177864_b();
    } else {
      this.field_175973_g = null;
    }
  }
      ...
      for (int j = 0; j < areaWidth; ++j) {
        ...
        if (this.field_175973_g != null && this.field_175973_g.fixedBiome >= 0) {
          ...
          if (l > 0) {
            ...
            aint1[j + i * areaWidth] =
                this.field_151623_c[this.nextInt(this.field_151623_c.length)].biomeID;
          }
        } else if (k == 2) {
          if (l > 0) {
            ...
            aint1[j + i * areaWidth] =
                this.field_151621_d[this.nextInt(this.field_151621_d.length)].biomeID;
          }
        } else if (k == 3) {
          if (l > 0) {
            ...
            aint1[j + i * areaWidth] =
                this.field_151622_e[this.nextInt(this.field_151622_e.length)].biomeID;
          }
        } else if (k == 4) {
          aint1[j + i * areaWidth] =
              this.field_151620_f[this.nextInt(this.field_151620_f.length)].biomeID;
        } else {
