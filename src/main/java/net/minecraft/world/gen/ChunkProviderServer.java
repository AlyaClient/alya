...
public class ChunkProviderServer implements IChunkProvider {
  ...
  public ChunkProviderServer(
      WorldServer p_i1520_1_, IChunkLoader p_i1520_2_, IChunkProvider p_i1520_3_) {
        ...
        if (this.serverChunkGenerator == null) {
          ...
          try {
            ...
            CrashReport crashreport =
                CrashReport.makeCrashReport(throwable, "Exception generating new chunk");
            CrashReportCategory crashreportcategory =
                crashreport.makeCategory("Chunk to be generated");
            ...
            crashreportcategory.addCrashSection(
                "Generator", this.serverChunkGenerator.makeString());
  ...
  public Chunk provideChunk(int x, int z) {
    ...
    return chunk == null
        ? (!this.worldObj.isFindingSpawnPoint() && !this.chunkLoadOverride
            ? this.dummyChunk
            : this.loadChunk(x, z))
        : chunk;
  }
  ...
  private void saveChunkData(Chunk p_73242_1_) {
    if (this.chunkLoader != null) {
      try {
        ...
        logger.error(
            (String) "Couldn\'t save chunk; already in use by another instance of Minecraft?",
  ...
  public boolean func_177460_a(
    ...
    if (this.serverChunkGenerator != null
        && this.serverChunkGenerator.func_177460_a(
  ...
  public String makeString() {
    return "ServerChunkCache: "
        + this.id2ChunkMap.getNumHashElements()
        + " Drop: "
        + this.droppedChunksSet.size();
  }
