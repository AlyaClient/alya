  ...
  protected void func_180702_a(
    ...
    for (boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
      double d2 =
          1.5D
              + (double)
                  (MathHelper.sin((float) p_180702_15_ * (float) Math.PI / (float) p_180702_16_)
                      * p_180702_12_
                      * 1.0F);
      ...
      if (flag2 || random.nextInt(4) != 0) {
        ...
        if (p_180702_6_ >= d0 - 16.0D - d2 * 2.0D
                        ...
                        if (j2 - 1 < 10) {
                          ...
                          if (iblockstate2.getBlock() == Blocks.sand) {
                            p_180702_5_.setBlockState(
                                ...
                                j2 + 1,
                                i2,
                                iblockstate2.getValue(BlockSand.VARIANT)
                          ...
                          if (flag1
                              && p_180702_5_.getBlockState(j3, j2 - 1, i2).getBlock()
                                  == Blocks.dirt) {
                            blockpos$mutableblockpos.func_181079_c(
                                j3 + p_180702_3_ * 16, 0, i2 + p_180702_4_ * 16);
                            p_180702_5_.setBlockState(
                                j3,
                                j2 - 1,
                                i2,
                                this.worldObj
                                    .getBiomeGenForCoords(blockpos$mutableblockpos)
                                    .topBlock
                                    .getBlock()
                                    .getDefaultState());
                          }
                                ...
                                : (p_175793_1_.getBlock() == Blocks.mycelium
                                    ...
                                    : (p_175793_1_.getBlock() == Blocks.snow_layer
                                        ...
                                        : (p_175793_1_.getBlock() == Blocks.sand
                                            ...
                                            && p_175793_2_.getBlock().getMaterial()
                                                != Material.water))))))));
  }
  ...
  protected void recursiveGenerate(
    ...
    for (int j = 0; j < i; ++j) {
      ...
      if (this.rand.nextInt(4) == 0) {
        this.func_180703_a(
            this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2);
