...
public class NoiseGeneratorImproved extends NoiseGenerator {
  ...
  private static final double[] field_152381_e =
      new double[] {
        1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 0.0D,
        -1.0D, 0.0D
      };
  private static final double[] field_152382_f =
      new double[] {
        1.0D, 1.0D, -1.0D, -1.0D, 0.0D, 0.0D, 0.0D, 0.0D, 1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D,
        1.0D, -1.0D
      };
  private static final double[] field_152383_g =
      new double[] {
        0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 1.0D, -1.0D, -1.0D, 1.0D, 1.0D, -1.0D, -1.0D, 0.0D, 1.0D,
        0.0D, -1.0D
      };
  ...
  public final double grad(
      int p_76310_1_, double p_76310_2_, double p_76310_4_, double p_76310_6_) {
    int i = p_76310_1_ & 15;
    return field_152381_e[i] * p_76310_2_
        + field_152382_f[i] * p_76310_4_
        + field_152383_g[i] * p_76310_6_;
  }

  /**
   * pars: noiseArray , xOffset , yOffset , zOffset , xSize , ySize , zSize , xScale, yScale ,
   * zScale , noiseScale. noiseArray should be xSize*ySize*zSize in size
   */
      ...
      for (int j2 = 0; j2 < p_76308_8_; ++j2) {
        ...
        for (int j6 = 0; j6 < p_76308_10_; ++j6) {
          ...
          d14 =
              this.lerp(
                  d18,
                  this.func_76309_a(this.permutations[j5], d17, d19),
