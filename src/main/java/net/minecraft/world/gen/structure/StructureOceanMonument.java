...
public class StructureOceanMonument extends MapGenStructure {
  ...
  private static final List<BiomeGenBase.SpawnListEntry> field_175803_h =
      Lists.<BiomeGenBase.SpawnListEntry>newArrayList();
  ...
  public StructureOceanMonument(Map<String, String> p_i45608_1_) {
    ...
    for (Entry<String, String> entry : p_i45608_1_.entrySet()) {
      if (((String) entry.getKey()).equals("spacing")) {
        this.field_175800_f =
            MathHelper.parseIntWithDefaultAndMax((String) entry.getValue(), this.field_175800_f, 1);
      } else if (((String) entry.getKey()).equals("separation")) {
        this.field_175801_g =
            MathHelper.parseIntWithDefaultAndMax((String) entry.getValue(), this.field_175801_g, 1);
      }
    }
  }
  ...
  protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
    ...
    k =
        k
            + (random.nextInt(this.field_175800_f - this.field_175801_g)
                    + random.nextInt(this.field_175800_f - this.field_175801_g))
                / 2;
    l =
        l
    ...
    if (i == k && j == l) {
      if (this.worldObj
              ...
              .getBiomeGenerator(new BlockPos(i * 16 + 8, 64, j * 16 + 8), (BiomeGenBase) null)
          != BiomeGenBase.deepOcean) {
        return false;
      }
      ...
      boolean flag =
          this.worldObj
              .getWorldChunkManager()
              .areBiomesViable(i * 16 + 8, j * 16 + 8, 29, field_175802_d);
  ...
  public static class StartMonument extends StructureStart {
    ...
    private void func_175789_b(
        World worldIn, Random p_175789_2_, int p_175789_3_, int p_175789_4_) {
      ...
      this.components.add(
          new StructureOceanMonumentPieces.MonumentBuilding(p_175789_2_, i1, j1, enumfacing));
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i) {
          ...
          this.field_175791_c.add(
              new ChunkCoordIntPair(
                  nbttagcompound.getInteger("X"), nbttagcompound.getInteger("Z")));
        }
      }
    }
  }
