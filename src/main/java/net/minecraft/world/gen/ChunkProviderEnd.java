...
public class ChunkProviderEnd implements IChunkProvider {
  ...
  public void func_180520_a(int p_180520_1_, int p_180520_2_, ChunkPrimer p_180520_3_) {
    ...
    int l = i + 1;
    this.densities =
        this.initializeNoiseField(this.densities, p_180520_1_ * i, 0, p_180520_2_ * i, j, k, l);
  ...
  private double[] initializeNoiseField(
    ...
    double d1 = 684.412D;
    this.noiseData4 =
        this.noiseGen4.generateNoiseOctaves(
            this.noiseData4, p_73187_2_, p_73187_4_, p_73187_5_, p_73187_7_, 1.121D, 1.121D, 0.5D);
    this.noiseData5 =
        this.noiseGen5.generateNoiseOctaves(
            this.noiseData5, p_73187_2_, p_73187_4_, p_73187_5_, p_73187_7_, 200.0D, 200.0D, 0.5D);
    d0 = d0 * 2.0D;
    this.noiseData1 =
  ...
  public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
    ...
    this.endWorld
        .getBiomeGenForCoords(blockpos.add(16, 0, 16))
        .decorate(this.endWorld, this.endWorld.rand, blockpos);
