  ...
  protected void func_180707_a(
    ...
    for (; p_180707_15_ < p_180707_16_; ++p_180707_15_) {
      double d9 =
          1.5D
              + (double)
                  (MathHelper.sin((float) p_180707_15_ * (float) Math.PI / (float) p_180707_16_)
                      * p_180707_12_
                      * 1.0F);
              ...
              for (int i2 = i3; i2 < i1; ++i2) {
                ...
                if (d10 * d10 + d7 * d7 < 1.0D) {
                  for (int j2 = l; j2 > l2; --j2) {
                    ...
                    if ((d10 * d10 + d7 * d7) * (double) this.field_75046_d[j2 - 1] + d8 * d8 / 6.0D
                        < 1.0D) {
                      ...
                      if (iblockstate1.getBlock() == Blocks.stone
                        ...
                        if (j2 - 1 < 10) {
                          p_180707_5_.setBlockState(
                              j3, j2, i2, Blocks.flowing_lava.getDefaultState());
                        } else {
                          p_180707_5_.setBlockState(j3, j2, i2, Blocks.air.getDefaultState());

                          if (flag
                              && p_180707_5_.getBlockState(j3, j2 - 1, i2).getBlock()
                                  == Blocks.dirt) {
                            blockpos$mutableblockpos.func_181079_c(
                                j3 + p_180707_3_ * 16, 0, i2 + p_180707_4_ * 16);
                            p_180707_5_.setBlockState(
                                j3,
                                j2 - 1,
                                i2,
                                this.worldObj.getBiomeGenForCoords(blockpos$mutableblockpos)
                                    .topBlock);
                          }
                        }
                      }
