...
public class WorldType {
  ...
  public static final WorldType DEFAULT_1_1 =
      (new WorldType(8, "default_1_1", 0)).setCanBeCreated(false);
  ...
  /**
   * Whether this world type can be generated. Normally true; set to false for out-of-date generator
   * versions.
   */
  ...
  /**
   * returns true if selecting this worldtype from the customize menu should display the
   * generator.[worldtype].info message
   */
