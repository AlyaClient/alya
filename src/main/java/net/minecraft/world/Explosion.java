  ...
  public void doExplosionA() {
          ...
          if (j == 0 || j == 15 || k == 0 || k == 15 || l == 0 || l == 15) {
            ...
            for (float f1 = 0.3F; f > 0.0F; f -= 0.22500001F) {
              ...
              if (iblockstate.getBlock().getMaterial() != Material.air) {
                float f2 =
                    this.exploder != null
                        ? this.exploder.getExplosionResistance(
                            this, this.worldObj, blockpos, iblockstate)
              ...
              if (f > 0.0F
                  && (this.exploder == null
                      || this.exploder.verifyExplosion(
                          this, this.worldObj, blockpos, iblockstate, f))) {
                set.add(blockpos);
              }
    ...
    for (int k2 = 0; k2 < list.size(); ++k2) {
      ...
      if (!entity.isImmuneToExplosions()) {
        double d12 =
            entity.getDistance(this.explosionX, this.explosionY, this.explosionZ) / (double) f3;
        ...
        if (d12 <= 1.0D) {
          ...
          if (d13 != 0.0D) {
            ...
            d9 = d9 / d13;
            double d14 =
                (double) this.worldObj.getBlockDensity(vec3, entity.getEntityBoundingBox());
            ...
            if (entity instanceof EntityPlayer
              ...
              this.playerKnockbackMap.put(
                  (EntityPlayer) entity, new Vec3(d5 * d10, d7 * d10, d9 * d10));
            }
          }
        }
      }
      ...
      for (BlockPos blockpos : this.affectedBlockPositions) {
        ...
        if (spawnParticles) {
          ...
          d7 =
              d7
                  * (double)
                      (this.worldObj.rand.nextFloat() * this.worldObj.rand.nextFloat() + 0.3F);
          d3 = d3 * d7;
          d4 = d4 * d7;
          d5 = d5 * d7;
          this.worldObj.spawnParticle(
              ...
              new int[0]);
          this.worldObj.spawnParticle(
              EnumParticleTypes.SMOKE_NORMAL, d0, d1, d2, d3, d4, d5, new int[0]);
        }
  ...
  public EntityLivingBase getExplosivePlacedBy() {
    return this.exploder == null
        ...
        : (this.exploder instanceof EntityTNTPrimed
            ...
            : (this.exploder instanceof EntityLivingBase
                ? (EntityLivingBase) this.exploder
                : null));
  }
