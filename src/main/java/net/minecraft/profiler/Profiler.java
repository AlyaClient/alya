...
public class Profiler {
  ...
  public List<Profiler.Result> getProfilingData(String p_76321_1_) {
    if (!this.profilingEnabled) {
      ...
      long i =
          this.profilingMap.containsKey("root")
              ? ((Long) this.profilingMap.get("root")).longValue()
              : 0L;
      long j =
          this.profilingMap.containsKey(p_76321_1_)
      ...
      for (String s : this.profilingMap.keySet()) {
        if (s.length() > p_76321_1_.length()
            && s.startsWith(p_76321_1_)
      ...
      for (String s1 : this.profilingMap.keySet()) {
        if (s1.length() > p_76321_1_.length()
            && s1.startsWith(p_76321_1_)
      ...
      for (String s3 : this.profilingMap.keySet()) {
        this.profilingMap.put(
            s3, Long.valueOf(((Long) this.profilingMap.get(s3)).longValue() * 950L / 1000L));
      }
  ...
  public static final class Result implements Comparable<Profiler.Result> {
    ...
    public int compareTo(Profiler.Result p_compareTo_1_) {
      return p_compareTo_1_.field_76332_a < this.field_76332_a
          ? -1
          : (p_compareTo_1_.field_76332_a > this.field_76332_a
              ? 1
