...
public class JsonToNBT {
  ...
  static JsonToNBT.Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
    ...
    if (p_150316_1_.startsWith("{")) {
      ...
      for (jsontonbt$compound = new JsonToNBT.Compound(p_150316_0_);
          p_150316_1_.length() > 0;
        ...
        if (c1 != 44 && c1 != 123 && c1 != 125 && c1 != 91 && c1 != 93) {
          throw new NBTException(
              "Unexpected token \'" + c1 + "\' at: " + p_150316_1_.substring(s1.length()));
        }
      }
      ...
      for (jsontonbt$list = new JsonToNBT.List(p_150316_0_);
          p_150316_1_.length() > 0;
        ...
        if (c0 != 44 && c0 != 123 && c0 != 125 && c0 != 91 && c0 != 93) {
          throw new NBTException(
              "Unexpected token \'" + c0 + "\' at: " + p_150316_1_.substring(s.length()));
        }
      }
  ...
  private static JsonToNBT.Any func_179270_a(String p_179270_0_, boolean p_179270_1_)
      throws NBTException {
  ...
  private static boolean func_179271_b(String p_179271_0_, int p_179271_1_) {
    return p_179271_1_ > 0
        && p_179271_0_.charAt(p_179271_1_ - 1) == 92
    ...
    public NBTBase parse() throws NBTException {
      ...
      if (this.jsonValue.startsWith("[") && this.jsonValue.endsWith("]")) {
        ...
        for (int i = 0; i < this.jsonValue.length(); ++i) {
          if (i < this.jsonValue.length() - 1
              && this.jsonValue.charAt(i) == 92
