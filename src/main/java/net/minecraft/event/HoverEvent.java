...
public class HoverEvent {
  ...
  /**
   * Gets the value to perform the action on when this event is raised. For example, if the action
   * is "show item", this would be the item to show.
   */
  ...
  public static enum Action {
    ...
    private static final Map<String, HoverEvent.Action> nameMapping =
        Maps.<String, HoverEvent.Action>newHashMap();
