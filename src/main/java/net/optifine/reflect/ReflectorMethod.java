...
public class ReflectorMethod {
  ...
  public ReflectorMethod(
      ReflectorClass reflectorClass, String targetMethodName, Class[] targetMethodParameterTypes) {
      ...
      if (oclass == null) {
        ...
        try {
          if (this.targetMethodParameterTypes == null) {
            ...
            this.targetMethod =
                getMethod(oclass, this.targetMethodName, this.targetMethodParameterTypes);
          }
