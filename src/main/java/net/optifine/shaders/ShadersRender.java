...
public class ShadersRender {
    ...
    if (Shaders.isRenderingWorld) {
      if (Shaders.usedDepthBuffers >= 2) {
        ...
        GL11.glCopyTexSubImage2D(
            GL11.GL_TEXTURE_2D, 0, 0, 0, 0, 0, Shaders.renderWidth, Shaders.renderHeight);
  ...
  public static void renderItemFP(
      ItemRenderer itemRenderer, float par1, boolean renderTranslucent) {
  ...
  public static void renderShadowMap(
      EntityRenderer entityRenderer, int pass, float partialTicks, long finishTimeNano) {
    if (Shaders.usedShadowDepthBuffers > 0 && --Shaders.shadowPassCounter <= 0) {
      ...
      EXTFramebufferObject.glFramebufferTexture2DEXT(
          36160, 36096, 3553, Shaders.sfbDepthTextures.get(0), 0);

      if (Shaders.usedShadowColorBuffers != 0) {
        EXTFramebufferObject.glFramebufferTexture2DEXT(
            36160, 36064, 3553, Shaders.sfbColorTextures.get(0), 0);
      }
      ...
      renderglobal.setupTerrain(
          entity, (double) partialTicks, frustum, i, minecraft.thePlayer.isSpectator());
      ...
      renderglobal.renderBlockLayer(
          EnumWorldBlockLayer.CUTOUT_MIPPED, (double) partialTicks, 2, entity);
      ...
      if (Shaders.usedShadowDepthBuffers >= 2) {
        ...
        GL11.glCopyTexSubImage2D(
            GL11.GL_TEXTURE_2D, 0, 0, 0, 0, 0, Shaders.shadowMapWidth, Shaders.shadowMapHeight);
      ...
      if (Shaders.isRenderShadowTranslucent()) {
        ...
        renderglobal.renderBlockLayer(
            EnumWorldBlockLayer.TRANSLUCENT, (double) partialTicks, 2, entity);
        ...
        if (Shaders.usedShadowColorBuffers >= 1) {
          if (Shaders.shadowColorMipmapEnabled[0]) {
            ...
            GL11.glTexParameteri(
                GL11.GL_TEXTURE_2D,
                GL11.GL_TEXTURE_MIN_FILTER,
                Shaders.shadowColorFilterNearest[0]
                    ? GL11.GL_NEAREST_MIPMAP_NEAREST
                    : GL11.GL_LINEAR_MIPMAP_LINEAR);
          }
          ...
          if (Shaders.usedShadowColorBuffers >= 2 && Shaders.shadowColorMipmapEnabled[1]) {
            ...
            GL11.glTexParameteri(
                GL11.GL_TEXTURE_2D,
                GL11.GL_TEXTURE_MIN_FILTER,
                Shaders.shadowColorFilterNearest[1]
                    ? GL11.GL_NEAREST_MIPMAP_NEAREST
                    : GL11.GL_LINEAR_MIPMAP_LINEAR);
          }
  ...
  public static boolean renderEndPortal(
    ...
    if (!Shaders.isShadowPass && Shaders.activeProgram.getId() == 0) {
      ...
      int i = 240;
      worldrenderer
          .pos(x, y + (double) offset, z + 1.0D)
          .func_181666_a(f1, f2, f3, 1.0F)
          .tex((double) (f4 + f6), (double) (f4 + f6))
          .func_181671_a(i, i)
          .endVertex();
      worldrenderer
          .pos(x + 1.0D, y + (double) offset, z + 1.0D)
          .func_181666_a(f1, f2, f3, 1.0F)
          .tex((double) (f4 + f6), (double) (f5 + f6))
          .func_181671_a(i, i)
          .endVertex();
      worldrenderer
          .pos(x + 1.0D, y + (double) offset, z)
          .func_181666_a(f1, f2, f3, 1.0F)
          .tex((double) (f5 + f6), (double) (f5 + f6))
          .func_181671_a(i, i)
          .endVertex();
      worldrenderer
          .pos(x, y + (double) offset, z)
          .func_181666_a(f1, f2, f3, 1.0F)
          .tex((double) (f5 + f6), (double) (f4 + f6))
          .func_181671_a(i, i)
          .endVertex();
      tessellator.draw();
