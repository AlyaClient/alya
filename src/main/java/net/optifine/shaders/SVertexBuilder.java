...
public class SVertexBuilder {
  ...
  public static void pushEntity(
      IBlockState blockState, BlockPos blockPos, IBlockAccess blockAccess, WorldRenderer wrr) {
    ...
    if (count != 0) {
      ...
      if (i == 56) {
        ...
        GL20.glVertexAttribPointer(
            Shaders.midTexCoordAttrib, 2, GL11.GL_FLOAT, false, i, bytebuffer);
