...
public class ResUtils {
    ...
    public static String[] collectFiles(String[] prefixes, String[] suffixes) {
        ...
        for(int i = 0; i < airesourcepack.length; ++i) {
            ...
            String[] astring =
                    collectFiles(iresourcepack, (String[]) prefixes, (String[]) suffixes, (String[]) null);
    ...
    public static String[] collectFiles(
            IResourcePack rp, String prefix, String suffix, String[] defaultPaths) {
    ...
    public static String[] collectFiles(
            IResourcePack rp, String[] prefixes, String[] suffixes, String[] defaultPaths) {
