...
public class ModelSprite {
    ...
    public static void renderItemIn2D(
        ...
        for(int i = 0; i < sizeX; ++i) {
            ...
            worldrenderer
                    .pos((double) f4 * d0, d1, (double) width)
                    .tex((double) f5, (double) maxV)
                    .endVertex();
            ...
            worldrenderer
                    .pos((double) f4 * d0, 0.0D, (double) width)
                    .tex((double) f5, (double) minV)
                    .endVertex();
        }
        ...
        for(int j = 0; j < sizeX; ++j) {
            ...
            worldrenderer
                    .pos((double) f6 * d0, 0.0D, (double) width)
                    .tex((double) f10, (double) minV)
                    .endVertex();
            ...
            worldrenderer
                    .pos((double) f6 * d0, d1, (double) width)
                    .tex((double) f10, (double) maxV)
                    .endVertex();
        }
        ...
        for(int k = 0; k < sizeY; ++k) {
            ...
            worldrenderer
                    .pos(0.0D, (double) f13 * d1, (double) width)
                    .tex((double) minU, (double) f11)
                    .endVertex();
            worldrenderer
                    .pos(d0, (double) f13 * d1, (double) width)
                    .tex((double) maxU, (double) f11)
                    .endVertex();
        ...
        for(int l = 0; l < sizeY; ++l) {
            ...
            worldrenderer
                    .pos(d0, (double) f9 * d1, (double) width)
                    .tex((double) maxU, (double) f12)
                    .endVertex();
            worldrenderer
                    .pos(0.0D, (double) f9 * d1, (double) width)
                    .tex((double) minU, (double) f12)
                    .endVertex();
