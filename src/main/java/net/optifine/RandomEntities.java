...
public class RandomEntities {
  ...
  private static final String[] HORSE_TEXTURES =
      (String[])
          ((String[])
              ReflectorRaw.getFieldValue((Object) null, EntityHorse.class, String[].class, 0));
  private static final String[] HORSE_TEXTURES_ABBR =
      (String[])
          ((String[])
              ReflectorRaw.getFieldValue((Object) null, EntityHorse.class, String[].class, 1));
      ...
      try {
        ...
        if (irandomentity != null) {
          ...
          RandomEntityProperties randomentityproperties =
              (RandomEntityProperties) mapProperties.get(s);
          ...
          ResourceLocation resourcelocation1 =
              randomentityproperties.getTextureLocation(loc, irandomentity);
  ...
  private static RandomEntityProperties parseProperties(
      ResourceLocation propLoc, ResourceLocation resLoc) {
    try {
      ...
      if (inputstream == null) {
        ...
        inputstream.close();
        RandomEntityProperties randomentityproperties =
            new RandomEntityProperties(properties, s, resLoc);
    ...
    if (resourcelocation == null) {
      ...
      if (list.size() <= 1) {
        ...
        ResourceLocation[] aresourcelocation =
            (ResourceLocation[])
                ((ResourceLocation[]) list.toArray(new ResourceLocation[list.size()]));
    ...
    for (int i = 0; i < astring2.length; ++i) {
      ...
      if (!set.contains(s1)) {
        ...
        if (Config.hasResource(resourcelocation)) {
          RandomEntityProperties randomentityproperties =
              (RandomEntityProperties) mapProperties.get(s1);
