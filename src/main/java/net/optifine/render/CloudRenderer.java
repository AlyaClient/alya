...
public class CloudRenderer {
  ...
  public void prepareToRender(
      boolean renderFancy, int cloudTickCounter, float partialTicks, Vec3 cloudColor) {
  ...
  public boolean shouldUpdateGlList() {
    if (!this.updated) {
      ...
      boolean flag =
          this.updatePlayerY + (double) entity.getEyeHeight()
              < 128.0D + (double) (this.mc.gameSettings.ofCloudsHeight * 128.0F);
      boolean flag1 =
          entity.prevPosY + (double) entity.getEyeHeight()
              < 128.0D + (double) (this.mc.gameSettings.ofCloudsHeight * 128.0F);
      return flag1 != flag;
    }
  }
  ...
  public void renderGlList() {
    ...
    double d3 =
        (double)
            ((float) (this.cloudTickCounter - this.updateCloudTickCounter) + this.partialTicks);
