...
public class RenderEnv {
    ...
    private BlockModelRenderer.AmbientOcclusionFace aoFace =
            new BlockModelRenderer.AmbientOcclusionFace();
    ...
    private ListQuadsOverlay[] listsQuadsOverlay =
            new ListQuadsOverlay[EnumWorldBlockLayer.values().length];
    ...
    public EnumFacing[] getBorderDirections(
            EnumFacing dir0, EnumFacing dir1, EnumFacing dir2, EnumFacing dir3) {
    ...
    public BakedQuad[] getArrayQuadsCtm(
            BakedQuad quad0, BakedQuad quad1, BakedQuad quad2, BakedQuad quad3) {
