    ...
    if (guibutton.enabled) {
      if (guibutton.id < 200 && guibutton instanceof GuiOptionButton) {
        ...
        guibutton.displayString =
            this.settings.getKeyBinding(GameSettings.Options.getEnumOptions(guibutton.id));
      }
      ...
      if (guibutton.id == 210) {
        this.mc.gameSettings.saveOptions();
        GuiYesNo guiyesno =
            new GuiYesNo(this, I18n.format("of.message.other.reset", new Object[0]), "", 9999);
