...
public class RandomEntityRule {
  ...
  public RandomEntityRule(
    ...
    this.collarColors =
        cp.parseDyeColors(
            props.getProperty("collarColors." + index),
            "collar color",
    ...
    this.weatherList =
        cp.parseWeather(
            props.getProperty("weather." + index), "weather." + index, (Weather[]) null);
  }
          ...
          for (int i = 0; i < this.resourceLocations.length; ++i) {
            ...
            if (j <= 1) {
              ...
              ResourceLocation resourcelocation1 =
                  RandomEntities.getLocationIndexed(resourcelocation, j);
