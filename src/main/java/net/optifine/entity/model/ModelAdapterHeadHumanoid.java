...
public class ModelAdapterHeadHumanoid extends ModelAdapter {
      ...
      return modelPart.equals("head")
          ...
          : (modelPart.equals("head2")
              ? (!Reflector.ModelHumanoidHead_head.exists()
                  ? null
                  : (ModelRenderer)
                      Reflector.getFieldValue(modelhumanoidhead, Reflector.ModelHumanoidHead_head))
              : null);
    }
  }
  ...
  public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
    ...
    TileEntitySpecialRenderer tileentityspecialrenderer =
        tileentityrendererdispatcher.getSpecialRendererByClass(TileEntitySkull.class);
    ...
    if (!(tileentityspecialrenderer instanceof TileEntitySkullRenderer)) {
      ...
      if (!Reflector.TileEntitySkullRenderer_humanoidHead.exists()) {
        ...
        Reflector.setFieldValue(
            tileentityspecialrenderer, Reflector.TileEntitySkullRenderer_humanoidHead, modelBase);
