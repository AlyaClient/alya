...
public class ModelAdapterBanner extends ModelAdapter {
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
        if(!(model instanceof ModelBanner)) {
            ...
            return modelPart.equals("slate")
                    ...
                    : (modelPart.equals("stand")
                    ? modelbanner.bannerStand
    ...
    public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
        ...
        TileEntitySpecialRenderer tileentityspecialrenderer =
                tileentityrendererdispatcher.getSpecialRendererByClass(TileEntityBanner.class);
        ...
        if(!(tileentityspecialrenderer instanceof TileEntityBannerRenderer)) {
            ...
            if(!Reflector.TileEntityBannerRenderer_bannerModel.exists()) {
                ...
                Reflector.setFieldValue(
                        tileentityspecialrenderer, Reflector.TileEntityBannerRenderer_bannerModel, modelBase);
