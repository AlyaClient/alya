...
public class CustomEntityModels {
    ...
    private static Map<Class, TileEntitySpecialRenderer> getTileEntityRenderMap() {
        Map<Class, TileEntitySpecialRenderer> map =
                TileEntityRendererDispatcher.instance.mapSpecialRenderers;
    ...
    private static ResourceLocation[] getModelLocations() {
        ...
        ResourceLocation[] aresourcelocation =
                (ResourceLocation[]) ((ResourceLocation[]) list.toArray(new ResourceLocation[list.size()]));
    ...
    private static IEntityRenderer parseEntityRender(JsonObject obj, String path) {
        CustomEntityRenderer customentityrenderer =
                CustomEntityModelParser.parseEntityRender(obj, path);
    ...
    private static IEntityRenderer makeEntityRender(
            ModelAdapter modelAdapter, CustomEntityRenderer cer) {
        ...
        if(modelbase == null) {
            ...
            ModelResolver modelresolver =
                    new ModelResolver(modelAdapter, modelbase, acustommodelrenderer);
            ...
            if(!modifyModel(modelAdapter, modelbase, acustommodelrenderer, modelresolver)) {
                ...
                if(ientityrenderer == null) {
                    throw new JsonParseException(
                            "Entity renderer is null, model: "
                                    + modelAdapter.getName()
                                    + ", adapter: "
                                    + modelAdapter.getClass().getName());
                } else {
    ...
    private static boolean modifyModel(
            ...
            ModelBase model,
            CustomModelRenderer[] modelRenderers,
            ModelResolver mr) {
