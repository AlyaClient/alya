...
public class ModelAdapterChest extends ModelAdapter {
    ...
    public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
        ...
        TileEntitySpecialRenderer tileentityspecialrenderer =
                tileentityrendererdispatcher.getSpecialRendererByClass(TileEntityChest.class);
        ...
        if(!(tileentityspecialrenderer instanceof TileEntityChestRenderer)) {
            ...
            if(!Reflector.TileEntityChestRenderer_simpleChest.exists()) {
                ...
                Reflector.setFieldValue(
                        tileentityspecialrenderer, Reflector.TileEntityChestRenderer_simpleChest, modelBase);
