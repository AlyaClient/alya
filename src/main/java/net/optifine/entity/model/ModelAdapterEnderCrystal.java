    ...
    if (!(model instanceof ModelEnderCrystal)) {
      ...
      return modelPart.equals("cube")
          ...
          : (modelPart.equals("glass")
              ? (ModelRenderer)
                  Reflector.getFieldValue(
                      modelendercrystal, Reflector.ModelEnderCrystal_ModelRenderers, 1)
              : (modelPart.equals("base")
                  ? (ModelRenderer)
                      Reflector.getFieldValue(
                          modelendercrystal, Reflector.ModelEnderCrystal_ModelRenderers, 2)
                  : null));
    }
  }
    ...
    if (!(render instanceof RenderEnderCrystal)) {
      ...
      if (!Reflector.RenderEnderCrystal_modelEnderCrystal.exists()) {
        ...
        Reflector.setFieldValue(
            renderendercrystal, Reflector.RenderEnderCrystal_modelEnderCrystal, modelBase);
