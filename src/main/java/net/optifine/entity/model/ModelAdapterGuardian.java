    ...
    if (!(model instanceof ModelGuardian)) {
      ...
      if (modelPart.equals("body")) {
        ...
        if (modelPart.startsWith(s)) {
          ModelRenderer[] amodelrenderer1 =
              (ModelRenderer[])
                  ((ModelRenderer[])
                      Reflector.getFieldValue(modelguardian, Reflector.ModelGuardian_spines));
          ...
          if (modelPart.startsWith(s1)) {
            ModelRenderer[] amodelrenderer =
                (ModelRenderer[])
                    ((ModelRenderer[])
                        Reflector.getFieldValue(modelguardian, Reflector.ModelGuardian_tail));
