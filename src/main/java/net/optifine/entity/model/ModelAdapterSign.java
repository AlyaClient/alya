...
public class ModelAdapterSign extends ModelAdapter {
  ...
  public IEntityRenderer makeEntityRender(ModelBase modelBase, float shadowSize) {
    ...
    TileEntitySpecialRenderer tileentityspecialrenderer =
        tileentityrendererdispatcher.getSpecialRendererByClass(TileEntitySign.class);
    ...
    if (!(tileentityspecialrenderer instanceof TileEntitySignRenderer)) {
      ...
      if (!Reflector.TileEntitySignRenderer_model.exists()) {
        ...
        Reflector.setFieldValue(
            tileentityspecialrenderer, Reflector.TileEntitySignRenderer_model, modelBase);
