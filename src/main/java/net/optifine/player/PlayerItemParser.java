...
public class PlayerItemParser {
  ...
  public static PlayerItemModel parseItemModel(JsonObject obj) {
    ...
    if (!Config.equals(s, "PlayerItem")) {
      ...
      PlayerItemRenderer[] aplayeritemrenderer =
          (PlayerItemRenderer[])
              ((PlayerItemRenderer[]) list.toArray(new PlayerItemRenderer[list.size()]));
  ...
  public static PlayerItemRenderer parseItemRenderer(JsonObject elem, Dimension textureDim) {
    ...
    if (!Config.equals(s, "ModelBox")) {
      ...
      ModelRenderer modelrenderer =
          parseModelRenderer(elem, modelbase, (int[]) null, (String) null);
  ...
  public static ModelRenderer parseModelRenderer(
      JsonObject elem, ModelBase modelBase, int[] parentTextureSize, String basePath) {
    ...
    if (s1 != null) {
      modelrenderer.setTextureLocation(
          CustomEntityModelParser.getResourceLocation(basePath, s1, ".png"));
    }
      ...
      for (int j = 0; j < jsonarray.size(); ++j) {
        ...
        if (aint2 != null) {
          modelrenderer.addBox(
              aint2, afloat2[0], afloat2[1], afloat2[2], afloat2[3], afloat2[4], afloat2[5], f1);
        } else {
