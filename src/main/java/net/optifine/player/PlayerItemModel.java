...
public class PlayerItemModel {
  ...
  private ResourceLocation locationMissing =
      new ResourceLocation("textures/blocks/wool_colored_red.png");
  ...
  public PlayerItemModel(
      Dimension textureSize, boolean usePlayerTexture, PlayerItemRenderer[] modelRenderers) {
    ...
    if (this.usePlayerTexture) {
      ...
      if (this.texture == null && this.textureImage != null) {
        ...
        Minecraft.getMinecraft()
            .getTextureManager()
            .loadTexture(this.textureLocation, this.texture);
      }
