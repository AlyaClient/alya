...
public class CustomColormap implements CustomColors.IColorizer {
    ...
    public CustomColormap(
            Properties props, String path, int width, int height, String formatDefault) {
    ...
    public int getColor(BiomeGenBase biome, BlockPos blockPos) {
        return this.format == 0
                ? this.getColorVanilla(biome, blockPos)
    ...
    public void addMatchBlock(MatchBlock mb) {
        ...
        this.matchBlocks =
                (MatchBlock[]) ((MatchBlock[]) Config.addObjectToArray(this.matchBlocks, mb));
    }
