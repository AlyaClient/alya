...
public class TextureAnimations {
  ...
  private static TextureAnimation[] getTextureAnimations(IResourcePack[] rps) {
    ...
    TextureAnimation[] atextureanimation1 =
        (TextureAnimation[]) ((TextureAnimation[]) list.toArray(new TextureAnimation[list.size()]));
  ...
  private static TextureAnimation[] getTextureAnimations(IResourcePack rp) {
    String[] astring =
        ResUtils.collectFiles(
            rp, (String) "mcpatcher/anim/", (String) ".properties", (String[]) null);
    ...
    if (astring.length <= 0) {
      ...
      TextureAnimation[] atextureanimation =
          (TextureAnimation[])
              ((TextureAnimation[]) list.toArray(new TextureAnimation[list.size()]));
    ...
    if (s != null && s1 != null) {
      if (i >= 0 && j >= 0 && k >= 0 && l >= 0) {
        ...
        if (abyte == null) {
          ...
          if (i1 != k1) {
            Config.warn(
                "TextureAnimation: Source texture has invalid number of frames: "
                    + s
                    + ", frames: "
                    + (float) i1 / (float) (k * l));
            return null;
              ...
              if (inputstream == null) {
                ...
                if (i + k <= bufferedimage.getWidth() && j + l <= bufferedimage.getHeight()) {
                  TextureAnimation textureanimation =
                      new TextureAnimation(s, abyte, s1, resourcelocation, i, j, k, l, props);
