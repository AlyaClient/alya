...
void main() {
	...
	from.x += transverseSpeed*(1.0)*cos(0.005*time) + 0.0005*time;
	from.y += transverseSpeed*(1.0)*sin(0.005*time) +0.0005*time;
	from.z += 0.0015*time;
	...
	for(int r=0; r<volsteps; r++) {
		...
		backCol2 += mix(.11, 1., v2) * vec3(1.2 * t3 * t3 * t3, 0.9 * t3 * t3, t3 * 0.6) * fade;
